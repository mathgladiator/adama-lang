...
//        System.out.println("    " + Util.prefix(Util.justifyLeft("--config",14), Util.ANSI.Green) + " Supplies a config file path other than the default (~/.adama)");
...
//            System.out.println("    " + Util.prefix(Util.justifyLeft(element.name,14), Util.ANSI.Green) +" "+ element.doc);
//        }
//
//       return 0;
//    }
...
//            CliElement element = entry.getValue();
//            System.out.println("    " + Util.prefix(Util.justifyLeft(element.name,15), Util.ANSI.Green) +  element.doc);
//        }
//        return 0;
//    }
//
...
//            System.out.println("    " + Util.prefix(Util.justifyLeft(item.shortField + ", " + entry.getKey(), 15), Util.ANSI.Green) + item.documentation);
//        }
//        return 0;
//    }
