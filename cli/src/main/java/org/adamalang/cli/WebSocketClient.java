...
public class WebSocketClient {
  ...
  public class Connection {
    ...
    public Connection(
        Channel channel, ConcurrentHashMap<Long, BiConsumer<Object, Boolean>> callbacks) {
    ...
    public long open(ObjectNode request, Consumer<ObjectNode> stream, Consumer<Exception> error)
        throws Exception {
      long id = idgen.incrementAndGet();
      request.put("id", Long.toString(id));
      callbacks.put(
