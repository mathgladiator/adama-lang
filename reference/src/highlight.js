/*!
  Highlight.js v11.4.0 (git: 70ac79cdbb)
...
contains:[s,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,ge,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ge,s]}},grmr_javascript:Ne,
...
return je}()
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("adama", (() => {
    "use strict";

    const IDENT_RE = '[A-Za-z$_][0-9A-Za-z_]*';
    const KEYWORD_LIST = ["for", "foreach", "var", "let", "formula", "public", "private"];

    const KEYWORD_NO_ONE = {
        className: 'literal',
        begin: '@no_one'
    };
