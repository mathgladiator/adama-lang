...
class GetSpaceRequest {
  ...
  public static void resolve(ConnectionNexus nexus, JsonRequest request, Callback<GetSpaceRequest> callback) {
    try {
      final BulkLatch<GetSpaceRequest> _latch = new BulkLatch<>(nexus.executor, 2, callback);
