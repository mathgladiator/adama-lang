...
class ConnectDocumentRequest {
  ...
  public static void resolve(ConnectionNexus nexus, JsonRequest request, Callback<ConnectDocumentRequest> callback) {
    try {
      final BulkLatch<ConnectDocumentRequest> _latch = new BulkLatch<>(nexus.executor, 2, callback);
