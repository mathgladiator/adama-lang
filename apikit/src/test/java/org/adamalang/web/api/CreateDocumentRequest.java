...
class CreateDocumentRequest {
  ...
  public static void resolve(ConnectionNexus nexus, JsonRequest request, Callback<CreateDocumentRequest> callback) {
    try {
      final BulkLatch<CreateDocumentRequest> _latch = new BulkLatch<>(nexus.executor, 2, callback);
