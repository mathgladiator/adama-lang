...
public class DoubleLinkedHeapTests {
  private void assetEqualsAfterSnapshot(String expected, DoubleLinkedHeap heap) {
    Assert.assertEquals(expected, heap.toString());
    ByteBuf buf = Unpooled.buffer();
    heap.snapshot(buf);
    DoubleLinkedHeap heap2 = new DoubleLinkedHeap(heap.maximumSize);
    heap2.load(buf);
  ...
  public void flow() throws Exception {
    DoubleLinkedHeap heap = new DoubleLinkedHeap(1024);
