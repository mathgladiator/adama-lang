...
public class SingleThreadDiskDataServiceTests {
  ...
  public void flow() throws Exception {
    flow((setup) -> {
      ...
      setup.service.compact(KEY1, 1, cb_CompactFailsFNF);
      ...
      }
      {
        ...
        setup.service.compact(KEY1, 100, cb_CompactWorks);
      ...
      }
      {
        ...
        setup.service.compact(KEY1, -1, cbCompactFailsNegHistory);
        cbCompactFailsNegHistory.assertFailure(777259);
      }
      {
        SimpleIntCallback cb_CompactWorks = new SimpleIntCallback();
        setup.service.compact(KEY1, 2, cb_CompactWorks);
      ...
      {
        SimpleIntCallback cb_CompactWorks = new SimpleIntCallback();
        setup.service.compact(KEY1, 1, cb_CompactWorks);
