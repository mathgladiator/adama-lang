...
class GetSpaceRequest {
  ...
  public GetSpaceRequest(final String identity, final NtClient who, final String space, final SpacePolicy policy) {
  ...
  public static void resolve(Executor executor, Nexus nexus, JsonRequest request, Callback<GetSpaceRequest> callback) {
    try {
      final BulkLatch<GetSpaceRequest> _latch = new BulkLatch<>(executor, 2, callback);
      ...
      _latch.with(() -> new GetSpaceRequest(identity, who.get(), space, policy.get()));
