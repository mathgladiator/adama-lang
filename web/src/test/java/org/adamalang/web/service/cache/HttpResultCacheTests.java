...
public class HttpResultCacheTests {
  ...
  public void expiry_get() {
    ...
    cache.inject("key").accept(1000, new HttpHandler.HttpResult("space", "key", NtAsset.NOTHING, false, 0));
  ...
  public void expiry_sweeper() throws Exception {
    ...
    try {
      ...
      cache.inject("key").accept(100, new HttpHandler.HttpResult("space", "key", NtAsset.NOTHING, false, 0));
