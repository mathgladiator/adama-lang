...
public class MockReadOnlyEvents implements ReadOnlyEvents {
  private final ArrayList<String> history;
  private ArrayList<CountDownLatch> latches;
  private final AtomicReference<ReadOnlyRemote> gotRemote;
  private CountDownLatch remoteFound;

  public MockReadOnlyEvents() {
  ...
  public ReadOnlyRemote getRemote() throws Exception {
