...
public class AccountGetPaymentPlanRequest {
  public final String identity;
  public final AuthenticatedUser who;

  public AccountGetPaymentPlanRequest(final String identity, final AuthenticatedUser who) {
  ...
  public static void resolve(Session session, ConnectionNexus nexus, JsonRequest request, Callback<AccountGetPaymentPlanRequest> callback) {
    try {
      ...
      _latch.with(() -> new AccountGetPaymentPlanRequest(identity, who.get()));
      nexus.identityService.execute(session, identity, who);
    } catch (ErrorCodeException ece) {
      nexus.executor.execute(new NamedRunnable("accountgetpaymentplan-error") {
        @Override
