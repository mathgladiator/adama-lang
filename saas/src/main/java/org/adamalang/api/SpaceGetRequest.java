...
public class SpaceGetRequest {
  ...
  public static void resolve(Session session, GlobalConnectionNexus nexus, JsonRequest request, Callback<SpaceGetRequest> callback) {
    try {
      ...
      nexus.executor.execute(new NamedRunnable("spaceget-error") {
        @Override
