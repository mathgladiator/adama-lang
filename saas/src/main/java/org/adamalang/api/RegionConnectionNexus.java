...
public class RegionConnectionNexus {
  ...
  public RegionConnectionNexus(JsonLogger logger, RegionApiMetrics metrics, SimpleExecutor executor, DomainResolver domainService, PerSessionAuthenticator identityService) {
    this.logger = logger;
