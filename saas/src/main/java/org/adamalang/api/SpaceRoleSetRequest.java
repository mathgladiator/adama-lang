...
public class SpaceRoleSetRequest {
  ...
  public SpaceRoleSetRequest(final String identity, final AuthenticatedUser who, final String space, final SpacePolicy policy, final String email, final Integer userId, final String role) {
  ...
  public static void resolve(ConnectionNexus nexus, JsonRequest request, Callback<SpaceRoleSetRequest> callback) {
    try {
      final BulkLatch<SpaceRoleSetRequest> _latch = new BulkLatch<>(nexus.executor, 3, callback);
