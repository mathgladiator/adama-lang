...
public class DomainListRequest {
  ...
  public DomainListRequest(final String identity, final AuthenticatedUser who) {
  ...
  public static void resolve(Session session, ConnectionNexus nexus, JsonRequest request, Callback<DomainListRequest> callback) {
    try {
      ...
      _latch.with(() -> new DomainListRequest(identity, who.get()));
      nexus.identityService.execute(session, identity, who);
    } catch (ErrorCodeException ece) {
      nexus.executor.execute(new NamedRunnable("domainlist-error") {
        @Override
