...
public class DomainGetVapidPublicKeyRequest {
  public final String identity;
  public final AuthenticatedUser who;
  public final String domain;
  public final DomainWithPolicy resolvedDomain;

  public DomainGetVapidPublicKeyRequest(final String identity, final AuthenticatedUser who, final String domain, final DomainWithPolicy resolvedDomain) {
  ...
  public static void resolve(Session session, GlobalConnectionNexus nexus, JsonRequest request, Callback<DomainGetVapidPublicKeyRequest> callback) {
    try {
      final BulkLatch<DomainGetVapidPublicKeyRequest> _latch = new BulkLatch<>(nexus.executor, 2, callback);
      ...
      nexus.executor.execute(new NamedRunnable("domaingetvapidpublickey-error") {
        @Override
