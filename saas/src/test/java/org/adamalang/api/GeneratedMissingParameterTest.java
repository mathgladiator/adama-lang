...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:466947", c69.next());
      node.put("key", "xzya");
      //DomainList
      node = Json.newJsonObject();
      node.put("id", 69);
      ...
      Assert.assertEquals("ERROR:461828", c72.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c81.next());
      node.put("username", "xzya");
      Iterator<String> c82 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c82.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c88.next());
      node.put("username", "xzya");
      Iterator<String> c89 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c89.next());
      node.put("password", "xzya");
      Iterator<String> c90 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c90.next());
      ...
      Assert.assertEquals("ERROR:466931", c94.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 94);
      ...
      Assert.assertEquals("ERROR:461828", c96.next());
      node.put("space", "xzya");
      Iterator<String> c97 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c97.next());
      node.put("key", "xzya");
      Iterator<String> c98 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461826", c98.next());
      ...
      Assert.assertEquals("ERROR:458759", c99.next());
      node.put("identity", _identity);
      Iterator<String> c100 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c100.next());
      node.put("space", "xzya");
      Iterator<String> c101 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c101.next());
      node.put("key", "xzya");
      //DocumentList
      node = Json.newJsonObject();
      node.put("id", 101);
      ...
      Assert.assertEquals("ERROR:454659", c107.next());
      ...
      Assert.assertEquals("ERROR:454659", c112.next());
      node.put("channel", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c116.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:405505", c119.next());
      ...
      Assert.assertEquals("ERROR:405505", c126.next());
      node.put("connection", 100L);
      Iterator<String> c127 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c127.next());
      node.put("channel", "xzya");
      Iterator<String> c128 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c128.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 128);
      ...
      Assert.assertEquals("ERROR:465917", c139.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c147.next());
      node.put("domain", "xzya");
      Iterator<String> c148 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c148.next());
      node.put("filename", "xzya");
      Iterator<String> c149 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c149.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 149);
      ...
      Assert.assertEquals("ERROR:439292", c156.next());
      ...
      Assert.assertEquals("ERROR:458759", c162.next());
      node.put("identity", _identity);
      Iterator<String> c163 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c163.next());
      node.put("space", "xzya");
      Iterator<String> c164 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c164.next());
      node.put("key", "xzya");
      Iterator<String> c165 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c165.next());
      ...
      Assert.assertEquals("ERROR:456716", c169.next());
      node.put("role", "xzya");
      Iterator<String> c170 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c170.next());
      ...
      Assert.assertEquals("ERROR:461828", c172.next());
      node.put("space", "xzya");
      Iterator<String> c173 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c173.next());
      node.put("key", "xzya");
      //RegionalFinderFree
      node = Json.newJsonObject();
      node.put("id", 173);
      ...
      Assert.assertEquals("ERROR:9006", c177.next());
      node.put("region", "xzya");
      Iterator<String> c178 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c178.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 178);
      ...
      Assert.assertEquals("ERROR:466947", c181.next());
      node.put("key", "xzya");
      Iterator<String> c182 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c182.next());
      node.put("region", "xzya");
      Iterator<String> c183 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c183.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c192.next());
      node.put("region", "xzya");
      Iterator<String> c193 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c193.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c213.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c221.next());
      node.put("space", "xzya");
