...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:458737", c89.next());
      node.put("username", "xzya");
      Iterator<String> c90 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c90.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:466931", c98.next());
      ...
      Assert.assertEquals("ERROR:488444", c99.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:461826", c106.next());
      ...
      Assert.assertEquals("ERROR:405505", c127.next());
      node.put("connection", 100L);
      Iterator<String> c128 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c128.next());
      node.put("channel", "xzya");
      Iterator<String> c129 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c129.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 129);
      ...
      Assert.assertEquals("ERROR:458737", c131.next());
      node.put("username", "xzya");
      Iterator<String> c132 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c132.next());
      node.put("password", "xzya");
      Iterator<String> c133 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c133.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 133);
      ...
      Assert.assertEquals("ERROR:454659", c135.next());
      node.put("channel", "xzya");
      Iterator<String> c136 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c136.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 136);
      ...
      Assert.assertEquals("ERROR:476156", c139.next());
      ...
      Assert.assertEquals("ERROR:477179", c142.next());
      node.put("size", 100L);
      Iterator<String> c143 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:445437", c143.next());
      node.put("digest-md5", "xzya");
      Iterator<String> c144 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:406525", c144.next());
      ...
      Assert.assertEquals("ERROR:465917", c147.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c152.next());
      node.put("filename", "xzya");
      Iterator<String> c153 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c153.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:439292", c164.next());
      ...
      Assert.assertEquals("ERROR:425213", c173.next());
