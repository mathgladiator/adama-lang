...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:473103", c42.next());
      node.put("email", "x@x.com");
      Iterator<String> c43 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:456716", c43.next());
      node.put("role", "xzya");
      //SpaceListDevelopers
      node = Json.newJsonObject();
      node.put("id", 43);
      ...
      Assert.assertEquals("ERROR:488444", c54.next());
      node.put("domain", "xzya");
      //DomainMapDocument
      node = Json.newJsonObject();
      node.put("id", 54);
      ...
      Assert.assertEquals("ERROR:458737", c66.next());
      node.put("username", "xzya");
      Iterator<String> c67 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c67.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c69.next());
      node.put("username", "xzya");
      Iterator<String> c70 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c70.next());
      node.put("password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 70);
      ...
      Assert.assertEquals("ERROR:466947", c73.next());
      node.put("key", "xzya");
      Iterator<String> c74 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461826", c74.next());
      ...
      Assert.assertEquals("ERROR:454659", c83.next());
      node.put("channel", "xzya");
      Iterator<String> c84 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c84.next());
      ...
      Assert.assertEquals("ERROR:454659", c88.next());
      node.put("channel", "xzya");
      ...
      Assert.assertEquals("ERROR:405505", c95.next());
      node.put("connection", 100L);
      Iterator<String> c96 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c96.next());
      node.put("channel", "xzya");
      Iterator<String> c97 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c97.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 97);
      ...
      Assert.assertEquals("ERROR:405505", c102.next());
      node.put("connection", 100L);
      Iterator<String> c103 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c103.next());
      node.put("channel", "xzya");
      Iterator<String> c104 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c104.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 104);
      ...
      Assert.assertEquals("ERROR:465917", c115.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c119.next());
      node.put("filename", "xzya");
      Iterator<String> c120 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c120.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 120);
      ...
      Assert.assertEquals("ERROR:409609", c124.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 124);
      ...
      Assert.assertEquals("ERROR:439292", c127.next());
      ...
      Assert.assertEquals("ERROR:439292", c130.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c132.next());
      node.put("domain", "xzya");
      //RegionalInitHost
      node = Json.newJsonObject();
      node.put("id", 132);
      ...
      Assert.assertEquals("ERROR:9006", c144.next());
      node.put("region", "xzya");
      Iterator<String> c145 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c145.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 145);
      ...
      Assert.assertEquals("ERROR:9006", c149.next());
      node.put("region", "xzya");
      Iterator<String> c150 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c150.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c152.next());
      node.put("space", "xzya");
      Iterator<String> c153 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c153.next());
      node.put("key", "xzya");
      Iterator<String> c154 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c154.next());
      node.put("region", "xzya");
      Iterator<String> c155 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c155.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c159.next());
      node.put("region", "xzya");
      Iterator<String> c160 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c160.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c161.next());
      node.put("identity", _identity);
      Iterator<String> c162 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c162.next());
      node.put("space", "xzya");
      Iterator<String> c163 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c163.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c196.next());
      node.put("region", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c202.next());
      node.put("region", "xzya");
    }
  }
}
