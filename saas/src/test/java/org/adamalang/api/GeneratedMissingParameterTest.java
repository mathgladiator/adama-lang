...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:458737", c77.next());
      node.put("username", "xzya");
      Iterator<String> c78 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c78.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c80.next());
      node.put("username", "xzya");
      Iterator<String> c81 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c81.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:466931", c86.next());
      ...
      Assert.assertEquals("ERROR:461826", c94.next());
      ...
      Assert.assertEquals("ERROR:454659", c108.next());
      node.put("channel", "xzya");
      ...
      Assert.assertEquals("ERROR:454659", c116.next());
      node.put("channel", "xzya");
      Iterator<String> c117 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c117.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 117);
      ...
      Assert.assertEquals("ERROR:405505", c118.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:470028", c140.next());
      node.put("filename", "xzya");
      Iterator<String> c141 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c141.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c143.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:409609", c149.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 149);
      ...
      Assert.assertEquals("ERROR:458759", c150.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:439292", c152.next());
      ...
      Assert.assertEquals("ERROR:488444", c154.next());
      node.put("domain", "xzya");
      Iterator<String> c155 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c155.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c157.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 157);
      ...
      Assert.assertEquals("ERROR:425213", c161.next());
      ...
      Assert.assertEquals("ERROR:461828", c168.next());
      node.put("space", "xzya");
      Iterator<String> c169 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c169.next());
      node.put("key", "xzya");
      //RegionalFinderFree
      node = Json.newJsonObject();
      node.put("id", 169);
      ...
      Assert.assertEquals("ERROR:466947", c172.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c182.next());
      node.put("key", "xzya");
