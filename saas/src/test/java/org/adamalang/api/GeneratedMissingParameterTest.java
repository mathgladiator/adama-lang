...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461826", c60.next());
      ...
      Assert.assertEquals("ERROR:454659", c69.next());
      node.put("channel", "xzya");
      Iterator<String> c70 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c70.next());
      ...
      Assert.assertEquals("ERROR:454659", c74.next());
      node.put("channel", "xzya");
      Iterator<String> c75 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c75.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 75);
      ...
      Assert.assertEquals("ERROR:405505", c79.next());
      node.put("connection", 100L);
      Iterator<String> c80 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c80.next());
      node.put("channel", "xzya");
      Iterator<String> c81 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c81.next());
      node.put("message", Json.newJsonObject());
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 81);
      ...
      Assert.assertEquals("ERROR:405505", c85.next());
      node.put("connection", 100L);
      //ConnectionAttach
      node = Json.newJsonObject();
      node.put("id", 85);
      ...
      Assert.assertEquals("ERROR:405505", c93.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 93);
      ...
      Assert.assertEquals("ERROR:470028", c98.next());
      node.put("filename", "xzya");
      Iterator<String> c99 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c99.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 99);
      ...
      Assert.assertEquals("ERROR:409609", c103.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 103);
      ...
      Assert.assertEquals("ERROR:439292", c106.next());
      ...
      Assert.assertEquals("ERROR:439292", c109.next());
      node.put("timestamp", 100L);
    }
  }
}
