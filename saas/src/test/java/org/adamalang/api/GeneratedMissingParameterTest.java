...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461826", c83.next());
      ...
      Assert.assertEquals("ERROR:466931", c110.next());
      ...
      Assert.assertEquals("ERROR:405505", c111.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:470028", c129.next());
      node.put("filename", "xzya");
      Iterator<String> c130 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c130.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c133.next());
      node.put("filename", "xzya");
      Iterator<String> c134 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c134.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 134);
      ...
      Assert.assertEquals("ERROR:409609", c138.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 138);
      ...
      Assert.assertEquals("ERROR:439292", c141.next());
      ...
      Assert.assertEquals("ERROR:439292", c144.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c146.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 146);
      ...
      Assert.assertEquals("ERROR:425213", c150.next());
      ...
      Assert.assertEquals("ERROR:461828", c160.next());
      node.put("space", "xzya");
      Iterator<String> c161 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c161.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c165.next());
      node.put("space", "xzya");
      Iterator<String> c166 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c166.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c170.next());
      node.put("space", "xzya");
      Iterator<String> c171 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c171.next());
      node.put("key", "xzya");
