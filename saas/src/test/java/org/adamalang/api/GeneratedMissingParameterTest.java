...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:402428", c35.next());
      ...
      Assert.assertEquals("ERROR:402255", c40.next());
      ...
      Assert.assertEquals("ERROR:458759", c43.next());
      node.put("identity", _identity);
      Iterator<String> c44 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c44.next());
      node.put("space", "xzya");
      //SpaceDelete
      node = Json.newJsonObject();
      node.put("id", 44);
      ...
      Assert.assertEquals("ERROR:473103", c49.next());
      node.put("email", "x@x.com");
      Iterator<String> c50 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:456716", c50.next());
      node.put("role", "xzya");
      //SpaceListDevelopers
      node = Json.newJsonObject();
      node.put("id", 50);
      ...
      Assert.assertEquals("ERROR:458759", c53.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:461828", c64.next());
      node.put("space", "xzya");
      Iterator<String> c65 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c65.next());
      node.put("key", "xzya");
      //DomainList
      node = Json.newJsonObject();
      node.put("id", 65);
      ...
      Assert.assertEquals("ERROR:461828", c68.next());
      node.put("space", "xzya");
      //DomainUnmap
      node = Json.newJsonObject();
      node.put("id", 68);
      ...
      Assert.assertEquals("ERROR:458737", c75.next());
      node.put("username", "xzya");
      Iterator<String> c76 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c76.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c78.next());
      node.put("username", "xzya");
      Iterator<String> c79 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c79.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c82.next());
      node.put("username", "xzya");
      Iterator<String> c83 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c83.next());
      node.put("password", "xzya");
      Iterator<String> c84 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c84.next());
      ...
      Assert.assertEquals("ERROR:458737", c86.next());
      node.put("username", "xzya");
      Iterator<String> c87 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c87.next());
      node.put("password", "xzya");
      Iterator<String> c88 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c88.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 88);
      ...
      Assert.assertEquals("ERROR:461826", c92.next());
      ...
      Assert.assertEquals("ERROR:458759", c96.next());
      node.put("identity", _identity);
      Iterator<String> c97 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c97.next());
      node.put("space", "xzya");
      //MessageDirectSend
      node = Json.newJsonObject();
      node.put("id", 97);
      ...
      Assert.assertEquals("ERROR:454659", c101.next());
      ...
      Assert.assertEquals("ERROR:454659", c106.next());
      node.put("channel", "xzya");
      Iterator<String> c107 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c107.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 107);
      ...
      Assert.assertEquals("ERROR:458759", c111.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:454659", c114.next());
      node.put("channel", "xzya");
      Iterator<String> c115 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c115.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 115);
      ...
      Assert.assertEquals("ERROR:458737", c117.next());
      node.put("username", "xzya");
      Iterator<String> c118 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c118.next());
      node.put("password", "xzya");
      Iterator<String> c119 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c119.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 119);
      ...
      Assert.assertEquals("ERROR:405505", c120.next());
      node.put("connection", 100L);
      Iterator<String> c121 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c121.next());
      node.put("channel", "xzya");
      Iterator<String> c122 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c122.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 122);
      ...
      Assert.assertEquals("ERROR:405505", c123.next());
      node.put("connection", 100L);
      //ConnectionAttach
      node = Json.newJsonObject();
      node.put("id", 123);
      ...
      Assert.assertEquals("ERROR:405505", c131.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 131);
      ...
      Assert.assertEquals("ERROR:465917", c133.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c136.next());
      node.put("space", "xzya");
      Iterator<String> c137 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c137.next());
      node.put("key", "xzya");
      Iterator<String> c138 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c138.next());
      node.put("filename", "xzya");
      Iterator<String> c139 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c139.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c141.next());
      node.put("domain", "xzya");
      Iterator<String> c142 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c142.next());
      node.put("filename", "xzya");
      Iterator<String> c143 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c143.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 143);
      ...
      Assert.assertEquals("ERROR:409609", c147.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 147);
      ...
      Assert.assertEquals("ERROR:439292", c150.next());
      ...
      Assert.assertEquals("ERROR:458759", c151.next());
      node.put("identity", _identity);
      Iterator<String> c152 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:488444", c152.next());
      node.put("domain", "xzya");
      Iterator<String> c153 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c153.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c155.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 155);
      ...
      Assert.assertEquals("ERROR:458759", c156.next());
      node.put("identity", _identity);
      Iterator<String> c157 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c157.next());
      node.put("space", "xzya");
      Iterator<String> c158 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c158.next());
      node.put("key", "xzya");
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c159.next());
      ...
      Assert.assertEquals("ERROR:456716", c163.next());
      node.put("role", "xzya");
      Iterator<String> c164 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c164.next());
      ...
      Assert.assertEquals("ERROR:466947", c170.next());
      node.put("key", "xzya");
      Iterator<String> c171 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c171.next());
      node.put("region", "xzya");
      Iterator<String> c172 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c172.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 172);
      ...
      Assert.assertEquals("ERROR:9006", c181.next());
      node.put("region", "xzya");
      Iterator<String> c182 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c182.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c184.next());
      node.put("space", "xzya");
      Iterator<String> c185 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c185.next());
      node.put("key", "xzya");
      Iterator<String> c186 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c186.next());
      node.put("region", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c188.next());
      node.put("identity", _identity);
      Iterator<String> c189 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c189.next());
      node.put("space", "xzya");
      Iterator<String> c190 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c190.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c199.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c200.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:458759", c204.next());
      node.put("identity", _identity);
      Iterator<String> c205 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c205.next());
      node.put("space", "xzya");
      //RegionalCapacityAdd
      node = Json.newJsonObject();
      node.put("id", 205);
      ...
      Assert.assertEquals("ERROR:9006", c208.next());
      node.put("region", "xzya");
      Iterator<String> c209 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c209.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c212.next());
      node.put("region", "xzya");
      Iterator<String> c213 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c213.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c215.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c223.next());
      node.put("region", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c224.next());
      node.put("identity", _identity);
      Iterator<String> c225 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c225.next());
      node.put("space", "xzya");
      Iterator<String> c226 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c226.next());
      node.put("region", "xzya");
