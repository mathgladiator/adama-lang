...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:458737", c63.next());
      node.put("username", "xzya");
      Iterator<String> c64 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c64.next());
      node.put("password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 64);
      ...
      Assert.assertEquals("ERROR:461826", c68.next());
      ...
      Assert.assertEquals("ERROR:454659", c77.next());
      node.put("channel", "xzya");
      Iterator<String> c78 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c78.next());
      ...
      Assert.assertEquals("ERROR:466931", c95.next());
      ...
      Assert.assertEquals("ERROR:470028", c113.next());
      node.put("filename", "xzya");
      Iterator<String> c114 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c114.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 114);
      ...
      Assert.assertEquals("ERROR:409609", c118.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 118);
      ...
      Assert.assertEquals("ERROR:439292", c121.next());
      ...
      Assert.assertEquals("ERROR:439292", c124.next());
      node.put("timestamp", 100L);
    }
  }
}
