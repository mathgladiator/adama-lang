...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:425987", c92.next());
      node.put("message", Json.newJsonObject());
      //DocumentAuthorize
      node = Json.newJsonObject();
      node.put("id", 92);
      ...
      Assert.assertEquals("ERROR:488444", c97.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c102.next());
      node.put("username", "xzya");
      Iterator<String> c103 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c103.next());
      node.put("password", "xzya");
      Iterator<String> c104 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c104.next());
      ...
      Assert.assertEquals("ERROR:488444", c105.next());
      node.put("domain", "xzya");
      Iterator<String> c106 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c106.next());
      node.put("username", "xzya");
      Iterator<String> c107 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c107.next());
      node.put("password", "xzya");
      Iterator<String> c108 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c108.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 108);
      ...
      Assert.assertEquals("ERROR:461826", c112.next());
      ...
      Assert.assertEquals("ERROR:454659", c126.next());
      node.put("channel", "xzya");
      Iterator<String> c127 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c127.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 127);
      ...
      Assert.assertEquals("ERROR:454659", c134.next());
      node.put("channel", "xzya");
      Iterator<String> c135 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c135.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 135);
      ...
      Assert.assertEquals("ERROR:405505", c136.next());
      node.put("connection", 100L);
      Iterator<String> c137 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c137.next());
      node.put("username", "xzya");
      Iterator<String> c138 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c138.next());
      node.put("password", "xzya");
      Iterator<String> c139 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c139.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 139);
      ...
      Assert.assertEquals("ERROR:454659", c141.next());
      node.put("channel", "xzya");
      Iterator<String> c142 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c142.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 142);
      ...
      Assert.assertEquals("ERROR:405505", c152.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c153.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c156.next());
      node.put("space", "xzya");
      Iterator<String> c157 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c157.next());
      node.put("key", "xzya");
      Iterator<String> c158 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c158.next());
      node.put("filename", "xzya");
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c159.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c162.next());
      node.put("filename", "xzya");
      Iterator<String> c163 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c163.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 163);
      ...
      Assert.assertEquals("ERROR:462859", c165.next());
      node.put("chunk-md5", "xzya");
      Iterator<String> c166 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:409608", c166.next());
      ...
      Assert.assertEquals("ERROR:409609", c167.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 167);
      ...
      Assert.assertEquals("ERROR:439292", c173.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c175.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 175);
      ...
      Assert.assertEquals("ERROR:466947", c178.next());
      node.put("key", "xzya");
      Iterator<String> c179 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c179.next());
      ...
      Assert.assertEquals("ERROR:456716", c183.next());
      node.put("role", "xzya");
      Iterator<String> c184 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c184.next());
      ...
      Assert.assertEquals("ERROR:9005", c197.next());
      node.put("machine", "xzya");
