...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:425987", c87.next());
      ...
      Assert.assertEquals("ERROR:458737", c92.next());
      node.put("username", "xzya");
      Iterator<String> c93 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c93.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c98.next());
      node.put("key", "xzya");
      Iterator<String> c99 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c99.next());
      node.put("username", "xzya");
      Iterator<String> c100 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c100.next());
      node.put("password", "xzya");
      Iterator<String> c101 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c101.next());
      ...
      Assert.assertEquals("ERROR:488444", c102.next());
      node.put("domain", "xzya");
      Iterator<String> c103 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c103.next());
      node.put("username", "xzya");
      Iterator<String> c104 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c104.next());
      node.put("password", "xzya");
      Iterator<String> c105 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c105.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 105);
      ...
      Assert.assertEquals("ERROR:458759", c106.next());
      node.put("identity", _identity);
      Iterator<String> c107 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c107.next());
      node.put("space", "xzya");
      Iterator<String> c108 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c108.next());
      node.put("key", "xzya");
      Iterator<String> c109 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461826", c109.next());
      ...
      Assert.assertEquals("ERROR:458759", c113.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:454659", c118.next());
      node.put("channel", "xzya");
      Iterator<String> c119 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c119.next());
      node.put("message", Json.newJsonObject());
      ...
      Assert.assertEquals("ERROR:461828", c126.next());
      node.put("space", "xzya");
      Iterator<String> c127 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c127.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:405505", c130.next());
      ...
      Assert.assertEquals("ERROR:458737", c134.next());
      node.put("username", "xzya");
      Iterator<String> c135 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c135.next());
      node.put("password", "xzya");
      Iterator<String> c136 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c136.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 136);
      ...
      Assert.assertEquals("ERROR:405505", c137.next());
      node.put("connection", 100L);
      Iterator<String> c138 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c138.next());
      node.put("channel", "xzya");
      Iterator<String> c139 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c139.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 139);
      ...
      Assert.assertEquals("ERROR:405505", c148.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 148);
      ...
      Assert.assertEquals("ERROR:405505", c149.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c150.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c155.next());
      node.put("filename", "xzya");
      Iterator<String> c156 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c156.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c158.next());
      node.put("domain", "xzya");
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c159.next());
      node.put("filename", "xzya");
      Iterator<String> c160 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c160.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 160);
      ...
      Assert.assertEquals("ERROR:409609", c164.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 164);
      ...
      Assert.assertEquals("ERROR:439292", c167.next());
      ...
      Assert.assertEquals("ERROR:488444", c169.next());
      node.put("domain", "xzya");
      Iterator<String> c170 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c170.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:458759", c171.next());
      node.put("identity", _identity);
      Iterator<String> c172 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:488444", c172.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 172);
      ...
      Assert.assertEquals("ERROR:425213", c176.next());
      ...
      Assert.assertEquals("ERROR:456716", c180.next());
      node.put("role", "xzya");
      Iterator<String> c181 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c181.next());
      ...
      Assert.assertEquals("ERROR:466947", c187.next());
      node.put("key", "xzya");
      Iterator<String> c188 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c188.next());
      node.put("region", "xzya");
      Iterator<String> c189 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c189.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 189);
      ...
      Assert.assertEquals("ERROR:461828", c191.next());
      node.put("space", "xzya");
      Iterator<String> c192 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c192.next());
      node.put("key", "xzya");
      Iterator<String> c193 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c193.next());
      node.put("region", "xzya");
      Iterator<String> c194 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c194.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c201.next());
      node.put("space", "xzya");
      Iterator<String> c202 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c202.next());
      node.put("key", "xzya");
      Iterator<String> c203 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c203.next());
      node.put("region", "xzya");
      Iterator<String> c204 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c204.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c206.next());
      node.put("space", "xzya");
      Iterator<String> c207 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c207.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c217.next());
      node.put("identity", _identity);
      Iterator<String> c218 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c218.next());
      node.put("region", "xzya");
      Iterator<String> c219 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c219.next());
      node.put("machine", "xzya");
      //RegionalAuth
      node = Json.newJsonObject();
      node.put("id", 219);
      ...
      Assert.assertEquals("ERROR:458759", c220.next());
      node.put("identity", _identity);
      //RegionalGetPlan
      node = Json.newJsonObject();
      node.put("id", 220);
      ...
      Assert.assertEquals("ERROR:461828", c239.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c242.next());
      node.put("space", "xzya");
      Iterator<String> c243 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c243.next());
      node.put("region", "xzya");
