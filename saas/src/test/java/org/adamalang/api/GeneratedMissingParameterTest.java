...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461828", c50.next());
      node.put("space", "xzya");
      //SpaceSetRole
      node = Json.newJsonObject();
      node.put("id", 50);
      ...
      Assert.assertEquals("ERROR:461828", c52.next());
      node.put("space", "xzya");
      Iterator<String> c53 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:473103", c53.next());
      node.put("email", "x@x.com");
      Iterator<String> c54 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:456716", c54.next());
      node.put("role", "xzya");
      //SpaceListDevelopers
      node = Json.newJsonObject();
      node.put("id", 54);
      ...
      Assert.assertEquals("ERROR:488444", c66.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:454644", c72.next());
      ...
      Assert.assertEquals("ERROR:453621", c75.next());
      ...
      Assert.assertEquals("ERROR:488444", c88.next());
      node.put("domain", "xzya");
      //DomainGet
      node = Json.newJsonObject();
      node.put("id", 88);
      ...
      Assert.assertEquals("ERROR:494583", c100.next());
      ...
      Assert.assertEquals("ERROR:458759", c101.next());
      node.put("identity", _identity);
      Iterator<String> c102 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c102.next());
      node.put("space", "xzya");
      Iterator<String> c103 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c103.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:493556", c105.next());
      node.put("agent", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c107.next());
      node.put("key", "xzya");
      Iterator<String> c108 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c108.next());
      ...
      Assert.assertEquals("ERROR:488444", c109.next());
      node.put("domain", "xzya");
      Iterator<String> c110 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c110.next());
      node.set("message", Json.newJsonObject());
      //DocumentAuthorize
      node = Json.newJsonObject();
      node.put("id", 110);
      ...
      Assert.assertEquals("ERROR:461828", c111.next());
      node.put("space", "xzya");
      Iterator<String> c112 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c112.next());
      node.put("key", "xzya");
      Iterator<String> c113 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c113.next());
      ...
      Assert.assertEquals("ERROR:458737", c120.next());
      node.put("username", "xzya");
      Iterator<String> c121 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c121.next());
      node.put("password", "xzya");
      Iterator<String> c122 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c122.next());
      ...
      Assert.assertEquals("ERROR:488444", c123.next());
      node.put("domain", "xzya");
      Iterator<String> c124 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c124.next());
      node.put("username", "xzya");
      Iterator<String> c125 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c125.next());
      node.put("password", "xzya");
      Iterator<String> c126 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c126.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 126);
      ...
      Assert.assertEquals("ERROR:461826", c130.next());
      ...
      Assert.assertEquals("ERROR:458759", c131.next());
      node.put("identity", _identity);
      Iterator<String> c132 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c132.next());
      node.put("space", "xzya");
      Iterator<String> c133 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c133.next());
      node.put("key", "xzya");
      //DocumentList
      node = Json.newJsonObject();
      node.put("id", 133);
      ...
      Assert.assertEquals("ERROR:458759", c136.next());
      node.put("identity", _identity);
      Iterator<String> c137 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c137.next());
      node.put("space", "xzya");
      Iterator<String> c138 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c138.next());
      node.put("key", "xzya");
      Iterator<String> c139 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c139.next());
      node.put("channel", "xzya");
      Iterator<String> c140 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c140.next());
      node.set("message", Json.newJsonObject());
      ...
      Assert.assertEquals("ERROR:461828", c142.next());
      node.put("space", "xzya");
      Iterator<String> c143 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c143.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c146.next());
      node.put("identity", _identity);
      Iterator<String> c147 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c147.next());
      node.put("space", "xzya");
      Iterator<String> c148 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c148.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:454659", c152.next());
      node.put("channel", "xzya");
      Iterator<String> c153 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c153.next());
      node.set("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 153);
      ...
      Assert.assertEquals("ERROR:458737", c155.next());
      node.put("username", "xzya");
      Iterator<String> c156 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c156.next());
      node.put("password", "xzya");
      Iterator<String> c157 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c157.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 157);
      ...
      Assert.assertEquals("ERROR:405505", c158.next());
      node.put("connection", 100L);
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c159.next());
      node.put("channel", "xzya");
      Iterator<String> c160 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c160.next());
      node.set("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 160);
      ...
      Assert.assertEquals("ERROR:405505", c169.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 169);
      ...
      Assert.assertEquals("ERROR:405505", c170.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c171.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c174.next());
      node.put("space", "xzya");
      Iterator<String> c175 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c175.next());
      node.put("key", "xzya");
      Iterator<String> c176 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c176.next());
      node.put("filename", "xzya");
      Iterator<String> c177 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c177.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c179.next());
      node.put("domain", "xzya");
      Iterator<String> c180 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c180.next());
      node.put("filename", "xzya");
      Iterator<String> c181 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c181.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 181);
      ...
      Assert.assertEquals("ERROR:409609", c185.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 185);
      ...
      Assert.assertEquals("ERROR:439292", c188.next());
      ...
      Assert.assertEquals("ERROR:488444", c190.next());
      node.put("domain", "xzya");
      Iterator<String> c191 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c191.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c193.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 193);
      ...
      Assert.assertEquals("ERROR:461828", c195.next());
      node.put("space", "xzya");
      Iterator<String> c196 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c196.next());
      node.put("key", "xzya");
      Iterator<String> c197 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c197.next());
      ...
      Assert.assertEquals("ERROR:461828", c207.next());
      node.put("space", "xzya");
      Iterator<String> c208 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c208.next());
      node.put("key", "xzya");
      Iterator<String> c209 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c209.next());
      node.put("region", "xzya");
      Iterator<String> c210 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c210.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 210);
      ...
      Assert.assertEquals("ERROR:9006", c236.next());
      node.put("region", "xzya");
      Iterator<String> c237 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c237.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c238.next());
      node.put("identity", _identity);
      Iterator<String> c239 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c239.next());
      node.put("region", "xzya");
      Iterator<String> c240 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c240.next());
      node.put("machine", "xzya");
      //RegionalAuth
      node = Json.newJsonObject();
      node.put("id", 240);
      ...
      Assert.assertEquals("ERROR:458759", c241.next());
      node.put("identity", _identity);
      //RegionalGetPlan
      node = Json.newJsonObject();
      node.put("id", 241);
      ...
      Assert.assertEquals("ERROR:9006", c246.next());
      node.put("region", "xzya");
      Iterator<String> c247 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c247.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c249.next());
      node.put("space", "xzya");
      Iterator<String> c250 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c250.next());
      node.put("region", "xzya");
      Iterator<String> c251 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c251.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c252.next());
      node.put("identity", _identity);
      Iterator<String> c253 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c253.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c256.next());
      node.put("identity", _identity);
      Iterator<String> c257 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c257.next());
      node.put("region", "xzya");
      Iterator<String> c258 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c258.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c261.next());
      node.put("region", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c262.next());
      node.put("identity", _identity);
      Iterator<String> c263 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c263.next());
      node.put("space", "xzya");
      Iterator<String> c264 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c264.next());
      node.put("region", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c265.next());
      node.put("identity", _identity);
      Iterator<String> c266 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c266.next());
      node.put("space", "xzya");
      Iterator<String> c267 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c267.next());
      node.put("region", "xzya");
    }
  }
}
