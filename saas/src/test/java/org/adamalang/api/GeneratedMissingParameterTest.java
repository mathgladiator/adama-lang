...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:470028", c184.next());
      node.put("filename", "xzya");
      Iterator<String> c185 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c185.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c187.next());
      node.put("domain", "xzya");
      Iterator<String> c188 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c188.next());
      node.put("filename", "xzya");
      Iterator<String> c189 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c189.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 189);
      ...
      Assert.assertEquals("ERROR:462859", c191.next());
      node.put("chunk-md5", "xzya");
      Iterator<String> c192 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:409608", c192.next());
      ...
      Assert.assertEquals("ERROR:409609", c193.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 193);
      ...
      Assert.assertEquals("ERROR:439292", c199.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c201.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 201);
      ...
      Assert.assertEquals("ERROR:425213", c205.next());
      ...
      Assert.assertEquals("ERROR:456716", c209.next());
      node.put("role", "xzya");
      Iterator<String> c210 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c210.next());
      ...
      Assert.assertEquals("ERROR:466947", c216.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c222.next());
      node.put("region", "xzya");
      Iterator<String> c223 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c223.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c226.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c231.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c233.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c236.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c248.next());
      node.put("machine", "xzya");
      //RegionalAuth
      node = Json.newJsonObject();
      node.put("id", 248);
      ...
      Assert.assertEquals("ERROR:9006", c254.next());
      node.put("region", "xzya");
      Iterator<String> c255 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c255.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c258.next());
      node.put("region", "xzya");
      Iterator<String> c259 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c259.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c265.next());
      node.put("region", "xzya");
      Iterator<String> c266 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c266.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c273.next());
      node.put("identity", _identity);
      Iterator<String> c274 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c274.next());
      node.put("space", "xzya");
      Iterator<String> c275 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c275.next());
      node.put("region", "xzya");
    }
  }
}
