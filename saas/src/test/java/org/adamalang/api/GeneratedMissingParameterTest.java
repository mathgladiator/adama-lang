...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461826", c70.next());
      ...
      Assert.assertEquals("ERROR:454659", c79.next());
      node.put("channel", "xzya");
      Iterator<String> c80 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c80.next());
      ...
      Assert.assertEquals("ERROR:454659", c92.next());
      node.put("channel", "xzya");
      Iterator<String> c93 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c93.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 93);
      ...
      Assert.assertEquals("ERROR:454659", c99.next());
      node.put("channel", "xzya");
      ...
      Assert.assertEquals("ERROR:405505", c110.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c111.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:439292", c123.next());
      ...
      Assert.assertEquals("ERROR:488444", c125.next());
      node.put("domain", "xzya");
