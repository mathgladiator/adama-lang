...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:493556", c92.next());
      node.put("agent", "xzya");
      ...
      Assert.assertEquals("ERROR:425987", c95.next());
      ...
      Assert.assertEquals("ERROR:458737", c107.next());
      node.put("username", "xzya");
      Iterator<String> c108 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c108.next());
      node.put("password", "xzya");
      Iterator<String> c109 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c109.next());
      ...
      Assert.assertEquals("ERROR:458737", c111.next());
      node.put("username", "xzya");
      Iterator<String> c112 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c112.next());
      node.put("password", "xzya");
      Iterator<String> c113 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c113.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 113);
      ...
      Assert.assertEquals("ERROR:461826", c117.next());
      ...
      Assert.assertEquals("ERROR:488444", c137.next());
      node.put("domain", "xzya");
      //ConnectionSend
      node = Json.newJsonObject();
      node.put("id", 137);
      ...
      Assert.assertEquals("ERROR:458737", c142.next());
      node.put("username", "xzya");
      Iterator<String> c143 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c143.next());
      node.put("password", "xzya");
      Iterator<String> c144 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c144.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 144);
      ...
      Assert.assertEquals("ERROR:405505", c145.next());
      node.put("connection", 100L);
      Iterator<String> c146 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c146.next());
      node.put("channel", "xzya");
      Iterator<String> c147 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c147.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 147);
      ...
      Assert.assertEquals("ERROR:476156", c150.next());
      ...
      Assert.assertEquals("ERROR:477179", c153.next());
      node.put("size", 100L);
      Iterator<String> c154 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:445437", c154.next());
      node.put("digest-md5", "xzya");
      Iterator<String> c155 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:406525", c155.next());
      ...
      Assert.assertEquals("ERROR:405505", c156.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 156);
      ...
      Assert.assertEquals("ERROR:465917", c158.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c161.next());
      node.put("space", "xzya");
      Iterator<String> c162 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c162.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c166.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:409609", c172.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 172);
      ...
      Assert.assertEquals("ERROR:439292", c175.next());
      ...
      Assert.assertEquals("ERROR:488444", c177.next());
      node.put("domain", "xzya");
      Iterator<String> c178 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c178.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c180.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 180);
      ...
      Assert.assertEquals("ERROR:425213", c184.next());
      ...
      Assert.assertEquals("ERROR:456716", c188.next());
      node.put("role", "xzya");
      Iterator<String> c189 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c189.next());
      ...
      Assert.assertEquals("ERROR:9006", c233.next());
      node.put("region", "xzya");
      Iterator<String> c234 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c234.next());
      node.put("machine", "xzya");
