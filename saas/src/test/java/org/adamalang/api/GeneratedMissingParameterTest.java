...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:494583", c99.next());
      ...
      Assert.assertEquals("ERROR:493556", c104.next());
      node.put("agent", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c108.next());
      node.put("domain", "xzya");
      Iterator<String> c109 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c109.next());
      node.set("message", Json.newJsonObject());
      //DocumentAuthorize
      node = Json.newJsonObject();
      node.put("id", 109);
      ...
      Assert.assertEquals("ERROR:488444", c114.next());
      node.put("domain", "xzya");
      Iterator<String> c115 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c115.next());
      node.put("username", "xzya");
      ...
      Assert.assertEquals("ERROR:466931", c121.next());
      ...
      Assert.assertEquals("ERROR:488444", c122.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:461826", c129.next());
      ...
      Assert.assertEquals("ERROR:454659", c143.next());
      node.put("channel", "xzya");
      Iterator<String> c144 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c144.next());
      node.set("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 144);
      ...
      Assert.assertEquals("ERROR:458759", c145.next());
      node.put("identity", _identity);
      Iterator<String> c146 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c146.next());
      node.put("space", "xzya");
      Iterator<String> c147 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c147.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c149.next());
      node.put("domain", "xzya");
      //ConnectionSend
      node = Json.newJsonObject();
      node.put("id", 149);
      ...
      Assert.assertEquals("ERROR:458737", c154.next());
      node.put("username", "xzya");
      Iterator<String> c155 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c155.next());
      node.put("password", "xzya");
      Iterator<String> c156 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c156.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 156);
      ...
      Assert.assertEquals("ERROR:465917", c170.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c174.next());
      node.put("key", "xzya");
      Iterator<String> c175 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c175.next());
      node.put("filename", "xzya");
      Iterator<String> c176 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c176.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c178.next());
      node.put("domain", "xzya");
      Iterator<String> c179 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c179.next());
      node.put("filename", "xzya");
      Iterator<String> c180 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c180.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 180);
      ...
      Assert.assertEquals("ERROR:439292", c187.next());
      ...
      Assert.assertEquals("ERROR:488444", c189.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c194.next());
      node.put("space", "xzya");
      Iterator<String> c195 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c195.next());
      node.put("key", "xzya");
      Iterator<String> c196 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c196.next());
      ...
      Assert.assertEquals("ERROR:456716", c200.next());
      node.put("role", "xzya");
      Iterator<String> c201 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c201.next());
      ...
      Assert.assertEquals("ERROR:9006", c213.next());
      node.put("region", "xzya");
      Iterator<String> c214 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c214.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c217.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c222.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c224.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c227.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c255.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:9005", c257.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c260.next());
      node.put("region", "xzya");
