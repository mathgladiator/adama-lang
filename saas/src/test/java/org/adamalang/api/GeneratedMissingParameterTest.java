...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:458737", c73.next());
      node.put("username", "xzya");
      Iterator<String> c74 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c74.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c75.next());
      node.put("domain", "xzya");
      Iterator<String> c76 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c76.next());
      node.put("username", "xzya");
      Iterator<String> c77 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c77.next());
      node.put("password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 77);
      ...
      Assert.assertEquals("ERROR:461826", c81.next());
      ...
      Assert.assertEquals("ERROR:405505", c109.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:405505", c121.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c122.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c125.next());
      node.put("space", "xzya");
      Iterator<String> c126 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c126.next());
      node.put("key", "xzya");
      Iterator<String> c127 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c127.next());
      node.put("filename", "xzya");
      Iterator<String> c128 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c128.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 128);
      ...
      Assert.assertEquals("ERROR:409609", c132.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 132);
      ...
      Assert.assertEquals("ERROR:439292", c135.next());
      ...
      Assert.assertEquals("ERROR:439292", c138.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c140.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 140);
      ...
      Assert.assertEquals("ERROR:425213", c144.next());
      ...
      Assert.assertEquals("ERROR:456716", c148.next());
      node.put("role", "xzya");
      Iterator<String> c149 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c149.next());
      ...
      Assert.assertEquals("ERROR:461828", c151.next());
      node.put("space", "xzya");
      Iterator<String> c152 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c152.next());
      node.put("key", "xzya");
      //RegionalFinderFree
      node = Json.newJsonObject();
      node.put("id", 152);
      ...
      Assert.assertEquals("ERROR:461828", c210.next());
      node.put("space", "xzya");
