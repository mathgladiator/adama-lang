...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:423142", c174.next());
      node.put("url", "xzya");
      //AttachmentStart
      node = Json.newJsonObject();
      node.put("id", 174);
      ...
      Assert.assertEquals("ERROR:470028", c178.next());
      node.put("filename", "xzya");
      Iterator<String> c179 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c179.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c181.next());
      node.put("domain", "xzya");
      Iterator<String> c182 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c182.next());
      node.put("filename", "xzya");
      Iterator<String> c183 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c183.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 183);
      ...
      Assert.assertEquals("ERROR:439292", c190.next());
      ...
      Assert.assertEquals("ERROR:488444", c192.next());
      node.put("domain", "xzya");
      ...
      Assert.assertEquals("ERROR:466947", c198.next());
      node.put("key", "xzya");
      Iterator<String> c199 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c199.next());
      ...
      Assert.assertEquals("ERROR:456716", c203.next());
      node.put("role", "xzya");
      Iterator<String> c204 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c204.next());
      ...
      Assert.assertEquals("ERROR:466947", c225.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c227.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c228.next());
      node.put("identity", _identity);
      Iterator<String> c229 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c229.next());
      node.put("space", "xzya");
      Iterator<String> c230 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c230.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c249.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c250.next());
      node.put("identity", _identity);
      Iterator<String> c251 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c251.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c257.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c260.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c262.next());
      node.put("space", "xzya");
      Iterator<String> c263 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c263.next());
      node.put("region", "xzya");
