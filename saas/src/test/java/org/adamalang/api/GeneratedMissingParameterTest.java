...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:425213", c138.next());
      ...
      Assert.assertEquals("ERROR:456716", c142.next());
      node.put("role", "xzya");
      Iterator<String> c143 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c143.next());
