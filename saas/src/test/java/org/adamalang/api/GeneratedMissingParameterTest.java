...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:453621", c70.next());
      ...
      Assert.assertEquals("ERROR:488444", c83.next());
      node.put("domain", "xzya");
      //DomainGet
      node = Json.newJsonObject();
      node.put("id", 83);
      ...
      Assert.assertEquals("ERROR:461828", c86.next());
      node.put("space", "xzya");
      Iterator<String> c87 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c87.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c93.next());
      node.put("username", "xzya");
      Iterator<String> c94 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c94.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c96.next());
      node.put("username", "xzya");
      Iterator<String> c97 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c97.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c103.next());
      node.put("domain", "xzya");
      Iterator<String> c104 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c104.next());
      node.put("username", "xzya");
      Iterator<String> c105 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c105.next());
      node.put("password", "xzya");
      Iterator<String> c106 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c106.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 106);
      ...
      Assert.assertEquals("ERROR:461826", c110.next());
      ...
      Assert.assertEquals("ERROR:458759", c114.next());
      node.put("identity", _identity);
      Iterator<String> c115 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c115.next());
      node.put("space", "xzya");
      //MessageDirectSend
      node = Json.newJsonObject();
      node.put("id", 115);
      ...
      Assert.assertEquals("ERROR:458759", c116.next());
      node.put("identity", _identity);
      ...
      Assert.assertEquals("ERROR:454659", c119.next());
      node.put("channel", "xzya");
      Iterator<String> c120 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c120.next());
      node.put("message", Json.newJsonObject());
      ...
      Assert.assertEquals("ERROR:458759", c121.next());
      node.put("identity", _identity);
      Iterator<String> c122 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c122.next());
      node.put("space", "xzya");
      Iterator<String> c123 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c123.next());
      node.put("key", "xzya");
      Iterator<String> c124 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:454659", c124.next());
      node.put("channel", "xzya");
      Iterator<String> c125 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c125.next());
      node.put("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 125);
      ...
      Assert.assertEquals("ERROR:466947", c128.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:454659", c132.next());
      node.put("channel", "xzya");
      Iterator<String> c133 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c133.next());
      node.put("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 133);
      ...
      Assert.assertEquals("ERROR:405505", c134.next());
      node.put("connection", 100L);
      Iterator<String> c135 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c135.next());
      node.put("username", "xzya");
      Iterator<String> c136 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c136.next());
      node.put("password", "xzya");
      Iterator<String> c137 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c137.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 137);
      ...
      Assert.assertEquals("ERROR:405505", c138.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c151.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c159.next());
      node.put("domain", "xzya");
      Iterator<String> c160 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c160.next());
      node.put("filename", "xzya");
      Iterator<String> c161 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c161.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 161);
      ...
      Assert.assertEquals("ERROR:409609", c165.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 165);
      ...
      Assert.assertEquals("ERROR:439292", c168.next());
      ...
      Assert.assertEquals("ERROR:488444", c170.next());
      node.put("domain", "xzya");
      Iterator<String> c171 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c171.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c173.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 173);
      ...
      Assert.assertEquals("ERROR:425213", c177.next());
      ...
      Assert.assertEquals("ERROR:9005", c190.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 190);
      ...
      Assert.assertEquals("ERROR:466947", c193.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c201.next());
      node.put("identity", _identity);
      Iterator<String> c202 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c202.next());
      node.put("space", "xzya");
      Iterator<String> c203 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c203.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c237.next());
      node.put("region", "xzya");
      Iterator<String> c238 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c238.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c239.next());
      node.put("identity", _identity);
      Iterator<String> c240 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c240.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c245.next());
      node.put("identity", _identity);
      Iterator<String> c246 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c246.next());
      node.put("space", "xzya");
      Iterator<String> c247 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c247.next());
      node.put("region", "xzya");
    }
  }
}
