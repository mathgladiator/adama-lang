...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:470028", c111.next());
      node.put("filename", "xzya");
      Iterator<String> c112 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c112.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 112);
      ...
      Assert.assertEquals("ERROR:409609", c116.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 116);
      ...
      Assert.assertEquals("ERROR:439292", c119.next());
      ...
      Assert.assertEquals("ERROR:439292", c122.next());
      node.put("timestamp", 100L);
    }
  }
}
