...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461828", c133.next());
      node.put("space", "xzya");
      Iterator<String> c134 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c134.next());
      node.put("key", "xzya");
      //RegionalFinderFree
      node = Json.newJsonObject();
      node.put("id", 134);
      ...
      Assert.assertEquals("ERROR:9006", c138.next());
      node.put("region", "xzya");
      Iterator<String> c139 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c139.next());
      ...
      Assert.assertEquals("ERROR:9006", c143.next());
      node.put("region", "xzya");
      Iterator<String> c144 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c144.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c148.next());
      node.put("region", "xzya");
      Iterator<String> c149 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c149.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c153.next());
      node.put("region", "xzya");
      Iterator<String> c154 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c154.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c158.next());
      node.put("region", "xzya");
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c159.next());
      node.put("machine", "xzya");
      Iterator<String> c160 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9007", c160.next());
      ...
      Assert.assertEquals("ERROR:9006", c162.next());
      node.put("region", "xzya");
      Iterator<String> c163 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c163.next());
      node.put("machine", "xzya");
