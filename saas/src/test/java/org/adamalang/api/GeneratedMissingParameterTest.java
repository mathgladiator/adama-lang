...
public class GeneratedMissingParameterTest {
  ...
  public void missing() throws Exception {
    try (TestFrontEnd fe = new TestFrontEnd()) {
      ...
      Assert.assertEquals("ERROR:461828", c104.next());
      node.put("space", "xzya");
      Iterator<String> c105 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c105.next());
      node.put("key", "xzya");
      Iterator<String> c106 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:494583", c106.next());
      ...
      Assert.assertEquals("ERROR:488444", c110.next());
      node.put("domain", "xzya");
      Iterator<String> c111 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:493556", c111.next());
      node.put("agent", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c112.next());
      node.put("space", "xzya");
      Iterator<String> c113 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c113.next());
      node.put("key", "xzya");
      Iterator<String> c114 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c114.next());
      ...
      Assert.assertEquals("ERROR:461828", c117.next());
      node.put("space", "xzya");
      Iterator<String> c118 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c118.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:458737", c122.next());
      node.put("username", "xzya");
      Iterator<String> c123 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c123.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:488444", c129.next());
      node.put("domain", "xzya");
      Iterator<String> c130 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c130.next());
      node.put("username", "xzya");
      Iterator<String> c131 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c131.next());
      node.put("password", "xzya");
      Iterator<String> c132 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c132.next());
      node.put("new_password", "xzya");
      //DocumentCreate
      node = Json.newJsonObject();
      node.put("id", 132);
      ...
      Assert.assertEquals("ERROR:461826", c136.next());
      ...
      Assert.assertEquals("ERROR:454659", c145.next());
      node.put("channel", "xzya");
      Iterator<String> c146 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c146.next());
      node.set("message", Json.newJsonObject());
      ...
      Assert.assertEquals("ERROR:454659", c150.next());
      node.put("channel", "xzya");
      Iterator<String> c151 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c151.next());
      node.set("message", Json.newJsonObject());
      //ConnectionCreate
      node = Json.newJsonObject();
      node.put("id", 151);
      ...
      Assert.assertEquals("ERROR:458759", c155.next());
      node.put("identity", _identity);
      Iterator<String> c156 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:488444", c156.next());
      node.put("domain", "xzya");
      //ConnectionSend
      node = Json.newJsonObject();
      node.put("id", 156);
      ...
      Assert.assertEquals("ERROR:454659", c158.next());
      node.put("channel", "xzya");
      Iterator<String> c159 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c159.next());
      node.set("message", Json.newJsonObject());
      //ConnectionPassword
      node = Json.newJsonObject();
      node.put("id", 159);
      ...
      Assert.assertEquals("ERROR:405505", c160.next());
      node.put("connection", 100L);
      Iterator<String> c161 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458737", c161.next());
      node.put("username", "xzya");
      Iterator<String> c162 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:465917", c162.next());
      node.put("password", "xzya");
      Iterator<String> c163 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466931", c163.next());
      node.put("new_password", "xzya");
      //ConnectionSendOnce
      node = Json.newJsonObject();
      node.put("id", 163);
      ...
      Assert.assertEquals("ERROR:454659", c165.next());
      node.put("channel", "xzya");
      Iterator<String> c166 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425987", c166.next());
      node.set("message", Json.newJsonObject());
      //ConnectionCanAttach
      node = Json.newJsonObject();
      node.put("id", 166);
      ...
      Assert.assertEquals("ERROR:405505", c167.next());
      node.put("connection", 100L);
      //ConnectionAttach
      node = Json.newJsonObject();
      node.put("id", 167);
      ...
      Assert.assertEquals("ERROR:405505", c175.next());
      node.put("connection", 100L);
      //ConnectionEnd
      node = Json.newJsonObject();
      node.put("id", 175);
      ...
      Assert.assertEquals("ERROR:405505", c176.next());
      node.put("connection", 100L);
      ...
      Assert.assertEquals("ERROR:465917", c177.next());
      node.put("password", "xzya");
      ...
      Assert.assertEquals("ERROR:423142", c180.next());
      node.put("url", "xzya");
      //ReplicationCreate
      node = Json.newJsonObject();
      node.put("id", 180);
      ...
      Assert.assertEquals("ERROR:466947", c183.next());
      node.put("key", "xzya");
      //RegionalReplicationCreate
      node = Json.newJsonObject();
      node.put("id", 183);
      ...
      Assert.assertEquals("ERROR:9005", c187.next());
      ...
      Assert.assertEquals("ERROR:405505", c188.next());
      node.put("connection", 100L);
      //AttachmentStart
      node = Json.newJsonObject();
      node.put("id", 188);
      ...
      Assert.assertEquals("ERROR:466947", c191.next());
      node.put("key", "xzya");
      Iterator<String> c192 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:470028", c192.next());
      node.put("filename", "xzya");
      Iterator<String> c193 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c193.next());
      node.put("content-type", "xzya");
      ...
      Assert.assertEquals("ERROR:470028", c196.next());
      node.put("filename", "xzya");
      Iterator<String> c197 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:455691", c197.next());
      node.put("content-type", "xzya");
      //AttachmentAppend
      node = Json.newJsonObject();
      node.put("id", 197);
      ...
      Assert.assertEquals("ERROR:409609", c201.next());
      node.put("upload", 100L);
      //SuperCheckIn
      node = Json.newJsonObject();
      node.put("id", 201);
      ...
      Assert.assertEquals("ERROR:439292", c204.next());
      ...
      Assert.assertEquals("ERROR:458759", c205.next());
      node.put("identity", _identity);
      Iterator<String> c206 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:488444", c206.next());
      node.put("domain", "xzya");
      Iterator<String> c207 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:439292", c207.next());
      node.put("timestamp", 100L);
      ...
      Assert.assertEquals("ERROR:488444", c209.next());
      node.put("domain", "xzya");
      //RegionalEmitMetrics
      node = Json.newJsonObject();
      node.put("id", 209);
      ...
      Assert.assertEquals("ERROR:458759", c210.next());
      node.put("identity", _identity);
      Iterator<String> c211 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c211.next());
      node.put("space", "xzya");
      Iterator<String> c212 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c212.next());
      node.put("key", "xzya");
      Iterator<String> c213 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:425213", c213.next());
      ...
      Assert.assertEquals("ERROR:458759", c214.next());
      node.put("identity", _identity);
      Iterator<String> c215 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c215.next());
      node.put("region", "xzya");
      Iterator<String> c216 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c216.next());
      node.put("machine", "xzya");
      Iterator<String> c217 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:456716", c217.next());
      node.put("role", "xzya");
      Iterator<String> c218 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:90000", c218.next());
      ...
      Assert.assertEquals("ERROR:466947", c221.next());
      node.put("key", "xzya");
      //RegionalFinderFree
      node = Json.newJsonObject();
      node.put("id", 221);
      ...
      Assert.assertEquals("ERROR:461828", c223.next());
      node.put("space", "xzya");
      Iterator<String> c224 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c224.next());
      node.put("key", "xzya");
      Iterator<String> c225 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c225.next());
      node.put("region", "xzya");
      Iterator<String> c226 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c226.next());
      node.put("machine", "xzya");
      //RegionalFinderBind
      node = Json.newJsonObject();
      node.put("id", 226);
      ...
      Assert.assertEquals("ERROR:461828", c228.next());
      node.put("space", "xzya");
      Iterator<String> c229 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c229.next());
      node.put("key", "xzya");
      Iterator<String> c230 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c230.next());
      node.put("region", "xzya");
      Iterator<String> c231 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c231.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c232.next());
      node.put("identity", _identity);
      Iterator<String> c233 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c233.next());
      node.put("space", "xzya");
      Iterator<String> c234 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c234.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c236.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:461828", c238.next());
      node.put("space", "xzya");
      Iterator<String> c239 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c239.next());
      node.put("key", "xzya");
      Iterator<String> c240 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c240.next());
      node.put("region", "xzya");
      Iterator<String> c241 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c241.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c242.next());
      node.put("identity", _identity);
      Iterator<String> c243 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c243.next());
      node.put("space", "xzya");
      Iterator<String> c244 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:466947", c244.next());
      node.put("key", "xzya");
      ...
      Assert.assertEquals("ERROR:9006", c252.next());
      node.put("region", "xzya");
      Iterator<String> c253 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c253.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c258.next());
      node.put("identity", _identity);
      Iterator<String> c259 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c259.next());
      node.put("space", "xzya");
      //RegionalCapacityAdd
      node = Json.newJsonObject();
      node.put("id", 259);
      ...
      Assert.assertEquals("ERROR:458759", c260.next());
      node.put("identity", _identity);
      Iterator<String> c261 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c261.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:9005", c267.next());
      node.put("machine", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c268.next());
      node.put("identity", _identity);
      Iterator<String> c269 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c269.next());
      node.put("space", "xzya");
      ...
      Assert.assertEquals("ERROR:458759", c272.next());
      node.put("identity", _identity);
      Iterator<String> c273 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c273.next());
      node.put("region", "xzya");
      Iterator<String> c274 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9005", c274.next());
      node.put("machine", "xzya");
      //RegionalCapacityListRegion
      node = Json.newJsonObject();
      node.put("id", 274);
      node.put("method", "regional/capacity/list-region");
      Iterator<String> c275 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458759", c275.next());
      node.put("identity", _identity);
      Iterator<String> c276 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c276.next());
      node.put("space", "xzya");
      Iterator<String> c277 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c277.next());
      node.put("region", "xzya");
      //RegionalCapacityPickSpaceHost
      node = Json.newJsonObject();
      node.put("id", 277);
      node.put("method", "regional/capacity/pick-space-host");
      Iterator<String> c278 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458759", c278.next());
      node.put("identity", _identity);
      Iterator<String> c279 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c279.next());
      node.put("space", "xzya");
      Iterator<String> c280 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c280.next());
      node.put("region", "xzya");
      //RegionalCapacityPickSpaceHostNew
      node = Json.newJsonObject();
      node.put("id", 280);
      node.put("method", "regional/capacity/pick-space-host-new");
      Iterator<String> c281 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:458759", c281.next());
      node.put("identity", _identity);
      Iterator<String> c282 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:461828", c282.next());
      node.put("space", "xzya");
      Iterator<String> c283 = fe.execute(node.toString());
      Assert.assertEquals("ERROR:9006", c283.next());
      node.put("region", "xzya");
    }
  }
}
