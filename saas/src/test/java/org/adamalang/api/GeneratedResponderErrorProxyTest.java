...
public class GeneratedResponderErrorProxyTest {
  ...
  public void proxy() throws Exception {
    ...
    new InitiationResponder(responder).error(new ErrorCodeException(16));
    new KeyListingResponder(responder).error(new ErrorCodeException(17));
    new KeyPairResponder(responder).error(new ErrorCodeException(18));
    new KeysResponder(responder).error(new ErrorCodeException(19));
    new KeystoreResponder(responder).error(new ErrorCodeException(20));
    new PaymentResponder(responder).error(new ErrorCodeException(21));
    new PlanResponder(responder).error(new ErrorCodeException(22));
    new ProgressResponder(responder).error(new ErrorCodeException(23));
    new ReflectionResponder(responder).error(new ErrorCodeException(24));
    new ReplicaResponder(responder).error(new ErrorCodeException(25));
    new RxhtmlResponder(responder).error(new ErrorCodeException(26));
    new SeqResponder(responder).error(new ErrorCodeException(27));
    new SimpleResponder(responder).error(new ErrorCodeException(28));
    new SpaceListingResponder(responder).error(new ErrorCodeException(29));
    new YesResponder(responder).error(new ErrorCodeException(30));
    Assert.assertEquals(465, errorCount.get());
  }
}
