...
public enum Label {
  ...
  FindingClientCancelTryNewTarget, // while we were finding the target, a new target to connect too became interesting. We need to abort this and try again
  ...
  FoundClientConnectingTryNewTarget, // while we wait to connect, a new target became available and we need to switch gears

  FoundClientConnectingStop, // while we wait to connect, a new target became available and we need to stop
