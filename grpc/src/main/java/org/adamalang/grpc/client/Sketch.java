...
public class Sketch {
  ...
  public static class ConnectionStateMachine {
    ...
    public ConnectionStateMachine(RoutingEngine engine, InstanceClientFinder mesh, ScheduledExecutorService scheduler, String agent, String authority, String space, String key, SimpleEvents events) {
      this.base = new Base(engine, mesh, scheduler);
      this.agent = agent;
