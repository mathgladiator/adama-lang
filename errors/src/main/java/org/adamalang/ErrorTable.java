...
public class ErrorTable {
  ...
  public ErrorTable() {
    ...
    descriptions.put(640009, "The document change was unable to be patched");
    retry.add(640009);
    ...
    descriptions.put(997516, "Was unable to update the viewer state within the document");
    names.put(998539, "API_UPDATE_REJECTED");
    descriptions.put(998539, "The document was busy and unable to accept view state updates");
    names.put(984111, "API_CAN_ATTACH_TIMEOUT");
    descriptions.put(984111, "Was unable to ask the document whether an attachment could be made");
    names.put(901163, "API_CAN_ATTACH_REJECTED");
    descriptions.put(901163, "The document was busy and unable to accept any attachment requests");
    names.put(916527, "API_ATTACH_TIMEOUT");
    descriptions.put(916527, "Was unable to attach to the document");
    names.put(913447, "API_ATTACH_REJECTED");
    descriptions.put(913447, "The document was busy and unable to attach the data");
