...
public class PhaseValidate {
    public static class ValidationResults {
        ...
        public ValidationResults(boolean passedValidation, String java) {
            this.passedValidation = passedValidation;
            this.java = java;
        }

    }
    public static ValidationResults go(final Path inputRoot, final Path path, String className, boolean emission, StringBuilder outputFile) throws Exception {
