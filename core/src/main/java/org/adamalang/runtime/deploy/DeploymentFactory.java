...
/** converts a DeploymentPlan into a LivingDocumentFactoryFactory; if this can be created, then it is in good order */
public class DeploymentFactory implements LivingDocumentFactoryFactory {
     ...
     */
    public DeploymentFactory(String spacePrefix, AtomicInteger newClassId, DeploymentFactory prior, DeploymentPlan plan) throws ErrorCodeException {
