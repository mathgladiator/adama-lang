                ...
                if (reader.startArray()) {
                  while (reader.notEndOfArray()) {
                    if (reader.startObject()) {
                        ...
                        switch (reader.fieldName()) {
                          case "version":
                            ...
                            if (!versions.containsKey(_version)) {
                              throw new ErrorCodeException(
                                  ErrorCodes.DEPLOYMENT_PLAN_VERSION_MUST_EXIST);
                            }
                            break;
                          case "prefix":
                          ...
                          case "percent":
                            try {
                              ...
                              throw new ErrorCodeException(
                                  ErrorCodes.DEPLOYMENT_PLAN_PERCENT_MUST_BE_DOUBLE);
                            }
                            break;
                          default:
                      ...
                      throw new ErrorCodeException(
                          ErrorCodes.DEPLOYMENT_PLAN_PLAN_ARRAY_ELEMENT_MUST_OBJECT);
                    }
                  }
                } else {
