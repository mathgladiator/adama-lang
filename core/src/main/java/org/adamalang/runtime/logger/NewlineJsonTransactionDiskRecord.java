...
/** used by SynchronousJsonDeltaDiskLogger to de-serialize a Transaction. This will pull the record off a buffered reader */
class NewlineJsonTransactionDiskRecord {
  public static void writeTo(final Transaction transaction, final PrintWriter writer) {
    writer.println(transaction.request.toString());
    writer.println(transaction.delta.toString());
  ...
  public final ObjectNode deltaObject;
  public final String metadata;
  public final ObjectNode metaObject;
  public final String request;
  public final ObjectNode requestObject;
  ...
  public NewlineJsonTransactionDiskRecord(final BufferedReader buffered) throws IOException {
    ...
    if (request == null) {
      ...
      try {
        requestObject = Utility.parseJsonObjectThrows(request);
        deltaObject = Utility.parseJsonObjectThrows(delta);
  ...
  public Transaction toTransaction() {
    return new Transaction(-1, requestObject, deltaObject, TransactionResult.from(metaObject));
  }
