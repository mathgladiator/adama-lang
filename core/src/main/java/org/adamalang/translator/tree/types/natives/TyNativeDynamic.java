    ...
    AssignmentViaNative //
{
  ...
  public TyNativeFunctional lookupMethod(String name, Environment environment) {
    if ("to_json".equals(name)) {
      return new TyNativeFunctional("to_json", FunctionOverloadInstance.WRAP(new FunctionOverloadInstance("to_json", new TyNativeJson(behavior, readonlyToken, token), new ArrayList<>(), FunctionPaint.READONLY_NORMAL)), FunctionStyleJava.ExpressionThenArgs);
    }
