...
public class TemplateExitGateTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/\" ln:ch=\"0;0;0;14;exitGate.rx.html\">");
    gold.append("\n  $.PG(['fixed',''], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n    $.IG($.pV(a),'foo',$.pV(a),'block-exit');");
    gold.append("\n");
    gold.append("\n    // <div rx:if=\"view:block-exit\" ln:ch=\"2;1;2;30;exitGate.rx.html\">");
    gold.append("\n    var d=$.E('div');");
    gold.append("\n    $.IF(d,a,$.pV(a),'block-exit',true,false,function(f,e) {");
    gold.append("\n      f.append($.T(' Show this if we try to exit when foo is true. '));");
    gold.append("\n");
    gold.append("\n      // <button rx:click=\"resume\" ln:ch=\"3;48;3;74;exitGate.rx.html\">");
    gold.append("\n      var g=$.E('button');");
    gold.append("\n      var h=[];");
    gold.append("\n      h.push($.bR());");
    gold.append("\n      $.onB(g,'click',e,h);");
