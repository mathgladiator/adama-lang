...
public class TemplateStyleAggrTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/\" ln:ch=\"3;0;3;14;styleAggr.rx.html\">");
    gold.append("\n  $.PG(['fixed',''], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"toggle:open\" ln:ch=\"7;1;7;32;styleAggr.rx.html\">");
    gold.append("\n    var d=$.E('button');");
    gold.append("\n    $.onT(d,'click',$.pV(a),'open');");
    gold.append("\n    d.append($.T('Toggle'));");
    gold.append("\n    b.append(d);");
    gold.append("\n");
    gold.append("\n    // <button rx:mouseenter=\"toggle:enter\" ln:ch=\"8;1;8;38;styleAggr.rx.html\">");
    gold.append("\n    var d=$.E('button');");
