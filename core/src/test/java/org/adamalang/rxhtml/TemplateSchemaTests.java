...
public class TemplateSchemaTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <template name=\"foo\" ln:ch=\"20;0;20;21;schema.rx.html\">");
    gold.append("\n  $.TP('foo', function(a,b,c) {");
    gold.append("\n    var d=$.X();");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"set:y=3\" ln:ch=\"20;21;20;48;schema.rx.html\">");
    gold.append("\n    var e=$.E('button');");
    gold.append("\n    var f=[];");
    ...
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <template name=\"foo_scope\" ln:ch=\"22;0;22;27;schema.rx.html\">");
    gold.append("\n  $.TP('foo_scope', function(a,b,c) {");
    gold.append("\n    var e=$.X();");
    gold.append("\n");
    gold.append("\n    // <div rx:scope=\"fooscope\" ln:ch=\"23;1;23;26;schema.rx.html\">");
    gold.append("\n    var g=$.E('div');");
    gold.append("\n    var h=$.pI(b,'fooscope');");
    gold.append("\n    c(g,h,'');");
    gold.append("\n    a.append(g);");
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/should_be_canonical_test_for_schema_gen\" ln:ch=\"0;0;0;53;schema.rx.html\">");
    gold.append("\n  $.PG(['fixed','should_be_canonical_test_for_schema_gen'], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n");
    gold.append("\n    // <div rx:scope=\"child\" rx:expand-view-state=\"\" ln:ch=\"1;1;1;44;schema.rx.html\">");
    gold.append("\n    var g=$.E('div');");
    gold.append("\n    var i=$.pIE(a,'child', true);");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"set:x=1\" ln:ch=\"1;44;1;71;schema.rx.html\">");
    gold.append("\n    var j=$.E('button');");
    gold.append("\n    var k=[];");
    ...
    gold.append("\n    g.append(j);");
    gold.append("\n");
    gold.append("\n    // <div rx:template=\"foo\" ln:ch=\"2;2;2;25;schema.rx.html\">");
    gold.append("\n    var j=$.E('div');");
    ...
    gold.append("\n    b.append(g);");
    gold.append("\n");
    gold.append("\n    // <div rx:iterate=\"children\" rx:expand-view-state=\"\" ln:ch=\"6;1;6;49;schema.rx.html\">");
    gold.append("\n    var g=$.E('div');");
    ...
    gold.append("\n      var l=$.E('div');");
    gold.append("\n");
    gold.append("\n      // <button rx:click=\"set:z=x\" ln:ch=\"6;49;6;76;schema.rx.html\">");
    gold.append("\n      var m=$.E('button');");
    gold.append("\n      var n=[];");
    ...
    gold.append("\n      l.append(m);");
    gold.append("\n");
    gold.append("\n      // <div rx:template=\"foo\" ln:ch=\"7;2;7;25;schema.rx.html\">");
    gold.append("\n      var m=$.E('div');");
    ...
    gold.append("\n    b.append($.L($.pV(a),'w'));");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"set:w=1\" ln:ch=\"13;1;13;28;schema.rx.html\">");
    gold.append("\n    var g=$.E('button');");
    gold.append("\n    var j=[];");
    ...
    gold.append("\n    b.append(g);");
    gold.append("\n");
    gold.append("\n    // <div rx:template=\"foo\" ln:ch=\"14;1;14;24;schema.rx.html\">");
    gold.append("\n    var g=$.E('div');");
    ...
    gold.append("\n    b.append(g);");
    gold.append("\n");
    gold.append("\n    // <div rx:template=\"foo_scope\" ln:ch=\"17;1;17;30;schema.rx.html\">");
    gold.append("\n    var g=$.E('div');");
    gold.append("\n    $.UT(g,a,'foo_scope', function(l,m,o) {");
    gold.append("\n");
    gold.append("\n      // <button rx:click=\"set:v=1\" ln:ch=\"17;30;17;57;schema.rx.html\">");
    gold.append("\n      var p=$.E('button');");
    gold.append("\n      var q=[];");
