...
public class TemplateChoosenSimpleTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/\" ln:ch=\"0;0;0;14;choosenSimple.rx.html\">");
    ...
    gold.append("\n");
    gold.append("\n      // <div rx:if=\"choose:channel\" ln:ch=\"2;2;2;30;choosenSimple.rx.html\">");
    gold.append("\n      var g=$.E('div');");
    gold.append("\n      $.DE(g,f,f,'channel','id','id',true,false,function(i,h) {");
    gold.append("\n");
    gold.append("\n        // <button rx:click=\"choose:channel\" ln:ch=\"2;30;2;64;choosenSimple.rx.html\">");
    gold.append("\n        var j=$.E('button');");
    gold.append("\n        $.exCH(j,'click',h,'id','channel','id');");
    gold.append("\n");
    gold.append("\n        // <span rx:if=\"chosen:channel\" ln:ch=\"2;65;2;94;choosenSimple.rx.html\">");
    gold.append("\n        var k=$.E('span');");
    gold.append("\n        $.CSEN(k,h,h,'channel','id','id',true,false,function(m,l) {");
    gold.append("\n          m.append($.T(' Add Choice '));");
    gold.append("\n        },function(m,l) {");
    gold.append("\n");
    gold.append("\n          // <span rx:else=\"\" ln:ch=\"2;106;2;120;choosenSimple.rx.html\">");
    gold.append("\n          var n=$.E('span');");
    ...
    gold.append("\n      b.append(g);");
    gold.append("\n");
    gold.append("\n      // <div rx:if=\"finalize:channel\" ln:ch=\"4;2;4;32;choosenSimple.rx.html\">");
    gold.append("\n      var g=$.E('div');");
    gold.append("\n      $.FIN(g,f,'channel',true,false,function(i,h) {");
    gold.append("\n");
    gold.append("\n        // <button rx:click=\"finalize:channel\" ln:ch=\"4;32;4;68;choosenSimple.rx.html\">");
    gold.append("\n        var j=$.E('button');");
