...
public class TemplateMultipageWithMultiAuthTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/customeraction/$customer_id:text/signin\" default-redirect-source=\"\" ln:ch=\"0;0;0;77;multipageWithMultiAuth.rx.html\">");
    gold.append("\n  $.PG(['fixed','customeraction','text','customer_id','fixed','signin'], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n    b.append($.T(' Sign in for customers '));");
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/customer/$customer_id:text\" authenticate=\"\" ln:ch=\"3;0;3;53;multipageWithMultiAuth.rx.html\">");
    ...
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/adminaction/$admin_id:text/signin\" default-redirect-source=\"\" ln:ch=\"6;0;6;71;multipageWithMultiAuth.rx.html\">");
    gold.append("\n  $.PG(['fixed','adminaction','text','admin_id','fixed','signin'], function(b,a) {");
    gold.append("\n    var e=$.X();");
    gold.append("\n    b.append($.T(' Sign in for admins '));");
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/admin/$admin_id:text\" authenticate=\"\" ln:ch=\"9;0;9;47;multipageWithMultiAuth.rx.html\">");
    ...
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/bounce\" authenticate=\"\" ln:ch=\"12;0;12;33;multipageWithMultiAuth.rx.html\">");
    ...
    gold.append("\n  });");
    gold.append("\n");
    gold.append("\n  // <page uri=\"/logingeneric\" default-redirect-source=\"\" ln:ch=\"14;0;14;50;multipageWithMultiAuth.rx.html\">");
