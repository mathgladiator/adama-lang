...
public class TemplateCommandOrderToggleTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/\" ln:ch=\"0;0;0;14;commandOrderToggle.rx.html\">");
    gold.append("\n  $.PG(['fixed',''], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"ot:people_sort_by=age\" ln:ch=\"1;1;1;42;commandOrderToggle.rx.html\">");
    gold.append("\n    var d=$.E('button');");
    gold.append("\n    $.onOT(d,'click',$.pV(a),'people_sort_by','age');");
    gold.append("\n    d.append($.T('By Age'));");
    gold.append("\n    b.append(d);");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"ot:people_sort_by=name\" ln:ch=\"2;1;2;43;commandOrderToggle.rx.html\">");
    gold.append("\n    var d=$.E('button');");
