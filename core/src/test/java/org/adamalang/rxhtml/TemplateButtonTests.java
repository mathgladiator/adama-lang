...
public class TemplateButtonTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n");
    gold.append("\n  // <page uri=\"/\" ln:ch=\"0;0;0;14;button.rx.html\">");
    gold.append("\n  $.PG(['fixed',''], function(b,a) {");
    gold.append("\n    var c=$.X();");
    gold.append("\n");
    gold.append("\n    // <button rx:click=\"toggle:open\" ln:ch=\"1;1;1;32;button.rx.html\">");
    gold.append("\n    var d=$.E('button');");
    gold.append("\n    $.onT(d,'click',$.pV(a),'open');");
    gold.append("\n    d.append($.T('Toggle'));");
    gold.append("\n    b.append(d);");
    gold.append("\n");
    gold.append("\n    // <button rx:mouseenter=\"toggle:enter\" ln:ch=\"2;1;2;38;button.rx.html\">");
    gold.append("\n    var d=$.E('button');");
