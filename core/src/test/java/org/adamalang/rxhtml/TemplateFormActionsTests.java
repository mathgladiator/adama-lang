...
public class TemplateFormActionsTests extends BaseRxHtmlTest {
  ...
  public String gold() {
    ...
    gold.append("\n    $.onS(c,'failure',$.pV(a),'asset_upload_failed',true);");
    gold.append("\n    var fb = $.E('input');");
    gold.append("\n    fb.setAttribute('name',\"space\");");
    gold.append("\n    c.append(fb);");
    gold.append("\n    var fb = $.E('input');");
    gold.append("\n    fb.setAttribute('name',\"key\");");
    gold.append("\n    c.append(fb);");
    gold.append("\n    var fb = $.E('input');");
