...
public class SelectoRxTObjectListTests {
  ...
  public void table_iterate_delete() {
    ...
    Assert.assertEquals("\"t\":{\"4\":{\"data\":\"\",\"index\":13},\"5\":{\"data\":\"\",\"index\":13},\"6\":{\"data\":\"\",\"index\":13}}", reverse.toString());
  }
  ...
  public void table_iterate_lookup() {
    ...
    final var table = new RxTable<>(document, document, "name", MockRecord::new, 1);
    table.__insert(new JsonStreamReader("{\"4\":{\"index\":13},\"5\":{\"index\":12},\"6\":{\"index\":13},\"7\":{\"index\":5}}}"));
  ...
  public void table_iterate_map() {
    ...
    final var reverse = new JsonStreamWriter();
    table.__commit("t", writer, reverse);
    Assert.assertEquals("\"t\":{\"4\":{\"data\":\"cake\"},\"5\":{\"data\":\"cake\"},\"6\":{\"data\":\"cake\"}}", writer.toString());
    Assert.assertEquals("\"t\":{\"4\":{\"data\":\"\"},\"5\":{\"data\":\"\"},\"6\":{\"data\":\"\"}}", reverse.toString());
  }
  ...
  public void table_iterate_transform() {
    ...
    final var reverse = new JsonStreamWriter();
    table.__commit("t", writer, reverse);
    Assert.assertEquals("\"t\":{\"4\":{\"index\":14},\"5\":{\"index\":13},\"6\":{\"index\":14}}", writer.toString());
    Assert.assertEquals("\"t\":{\"4\":{\"index\":13},\"5\":{\"index\":12},\"6\":{\"index\":13}}", reverse.toString());
  }
