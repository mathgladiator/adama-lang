...
public class ServiceTemporalTests {
    ...
    private static final String SIMPLE_CODE_MSG = "public int x; @connected(who) { x = 42; return who == @no_one; } message M {} channel foo(M y) { x += 100; transition #bump in 0.25; } #bump { x += 1000; transition #end; } #end {} ";
    private static final String SIMPLE_BOUNCER = "public int x; @connected(who) { return true; } @construct { transition #bounce in 0.05; } #bounce { x += 1; transition #bounce in 0.05; } ";
    ...
    private static Integer getX(MockStreamback streamback, int k) {
        ...
        return (Integer) ((HashMap<String, Object>) ((HashMap<String, Object>) reader.readJavaTree()).get("data")).get("x");
    }
    ...
    public void transitions_scan_process_start() throws Exception {
        ...
        realDataService.initialize(KEY, ServiceConnectTests.wrap("{\"__state\":\"bounce\",\"__constructed\":true,\"__next_time\":\"1637878366533\",\"__time\":\"1637878366483\"}"), Callback.DONT_CARE_VOID);
        realDataService.patch(KEY, ServiceConnectTests.wrap("{\"__messages\":null,\"__seq\":1,\"__entropy\":\"-4776469697456872557\",\"__time\":\"1637878366498\"}"), Callback.DONT_CARE_VOID);
    ...
    public void load_after_create_pause() throws Exception {
        ...
        try {
            ...
            dataService.assertLogAt(1, "PATCH:space/key:1->{\"__messages\":null,\"__seq\":1,\"__entropy\":\"-4964420948893066024\"}");
            dataService.assertLogAt(2, "LOAD:space/key");
            dataService.assertLogAt(3, "PATCH:space/key:2->{\"__seq\":2,\"__connection_id\":1,\"x\":42,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"}}}");
            dataService.assertLogAt(4, "PATCH:space/key:3->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"323091568684100223\"}");
            dataService.assertLogAt(5, "PATCH:space/key:4->{\"__messages\":null,\"__seq\":4,\"__entropy\":\"-6153234687710755147\"}");
            dataService.assertLogAt(6, "PATCH:space/key:5->{\"__seq\":5,\"__clients\":{\"0\":null}}");
            dataService.assertLogAt(7, "PATCH:space/key:6->{\"__messages\":null,\"__seq\":6,\"__entropy\":\"6497997367891420869\"}");
