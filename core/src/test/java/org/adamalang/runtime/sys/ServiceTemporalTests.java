...
public class ServiceTemporalTests {
  ...
  public void load_after_create_pause() throws Exception {
    ...
    try {
      ...
      dataService.assertLogAt(1, "PATCH:space/key:1-1->{\"__messages\":null,\"__seq\":1,\"__entropy\":\"-4964420948893066024\"}");
      dataService.assertLogAt(2, "LOAD:space/key");
      dataService.assertLogAt(3, "PATCH:space/key:2-3->{\"__seq\":3,\"__connection_id\":1,\"x\":42,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"}},\"__messages\":null,\"__entropy\":\"323091568684100223\"}");
      dataService.assertLogAt(4, "PATCH:space/key:4-4->{\"__messages\":null,\"__seq\":4,\"__entropy\":\"-6153234687710755147\"}");
      dataService.assertLogAt(5, "PATCH:space/key:5-6->{\"__seq\":6,\"__clients\":{\"0\":null},\"__messages\":null,\"__entropy\":\"6497997367891420869\"}");
