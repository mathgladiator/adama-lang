...
public class ServiceCatastropheTests {
  ...
  public void send_failure_disconnects_and_reconcile() throws Exception {
    ...
    try {
      ...
      realDataService.assertLogAt(
          3,
          "PATCH:space/key:2->{\"__seq\":2,\"__connection_id\":1,\"x\":1,\"__clients\":{\"0\":{\"agent\":\"alice\",\"authority\":\"test\"}}}");
      realDataService.assertLogAt(
          4,
      ...
      realDataService.assertLogAt(
          7,
          "PATCH:space/key:5->{\"__seq\":5,\"__connection_id\":2,\"x\":2,\"__clients\":{\"1\":{\"agent\":\"bob\",\"authority\":\"test\"}}}");
      realDataService.assertLogAt(
          8,
          "PATCH:space/key:6->{\"__messages\":null,\"__seq\":6,\"__entropy\":\"6497997367891420869\"}");
      realDataService.assertLogAt(
          9,
          "PATCH:space/key:7->{\"__messages\":null,\"__seq\":7,\"__entropy\":\"-5218234856268126500\"}");
      realDataService.assertLogAt(
          10, "PATCH:space/key:8->{\"__seq\":8,\"x\":1,\"__clients\":{\"0\":null}}");
