...
public class InMemoryDataServiceTests {
  ...
  public void compaction() {
    ...
    ds.compactAndSnapshot(key, 1, "{}", 100, new Callback<Integer>() {
      @Override
      public void success(Integer value) {
    ...
    ds.compactAndSnapshot(key, 1, "{}", 1000, new Callback<Integer>() {
      @Override
      public void success(Integer value) {
    ...
    ds.compactAndSnapshot(new Key("spaaaaaace", "keeeey"), 1, "{}", 1000, new Callback<Integer>() {
      @Override
      public void success(Integer value) {
      }
