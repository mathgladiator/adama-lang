...
public class GeneratedJsonTests extends GeneratedBase {
  private String cached_Basics_1 = null;
  private String get_Basics_1() {
    if (cached_Basics_1 != null) {
      return cached_Basics_1;
    }
    cached_Basics_1 = generateTestOutput(true, "Basics_1", "./test_code/Json_Basics_success.a");
    return cached_Basics_1;
  }

  @Test
  public void testBasicsEmission() {
    assertEmissionGood(get_Basics_1());
  }

  @Test
  public void testBasicsSuccess() {
    assertLivePass(get_Basics_1());
  }

  @Test
  public void testBasicsNoFormatException() {
    assertNoFormatException(get_Basics_1());
  }

  @Test
  public void testBasicsGoodWillHappy() {
    assertGoodWillHappy(get_Basics_1());
  }

  @Test
  public void testBasicsExceptionFree() {
    assertExceptionFree(get_Basics_1());
  }

  @Test
  public void testBasicsTODOFree() {
    assertTODOFree(get_Basics_1());
  }

  @Test
  public void stable_Basics_1() {
    String live = get_Basics_1();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:Json_Basics_success.a");
    gold.append("\n--EMISSION-----------------------------------------");
    ...
    gold.append("\npublic class Basics_1 extends LivingDocument {");
    gold.append("\n  private final RxLazy<NtMaybe<NtJson>> pj;");
    gold.append("\n  private final RxLazy<NtMaybe<NtJson>> pj_x;");
    gold.append("\n  private final RxLazy<NtJson> npj;");
    gold.append("\n  private final RxLazy<NtJson> npj_0;");
    gold.append("\n  @Override");
    ...
    gold.append("\n    __sum += pj_x.__memory();");
    gold.append("\n    __sum += npj.__memory();");
    gold.append("\n    __sum += npj_0.__memory();");
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Basics_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    pj = new RxLazy<NtMaybe<NtJson>>(this, () -> (NtMaybe<NtJson>)(LibJson.parse(\"{\\\"x\\\":123}\")), null);");
    gold.append("\n    pj_x = new RxLazy<NtMaybe<NtJson>>(this, () -> (NtMaybe<NtJson>)(LibJson.parse(\"{\\\"x\\\":123}\").unpack((__item) -> ((NtJson) __item).deref(\"x\"))), null);");
    gold.append("\n    npj = new RxLazy<NtJson>(this, () -> (NtJson)(LibJson.parsen(\"[42]\")), null);");
    gold.append("\n    npj_0 = new RxLazy<NtJson>(this, () -> (NtJson)(LibJson.parsen(\"[42]\").deref(0)), null);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  public void __settle(Set<Integer> __viewers) {");
    gold.append("\n    pj.__settle(__viewers);");
    gold.append("\n    pj_x.__settle(__viewers);");
    gold.append("\n    npj.__settle(__viewers);");
    gold.append("\n    npj_0.__settle(__viewers);");
    gold.append("\n  }");
    gold.append("\n  @Override");
    ...
    gold.append("\n  }");
    gold.append("\n  private class DeltaBasics_1 implements DeltaNode {");
    gold.append("\n    private int __gpj;");
    gold.append("\n    private DMaybe<DDynamic> __dpj;");
    gold.append("\n    private int __gpj_x;");
    gold.append("\n    private DMaybe<DDynamic> __dpj_x;");
    gold.append("\n    private int __gnpj;");
    gold.append("\n    private DDynamic __dnpj;");
    gold.append("\n    private int __gnpj_0;");
    gold.append("\n    private DDynamic __dnpj_0;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaBasics_1() {");
    gold.append("\n      __gpj = -1;");
    gold.append("\n      __dpj = new DMaybe<DDynamic>();");
    gold.append("\n      __gpj_x = -1;");
    gold.append("\n      __dpj_x = new DMaybe<DDynamic>();");
    gold.append("\n      __gnpj = -1;");
    gold.append("\n      __dnpj = new DDynamic();");
    gold.append("\n      __gnpj_0 = -1;");
    gold.append("\n      __dnpj_0 = new DDynamic();");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    gold.append("\n      long __sum = 40;");
    gold.append("\n      __sum += __dpj.__memory();");
    gold.append("\n      __sum += __dpj_x.__memory();");
    gold.append("\n      __sum += __dnpj.__memory();");
    gold.append("\n      __sum += __dnpj_0.__memory();");
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(Basics_1 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      __code_cost += 4;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    gold.append("\n      if (__gpj != __item.pj.getGeneration()) {");
    gold.append("\n        if (__item.pj.get().has()) {");
    gold.append("\n          NtJson __maybeElement1 = (NtJson)(__item.pj.get().get());");
    gold.append("\n          DDynamic __maybeDeltaElement2 = __dpj.get(() -> new DDynamic());");
    gold.append("\n          __maybeDeltaElement2.show(__maybeElement1, __obj.planField(\"pj\"));");
    gold.append("\n        } else {");
    gold.append("\n          __dpj.hide(__obj.planField(\"pj\"));");
    gold.append("\n        }");
    gold.append("\n        __gpj = __item.pj.getGeneration();");
    gold.append("\n      }");
    gold.append("\n      if (__gpj_x != __item.pj_x.getGeneration()) {");
    gold.append("\n        if (__item.pj_x.get().has()) {");
    gold.append("\n          NtJson __maybeElement3 = (NtJson)(__item.pj_x.get().get());");
    gold.append("\n          DDynamic __maybeDeltaElement4 = __dpj_x.get(() -> new DDynamic());");
    gold.append("\n          __maybeDeltaElement4.show(__maybeElement3, __obj.planField(\"pj_x\"));");
    gold.append("\n        } else {");
    gold.append("\n          __dpj_x.hide(__obj.planField(\"pj_x\"));");
    gold.append("\n        }");
    gold.append("\n        __gpj_x = __item.pj_x.getGeneration();");
    gold.append("\n      }");
    gold.append("\n      if (__gnpj != __item.npj.getGeneration()) {");
    gold.append("\n        __dnpj.show(__item.npj.get(), __obj.planField(\"npj\"));");
    gold.append("\n        __gnpj = __item.npj.getGeneration();");
    gold.append("\n      }");
    gold.append("\n      if (__gnpj_0 != __item.npj_0.getGeneration()) {");
    gold.append("\n        __dnpj_0.show(__item.npj_0.get(), __obj.planField(\"npj_0\"));");
    gold.append("\n        __gnpj_0 = __item.npj_0.getGeneration();");
    gold.append("\n      }");
    gold.append("\n      if (__obj.end()) {");
    gold.append("\n        __emitted = true;");
    gold.append("\n      }");
    ...
    gold.append("\n    Basics_1 __self = this;");
    gold.append("\n    DeltaBasics_1 __state = new DeltaBasics_1();");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private NtJson __FUNC_0_foo(NtDynamic d) {");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(0);");
    gold.append("\n    return d.to_json();");
    gold.append("\n  }");
    ...
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(0);");
    gold.append("\n    NtMaybe<NtJson> _AutoConditionj1_5;");
    gold.append("\n    if ((_AutoConditionj1_5 = LibJson.parse(\"{}\")).has()) {");
    gold.append("\n      NtJson j1 = _AutoConditionj1_5.get();");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      __track(1);");
    gold.append("\n      NtJson j2 = j1;");
    gold.append("\n    }");
    ...
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{\"pj\":{\"type\":{\"nature\":\"native_maybe\",\"type\":{\"nature\":\"native_value\",\"type\":\"json\"}},\"computed\":true,\"privacy\":\"public\"},\"pj_x\":{\"type\":{\"nature\":\"native_maybe\",\"type\":{\"nature\":\"native_value\",\"type\":\"json\"}},\"computed\":true,\"privacy\":\"public\"},\"npj\":{\"type\":{\"nature\":\"native_value\",\"type\":\"json\"},\"computed\":true,\"privacy\":\"public\"},\"npj_0\":{\"type\":{\"nature\":\"native_value\",\"type\":\"json\"},\"computed\":true,\"privacy\":\"public\"}}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}}},\"channels\":{},\"channels-privacy\":{},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
    ...
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"pj\":{\"x\":123},\"pj_x\":123,\"npj\":[42],\"npj_0\":42},\"seq\":3}");
    ...
    gold.append("\n+ NO_ONE DELTA:{\"seq\":4}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"pj\":{\"x\":123},\"pj_x\":123,\"npj\":[42],\"npj_0\":42},\"seq\":4}");
