...
public class GeneratedReactiveTests extends GeneratedBase {
  private String cached_ReorderTyping_1 = null;
  private String get_ReorderTyping_1() {
    if (cached_ReorderTyping_1 != null) {
      return cached_ReorderTyping_1;
    }
    cached_ReorderTyping_1 = generateTestOutput(true, "ReorderTyping_1", "./test_code/Reactive_ReorderTyping_success.a");
    return cached_ReorderTyping_1;
  }

  @Test
  public void testReorderTypingEmission() {
    assertEmissionGood(get_ReorderTyping_1());
  }

  @Test
  public void testReorderTypingSuccess() {
    assertLivePass(get_ReorderTyping_1());
  }

  @Test
  public void testReorderTypingGoodWillHappy() {
    assertGoodWillHappy(get_ReorderTyping_1());
  }

  @Test
  public void testReorderTypingExceptionFree() {
    assertExceptionFree(get_ReorderTyping_1());
  }

  @Test
  public void testReorderTypingTODOFree() {
    assertTODOFree(get_ReorderTyping_1());
  }

  @Test
  public void stable_ReorderTyping_1() {
    String live = get_ReorderTyping_1();
    ...
    gold.append("\npublic class ReorderTyping_1 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public ReorderTyping_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaReorderTyping_1 implements DeltaNode {");
    gold.append("\n    private DInt32 __dx;");
    gold.append("\n    private int __gy;");
    gold.append("\n    private DInt32 __dy;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaReorderTyping_1() {");
    gold.append("\n      __dx = new DInt32();");
    gold.append("\n      __gy = -1;");
    gold.append("\n      __dy = new DInt32();");
    gold.append("\n      __emitted = false;");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(ReorderTyping_1 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 2;");
    ...
    gold.append("\n    ReorderTyping_1 __self = this;");
    gold.append("\n    DeltaReorderTyping_1 __state = new DeltaReorderTyping_1();");
    ...
    gold.append("\nEnd");
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{\"x\":{\"type\":{\"nature\":\"reactive_value\",\"type\":\"int\"},\"privacy\":\"public\"},\"y\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"public\"}}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}}},\"channels\":{},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
    ...
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"x\":0,\"y\":1},\"seq\":3}");
    ...
    gold.append("\n+ NO_ONE DELTA:{\"seq\":4}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"x\":0,\"y\":1},\"seq\":4}");
