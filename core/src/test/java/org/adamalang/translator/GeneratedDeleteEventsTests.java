...
public class GeneratedDeleteEventsTests extends GeneratedBase {
  ...
  public void stable_DeleteMustReturn_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":8,\"byte\":8},\"end\":{\"line\":1,\"character\":1,\"byte\":11}},\"severity\":1,\"source\":\"error\",\"message\":\"The @delete handler must return a boolean\",\"file\":\"./test_code/DeleteEvents_DeleteMustReturn_failure.a\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
