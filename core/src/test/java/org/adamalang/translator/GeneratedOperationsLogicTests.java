...
public class GeneratedOperationsLogicTests extends GeneratedBase {
  ...
  public void stable_Formulas_1() {
    ...
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"f0\":true,\"f1\":true,\"f2\":false,\"f3\":true,\"f4\":false,\"f5\":true,\"f6\":true,\"f7\":false,\"f8\":true,\"f9\":false,\"f10\":false,\"f11\":false},\"seq\":2}");
    gold.append("\nNO_ONE was DENIED");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"75\"}-->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"75\"} need:false in:-75");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":3}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"f0\":true,\"f1\":true,\"f2\":false,\"f3\":true,\"f4\":false,\"f5\":true,\"f6\":true,\"f7\":false,\"f8\":true,\"f9\":false,\"f10\":false,\"f11\":false},\"seq\":3}");
    gold.append("\nRANDO was DENIED:");
