...
public class GeneratedGraphTests extends GeneratedBase {
  ...
  private String cached_JoinRoot_6 = null;
  private String get_JoinRoot_6() {
    if (cached_JoinRoot_6 != null) {
      return cached_JoinRoot_6;
    }
    cached_JoinRoot_6 = generateTestOutput(true, "JoinRoot_6", "./test_code/Graph_JoinRoot_success.a");
    return cached_JoinRoot_6;
  }

  @Test
  public void testJoinRootEmission() {
    assertEmissionGood(get_JoinRoot_6());
  }

  @Test
  public void testJoinRootSuccess() {
    assertLivePass(get_JoinRoot_6());
  }

  @Test
  public void testJoinRootGoodWillHappy() {
    assertGoodWillHappy(get_JoinRoot_6());
  }

  @Test
  public void testJoinRootExceptionFree() {
    assertExceptionFree(get_JoinRoot_6());
  }

  @Test
  public void testJoinRootTODOFree() {
    assertTODOFree(get_JoinRoot_6());
  }

  @Test
  public void stable_JoinRoot_6() {
    String live = get_JoinRoot_6();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class JoinRoot_6 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public JoinRoot_6(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaJoinRoot_6 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaJoinRoot_6() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(JoinRoot_6 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    ...
    gold.append("\n  @Override");
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    JoinRoot_6 __self = this;");
    gold.append("\n    DeltaJoinRoot_6 __state = new DeltaJoinRoot_6();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    int __viewId = __genViewId();");
    gold.append("\n    return new PrivateView(__viewId, __who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
