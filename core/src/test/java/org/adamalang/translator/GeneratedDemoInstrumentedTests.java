...
public class GeneratedDemoInstrumentedTests extends GeneratedBase {
  ...
  public void stable_GameHearts_1() {
    ...
    gold.append("\n    people = new RxLazy<NtList<RTxPlayer>>(this, () -> (NtList<RTxPlayer>)(players.iterate(false).orderBy(true, __ORDER_Player_play_order_a)), () -> __perf.measure(\"f_Root_people\"));");
    ...
    gold.append("\n    hand = new RxLazy<NtList<RTxCard>>(this, () -> (NtList<RTxCard>)(deck.iterate(false).where(true, new __CLOSURE_WhereClause0())), () -> __perf.measure(\"f_Root_hand\"));");
    gold.append("\n    __hand_deck = new RxTableGuard(hand);");
    gold.append("\n    players_connected = new RxLazy<Integer>(this, () -> (Integer)((players.iterate(false).where(true, new __CLOSURE_WhereClause4())).size()), () -> __perf.measure(\"f_Root_players_connected\"));");
    gold.append("\n    __players_connected_players = new RxTableGuard(players_connected);");
    gold.append("\n    observers_connected = new RxLazy<Integer>(this, () -> (Integer)((players.iterate(false).where(true, new __CLOSURE_WhereClause5())).size()), () -> __perf.measure(\"f_Root_observers_connected\"));");
    gold.append("\n    __observers_connected_players = new RxTableGuard(observers_connected);");
    gold.append("\n    players_ordered = new RxLazy<NtList<RTxPlayer>>(this, () -> (NtList<RTxPlayer>)(players.iterate(false).where(false, new __CLOSURE_WhereClause6()).orderBy(true, __ORDER_Player_play_order_a)), () -> __perf.measure(\"f_Root_players_ordered\"));");
    ...
    gold.append("\n    __writer.beginObject();");
    gold.append("\n    current.__reportRx(\"current\", __writer);");
    gold.append("\n    deck.__reportRx(\"deck\", __writer);");
    gold.append("\n    hand.__reportRx(\"hand\", __writer);");
    gold.append("\n    in_play.__reportRx(\"in_play\", __writer);");
    gold.append("\n    last_winner.__reportRx(\"last_winner\", __writer);");
    gold.append("\n    observers_connected.__reportRx(\"observers_connected\", __writer);");
    gold.append("\n    owner.__reportRx(\"owner\", __writer);");
    gold.append("\n    passing_mode.__reportRx(\"passing_mode\", __writer);");
    gold.append("\n    people.__reportRx(\"people\", __writer);");
    gold.append("\n    played.__reportRx(\"played\", __writer);");
    gold.append("\n    player1.__reportRx(\"player1\", __writer);");
    gold.append("\n    player2.__reportRx(\"player2\", __writer);");
    gold.append("\n    player3.__reportRx(\"player3\", __writer);");
    gold.append("\n    player4.__reportRx(\"player4\", __writer);");
    gold.append("\n    players.__reportRx(\"players\", __writer);");
    gold.append("\n    players_connected.__reportRx(\"players_connected\", __writer);");
    gold.append("\n    players_ordered.__reportRx(\"players_ordered\", __writer);");
    gold.append("\n    playing.__reportRx(\"playing\", __writer);");
    gold.append("\n    points_awarded.__reportRx(\"points_awarded\", __writer);");
    ...
    gold.append("\n      points = new RxLazy<Integer>(this, () -> (Integer)((((int) suit.get()) == ((int) 2) ? 1 : (((int) suit.get()) == ((int) 3) && ((int) rank.get()) == ((int) 12) ? 13 : 0))), () -> __perf.measure(\"f_Card_points\"));");
    ...
    gold.append("\n    public void __writeRxReport(JsonStreamWriter __writer) {");
    gold.append("\n      __writer.beginObject();");
    gold.append("\n      id.__reportRx(\"id\", __writer);");
    gold.append("\n      ordering.__reportRx(\"ordering\", __writer);");
    gold.append("\n      owner.__reportRx(\"owner\", __writer);");
    gold.append("\n      place.__reportRx(\"place\", __writer);");
    gold.append("\n      points.__reportRx(\"points\", __writer);");
    gold.append("\n      rank.__reportRx(\"rank\", __writer);");
    gold.append("\n      suit.__reportRx(\"suit\", __writer);");
    gold.append("\n      __writer.endObject();");
    gold.append("\n    }");
    gold.append("\n    @Override");
    ...
    gold.append("\n      __writer.beginObject();");
    gold.append("\n      id.__reportRx(\"id\", __writer);");
    gold.append("\n      leader.__reportRx(\"leader\", __writer);");
    gold.append("\n      link.__reportRx(\"link\", __writer);");
    gold.append("\n      play_order.__reportRx(\"play_order\", __writer);");
    gold.append("\n      playing.__reportRx(\"playing\", __writer);");
    gold.append("\n      points.__reportRx(\"points\", __writer);");
    gold.append("\n      __writer.endObject();");
    gold.append("\n    }");
  ...
  public void stable_chat_2() {
    ...
    gold.append("\n    chat = new RxLazy<NtList<RTxLine>>(this, () -> (NtList<RTxLine>)(_chat.iterate(true)), () -> __perf.measure(\"f_Root_chat\"));");
    ...
    gold.append("\n        {");
    gold.append("\n          PrivateLazyDeltaWriter __list6 = __obj.planField(\"chat\").planObject();");
    gold.append("\n          DRecordList<DeltaRTxLine> __deltaList7 = __dchat;");
    gold.append("\n          DRecordList<DeltaRTxLine>.Walk __deltaListWalker8 = __deltaList7.begin();");
    gold.append("\n          for (RTxLine __listElement9 : __item.chat.get()) {");
    gold.append("\n            DeltaRTxLine __deltaElement10 = __deltaList7.getPrior(__listElement9.__id(), () -> new DeltaRTxLine());");
    ...
    gold.append("\n      __writer.beginObject();");
    gold.append("\n      id.__reportRx(\"id\", __writer);");
    gold.append("\n      what.__reportRx(\"what\", __writer);");
    gold.append("\n      when.__reportRx(\"when\", __writer);");
    gold.append("\n      who.__reportRx(\"who\", __writer);");
    gold.append("\n      __writer.endObject();");
    gold.append("\n    }");
    gold.append("\n    @Override");
    ...
    gold.append("\n      Runnable __measure_12 = __perf.measure(\"mt_foo\");");
    gold.append("\n      try {");
    gold.append("\n        __code_cost += 2;");
    gold.append("\n        __track(0);");
    gold.append("\n        return 1;");
    ...
    gold.append("\n    private RTx_AnonObjConvert_4(String html) {");
    gold.append("\n      this.__this = this;");
    gold.append("\n      this.html = html;");
    gold.append("\n    }");
    gold.append("\n  }");
    ...
    gold.append("\n    Runnable __measure_13 = __perf.measure(\"fn_foo\");");
    gold.append("\n    try {");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      __track(1);");
    gold.append("\n      return 123;");
    ...
    gold.append("\n    Runnable __measure_14 = __perf.measure(\"fn_g\");");
    gold.append("\n    try {");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      __track(0);");
    gold.append("\n      return x + y;");
    ...
    gold.append("\n    __track(2);");
    gold.append("\n    {");
    gold.append("\n      RxTable<RTxLine> _AutoRef15 = _chat;");
    gold.append("\n      RTx_AnonObjConvert_2 _AutoExpr17 = new RTx_AnonObjConvert_2(what.what, __timeNow(), __who);");
    gold.append("\n      RTxLine _CreateRef16 = _AutoRef15.make();");
    gold.append("\n      __code_cost += 4;");
    gold.append("\n      _CreateRef16.what.set(_AutoExpr17.what);");
    gold.append("\n      _CreateRef16.when.set(_AutoExpr17.when);");
    gold.append("\n      _CreateRef16.who.set(_AutoExpr17.who);");
    gold.append("\n    }");
    gold.append("\n    __track(3);");
    ...
    gold.append("\n        }");
    gold.append("\n      }");
    gold.append("\n      if (_0.fragment.equals(\"happy-times\")) {");
    gold.append("\n        WebFragment _1 = __path.at(1);");
    gold.append("\n        if (_1 != null) {");
    gold.append("\n          /** END:1*/");
    gold.append("\n        } else {");
    gold.append("\n          return __get_LD(__context, __request.context.who, __request);");
    gold.append("\n        }");
    gold.append("\n      }");
    gold.append("\n      /** END:0*/");
    gold.append("\n    }");
    ...
    gold.append("\n    Runnable __measure = __perf.measure(\"wb_get_foo\");");
    gold.append("\n    try {");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      __track(4);");
    gold.append("\n      {");
    gold.append("\n        RTx_AnonObjConvert_4 __capture18 = new RTx_AnonObjConvert_4(\"Happy\");");
    gold.append("\n        return new WebResponse().html(__capture18.html);");
    gold.append("\n      }");
    gold.append("\n    } finally {");
    gold.append("\n      __measure.run();");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n");
    gold.append("\n  private WebResponse __get_LD(CoreRequestContext __context, NtPrincipal __who, WebGet __request) throws AbortMessageException {");
    gold.append("\n    Runnable __measure = __perf.measure(\"wb_get_happy-times\");");
    gold.append("\n    try {");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      __track(5);");
    gold.append("\n      {");
    gold.append("\n        RTx_AnonObjConvert_4 __capture19 = new RTx_AnonObjConvert_4(\"Happy\");");
    gold.append("\n        return new WebResponse().html(__capture19.html);");
    gold.append("\n      }");
    gold.append("\n    } finally {");
    gold.append("\n      __measure.run();");
    gold.append("\n    }");
