...
public class GeneratedDefineTests extends GeneratedBase {
  ...
  public void stable_BumpWrongType_5() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":7,\"character\":11,\"byte\":0},\"end\":{\"line\":7,\"character\":12,\"byte\":77}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of 'bool', but the type is actually 'int' (TypeCheckFailures)\"},{\"range\":{\"start\":{\"line\":8,\"character\":4,\"byte\":22},\"end\":{\"line\":8,\"character\":17,\"byte\":97}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of 'bool', but the type is actually 'string' (TypeCheckFailures)\"},{\"range\":{\"start\":{\"line\":11,\"character\":2,\"byte\":22},\"end\":{\"line\":11,\"character\":15,\"byte\":132}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: Must have a type of 'int', 'long', 'double', 'list<int>', 'list<long>', 'list<double>'; instead got 'list<r<string>>' (CanBumpNumeric)\"},{\"range\":{\"start\":{\"line\":12,\"character\":5,\"byte\":22},\"end\":{\"line\":12,\"character\":18,\"byte\":155}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: Must have a type of 'int', 'long', 'double', 'list<int>', 'list<long>', 'list<double>'; instead got 'list<r<string>>' (CanBumpNumeric)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_RightSideFailTyping_16() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":10,\"byte\":0},\"end\":{\"line\":1,\"character\":18,\"byte\":2147483647}},\"severity\":1,\"source\":\"error\",\"message\":\"Could not find a meaning for 'string' + '__ViewerType' (OperatorTable)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
