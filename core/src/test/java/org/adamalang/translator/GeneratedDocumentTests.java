...
public class GeneratedDocumentTests extends GeneratedBase {
  ...
  public void stable_GlobalPolicy_8() {
    ...
    gold.append("\n+ NO_ONE DELTA:{\"seq\":8}");
    gold.append("\n+ RANDO DELTA:{\"seq\":8}");
    gold.append("\n{\"command\":\"bill\",\"timestamp\":\"225\"}-->{\"__goodwill_used\":0,\"__cost\":15,\"__billing_seq\":8,\"__seq\":9,\"__time\":\"225\"} need:true in:0");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"250\"}-->{\"__messages\":null,\"__seq\":10,\"__entropy\":\"5082315122564986995\",\"__time\":\"250\"} need:false in:-250");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":10}");
    gold.append("\n+ RANDO DELTA:{\"seq\":10}");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"r\":{\"1\":{\"x\":1,\"id\":1}},\"z2\":0,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":10,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"250\",\"__auto_table_row_id\":1,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{\"r\":{\"1\":{\"x\":1,\"id\":1}},\"z2\":0,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":10,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"250\",\"__auto_table_row_id\":1,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n{\"r\":{\"1\":{\"x\":1,\"id\":1}},\"z2\":0,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":10,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"250\",\"__auto_table_row_id\":1,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n--JAVA TEST RESULTS--------------------------------");
