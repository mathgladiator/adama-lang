...
public class GeneratedChannelsTests extends GeneratedBase {
  ...
  public void stable_AsyncLegacy_1() {
    ...
    gold.append("\n      __track(19);");
    gold.append("\n      __queue.add(new AsyncTask(0, NtPrincipal.NO_ONE, \"chan\", 0, new RTxX(5, 10)));");
    gold.append("\n      __track(20);");
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"ip\",\"origin\":\"0\",\"ip\":\"origin\"}-->{\"__state\":\"begin\",\"__constructed\":true,\"__entropy\":\"0\"} need:true in:0");
  ...
  public void stable_DuplicateHandlers_2() {
    ...
    gold.append("\n  @Override");
    gold.append("\n  public void __executeServiceCalls(boolean cancel) {}");
    gold.append("\n  private void handleChannelMessage_goo(NtPrincipal __who, RTxX x) throws AbortMessageException {");
    gold.append("\n    __code_cost += 1;");
    gold.append("\n");
    gold.append("\n  }");
    gold.append("\n  @Override");
  ...
  public void stable_HandlerLegacy_4() {
    ...
    gold.append("\n  @Override");
    gold.append("\n  public void __executeServiceCalls(boolean cancel) {}");
    gold.append("\n  private void handleChannelMessage_chan1(NtPrincipal __who, RTxM m) throws AbortMessageException {");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(0);");
    gold.append("\n    return;");
    gold.append("\n");
    gold.append("\n  }");
    gold.append("\n  private void handleChannelMessage_chan2(NtPrincipal __who, RTxM m) throws AbortMessageException {");
    gold.append("\n    __code_cost += 1;");
    gold.append("\n");
    gold.append("\n  }");
    gold.append("\n  @Override");
  ...
  public void stable_MessageHasEnum_5() {
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaMessageHasEnum_5 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
  ...
  private String get_MessageHasMethod_6() {
    if (cached_MessageHasMethod_6 != null) {
      return cached_MessageHasMethod_6;
    }
    cached_MessageHasMethod_6 = generateTestOutput(true, "MessageHasMethod_6", "./test_code/Channels_MessageHasMethod_success.a");
    return cached_MessageHasMethod_6;
  }

  @Test
  public void testMessageHasMethodEmission() {
    assertEmissionGood(get_MessageHasMethod_6());
  }

  @Test
  public void testMessageHasMethodSuccess() {
    assertLivePass(get_MessageHasMethod_6());
  }

  @Test
  public void testMessageHasMethodGoodWillHappy() {
    assertGoodWillHappy(get_MessageHasMethod_6());
  }

  @Test
  public void testMessageHasMethodExceptionFree() {
    assertExceptionFree(get_MessageHasMethod_6());
  }

  @Test
  public void testMessageHasMethodTODOFree() {
    assertTODOFree(get_MessageHasMethod_6());
  }

  @Test
  public void stable_MessageHasMethod_6() {
    String live = get_MessageHasMethod_6();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Set;");
    gold.append("\nimport java.lang.Math;");
    gold.append("\npublic class MessageHasMethod_6 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public MessageHasMethod_6(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaMessageHasMethod_6 implements DeltaNode {");
    gold.append("\n    private DDynamic __dz;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaMessageHasMethod_6() {");
    gold.append("\n      __dz = new DDynamic();");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(MessageHasMethod_6 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 1;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    ...
    gold.append("\n  @Override");
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    MessageHasMethod_6 __self = this;");
    gold.append("\n    DeltaMessageHasMethod_6 __state = new DeltaMessageHasMethod_6();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    return new PrivateView(__who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
    gold.append("\n      public long memory() {");
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"ip\",\"origin\":\"0\",\"ip\":\"origin\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"z\":{\"val\":32},\"__messages\":null,\"__seq\":1} need:false in:0");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"25\"}-->{\"__messages\":null,\"__seq\":2,\"__entropy\":\"4804307197456638271\",\"__time\":\"25\"} need:false in:-25");
    gold.append("\nCPU:2");
    gold.append("\nMEMORY:480");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"50\"}-->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"50\"} need:false in:-50");
  ...
  private String get_MessageMethodsScopedStatic_7() {
    if (cached_MessageMethodsScopedStatic_7 != null) {
      return cached_MessageMethodsScopedStatic_7;
    }
    cached_MessageMethodsScopedStatic_7 = generateTestOutput(false, "MessageMethodsScopedStatic_7", "./test_code/Channels_MessageMethodsScopedStatic_failure.a");
    return cached_MessageMethodsScopedStatic_7;
  }

  @Test
  public void testMessageMethodsScopedStaticFailure() {
    assertLiveFail(get_MessageMethodsScopedStatic_7());
  }

  @Test
  public void testMessageMethodsScopedStaticNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_MessageMethodsScopedStatic_7());
  }

  @Test
  public void testMessageMethodsScopedStaticExceptionFree() {
    assertExceptionFree(get_MessageMethodsScopedStatic_7());
  }

  @Test
  public void testMessageMethodsScopedStaticTODOFree() {
    assertTODOFree(get_MessageMethodsScopedStatic_7());
  }

  @Test
  public void stable_MessageMethodsScopedStatic_7() {
    String live = get_MessageMethodsScopedStatic_7();
    StringBuilder gold = new StringBuilder();
  ...
  private String get_MessageTypeWasRecord_8() {
    if (cached_MessageTypeWasRecord_8 != null) {
      return cached_MessageTypeWasRecord_8;
    }
    cached_MessageTypeWasRecord_8 = generateTestOutput(false, "MessageTypeWasRecord_8", "./test_code/Channels_MessageTypeWasRecord_failure.a");
    return cached_MessageTypeWasRecord_8;
  }

  @Test
  public void testMessageTypeWasRecordFailure() {
    assertLiveFail(get_MessageTypeWasRecord_8());
  }

  @Test
  public void testMessageTypeWasRecordNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_MessageTypeWasRecord_8());
  }

  @Test
  public void testMessageTypeWasRecordExceptionFree() {
    assertExceptionFree(get_MessageTypeWasRecord_8());
  }

  @Test
  public void testMessageTypeWasRecordTODOFree() {
    assertTODOFree(get_MessageTypeWasRecord_8());
  }

  @Test
  public void stable_MessageTypeWasRecord_8() {
    String live = get_MessageTypeWasRecord_8();
    StringBuilder gold = new StringBuilder();
  ...
  private String get_UndefinedMessage_9() {
    if (cached_UndefinedMessage_9 != null) {
      return cached_UndefinedMessage_9;
    }
    cached_UndefinedMessage_9 = generateTestOutput(false, "UndefinedMessage_9", "./test_code/Channels_UndefinedMessage_failure.a");
    return cached_UndefinedMessage_9;
  }

  @Test
  public void testUndefinedMessageFailure() {
    assertLiveFail(get_UndefinedMessage_9());
  }

  @Test
  public void testUndefinedMessageNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_UndefinedMessage_9());
  }

  @Test
  public void testUndefinedMessageExceptionFree() {
    assertExceptionFree(get_UndefinedMessage_9());
  }

  @Test
  public void testUndefinedMessageTODOFree() {
    assertTODOFree(get_UndefinedMessage_9());
  }

  @Test
  public void stable_UndefinedMessage_9() {
    String live = get_UndefinedMessage_9();
    StringBuilder gold = new StringBuilder();
