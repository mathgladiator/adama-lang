...
public class GeneratedChannelsTests extends GeneratedBase {
  ...
  public void stable_EsotericMessages_3() {
    ...
    gold.append("\n    public long __memory() {");
    gold.append("\n      long __mem = 64;");
    gold.append("\n      if (miarr.has()) {int[] __child_0 = miarr.get();");
    gold.append("\n        for (int __idx_1 : __child_0) {");
    gold.append("\n          __mem += 4;");
    gold.append("\n        }");
    gold.append("\n      }");
    gold.append("\n      for (int __idx_2 : li) {");
    gold.append("\n        __mem += 4;");
    gold.append("\n      }");
    gold.append("\n      for (NtPair<Integer,Integer> __idx_3 : mii) {");
    gold.append("\n        __mem += 4;");
    gold.append("\n        __mem += 4;");
    gold.append("\n      }");
    gold.append("\n      for (NtPair<Integer,int[]> __idx_4 : miiarr) {");
    gold.append("\n        __mem += 4;");
    gold.append("\n        for (int __idx_5 : __idx_4.value) {");
    gold.append("\n          __mem += 4;");
    gold.append("\n        }");
    gold.append("\n      }");
    gold.append("\n      for (NtPair<Long,String> __idx_6 : mls) {");
    gold.append("\n        __mem += 8;");
    gold.append("\n        __mem += Sizing.memoryOf(__idx_6.value);");
    gold.append("\n      }");
    gold.append("\n      for (NtPair<String,String> __idx_7 : mss) {");
    gold.append("\n        __mem += Sizing.memoryOf(__idx_7.key);");
    gold.append("\n        __mem += Sizing.memoryOf(__idx_7.value);");
    gold.append("\n      }");
    gold.append("\n      if (recur.has()) {RTxStrange __child_8 = recur.get();");
    gold.append("\n        __mem += __child_8.__memory();");
    gold.append("\n      }");
    gold.append("\n      return __mem;");
    gold.append("\n    }");
    gold.append("\n    public void __reset() {");
    gold.append("\n      this.miarr = new NtMaybe<int[]>();");
    gold.append("\n      this.li = new EmptyNtList<Integer>();");
    gold.append("\n      this.mii = new NtMap<Integer,Integer>();");
    gold.append("\n      this.miiarr = new NtMap<Integer,int[]>();");
    gold.append("\n      this.mls = new NtMap<Long,String>();");
    gold.append("\n      this.mss = new NtMap<String,String>();");
    gold.append("\n      this.recur = new NtMaybe<RTxStrange>();");
    gold.append("\n    }");
    gold.append("\n    public void __hash(HashBuilder __hash) {");
    ...
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      if (__item.miarr.has()) {");
    gold.append("\n        int[] __maybeElement9 = (int[])(__item.miarr.get());");
    gold.append("\n        DList<DInt32> __maybeDeltaElement10 = __dmiarr.get(() -> new DList<DInt32>());");
    gold.append("\n        {");
    gold.append("\n          DList<DInt32> __deltaList12 = __maybeDeltaElement10;");
    gold.append("\n          PrivateLazyDeltaWriter __list11 = __obj.planField(\"miarr\").planObject();");
    gold.append("\n          int __index15 = 0;");
    gold.append("\n          for (Integer __listElement13 : __maybeElement9) {");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        DList<DInt32> __deltaList17 = __dli;");
    gold.append("\n        PrivateLazyDeltaWriter __list16 = __obj.planField(\"li\").planObject();");
    gold.append("\n        int __index20 = 0;");
    gold.append("\n        for (Integer __listElement18 : __item.li) {");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        PrivateLazyDeltaWriter __map21 = __obj.planField(\"mii\").planObject();");
    gold.append("\n        DMap<Integer,DInt32> __deltaMap22 = __dmii;");
    gold.append("\n        DMap<Integer,DInt32>.Walk __deltaMapWalker23 = __deltaMap22.begin();");
    gold.append("\n        for (NtPair<Integer,Integer> __mapEntry24 : __item.mii) {");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        PrivateLazyDeltaWriter __map26 = __obj.planField(\"miiarr\").planObject();");
    gold.append("\n        DMap<Integer,DList<DInt32>> __deltaMap27 = __dmiiarr;");
    gold.append("\n        DMap<Integer,DList<DInt32>>.Walk __deltaMapWalker28 = __deltaMap27.begin();");
    gold.append("\n        for (NtPair<Integer,int[]> __mapEntry29 : __item.miiarr) {");
    gold.append("\n          DList<DInt32> __deltaElement30 = __deltaMapWalker28.next(__mapEntry29.key, () -> new DList<DInt32>());");
    gold.append("\n          {");
    gold.append("\n            DList<DInt32> __deltaList32 = __deltaElement30;");
    gold.append("\n            PrivateLazyDeltaWriter __list31 = __map26.planField(\"\" + __mapEntry29.key).planObject();");
    gold.append("\n            int __index35 = 0;");
    gold.append("\n            for (Integer __listElement33 : __mapEntry29.value) {");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        PrivateLazyDeltaWriter __map36 = __obj.planField(\"mls\").planObject();");
    gold.append("\n        DMap<Long,DString> __deltaMap37 = __dmls;");
    gold.append("\n        DMap<Long,DString>.Walk __deltaMapWalker38 = __deltaMap37.begin();");
    gold.append("\n        for (NtPair<Long,String> __mapEntry39 : __item.mls) {");
    gold.append("\n          DString __deltaElement40 = __deltaMapWalker38.next(__mapEntry39.key, () -> new DString());");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        PrivateLazyDeltaWriter __map41 = __obj.planField(\"mss\").planObject();");
    gold.append("\n        DMap<String,DString> __deltaMap42 = __dmss;");
    gold.append("\n        DMap<String,DString>.Walk __deltaMapWalker43 = __deltaMap42.begin();");
    gold.append("\n        for (NtPair<String,String> __mapEntry44 : __item.mss) {");
    gold.append("\n          DString __deltaElement45 = __deltaMapWalker43.next(__mapEntry44.key, () -> new DString());");
    gold.append("\n          __deltaElement45.show(__mapEntry44.value, __map41.planField(\"\" + __mapEntry44.key));");
    gold.append("\n        }");
    gold.append("\n        __deltaMapWalker43.end(__map41);");
    gold.append("\n        __map41.end();");
    gold.append("\n      }");
    gold.append("\n      if (__item.recur.has()) {");
    gold.append("\n        RTxStrange __maybeElement46 = (RTxStrange)(__item.recur.get());");
    gold.append("\n        DeltaRTxStrange __maybeDeltaElement47 = __drecur.get(() -> new DeltaRTxStrange());");
    gold.append("\n        __maybeDeltaElement47.show(__maybeElement46, __obj.planField(\"recur\"));");
    gold.append("\n      } else {");
