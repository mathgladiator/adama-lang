...
public class GeneratedChannelsTests extends GeneratedBase {
  ...
  public void stable_HandlerLegacy_4() {
    ...
    gold.append("\n!!EXCEPTION!!!!!!!!!!!!!!!!!!");
    gold.append("\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    gold.append("\npath: HandlerLegacy_4 failed due to to exception");
    gold.append("\norg.adamalang.translator.parser.exceptions.ParseException: Parser was expecting a Symbol=`)`; instead, the parse got Symbol:,. {Token: `,` @ (5,22) -> (5,23): Symbol}");
  ...
  public void stable_MessageHasMethod_6() {
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"z\":{\"val\":32},\"__messages\":null,\"__seq\":1} need:false in:0");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"25\"}-->{\"__messages\":null,\"__seq\":2,\"__entropy\":\"4804307197456638271\",\"__time\":\"25\"} need:false in:-25");
    gold.append("\nCPU:2");
    gold.append("\nMEMORY:480");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"50\"}-->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"50\"} need:false in:-50");
