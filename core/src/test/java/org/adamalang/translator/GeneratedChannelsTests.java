...
public class GeneratedChannelsTests extends GeneratedBase {
  ...
  public void stable_EsotericMessages_3() {
    ...
    gold.append("\n      for (Map.Entry<Integer,Integer> __entry3 : this.mii) {");
    gold.append("\n        __hash.hashInteger(__entry3.getKey());");
    gold.append("\n        __hash.hashInteger(__entry3.getValue());");
    gold.append("\n      }");
    gold.append("\n      __hash.hashString(\"miiarr\");");
    gold.append("\n      for (Map.Entry<Integer,int[]> __entry4 : this.miiarr) {");
    gold.append("\n        __hash.hashInteger(__entry4.getKey());");
    gold.append("\n        for (Integer __item5 : __entry4.getValue()) {");
    gold.append("\n          __hash.hashInteger(__item5);");
    gold.append("\n        }");
    gold.append("\n      }");
    gold.append("\n      __hash.hashString(\"mls\");");
    gold.append("\n      for (Map.Entry<Long,String> __entry6 : this.mls) {");
    gold.append("\n        __hash.hashLong(__entry6.getKey());");
    gold.append("\n        __hash.hashString(__entry6.getValue());");
    gold.append("\n      }");
    gold.append("\n      __hash.hashString(\"mss\");");
    gold.append("\n      for (Map.Entry<String,String> __entry7 : this.mss) {");
    gold.append("\n        __hash.hashString(__entry7.getKey());");
    gold.append("\n        __hash.hashString(__entry7.getValue());");
    gold.append("\n      }");
