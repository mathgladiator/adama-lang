...
public class GeneratedOperationsModTests extends GeneratedBase {
  ...
  public void stable_Formulas_1() {
    ...
    gold.append("\n    super(__monitor);");
    gold.append("\n    f0 = new RxLazy<NtMaybe<Integer>>(this, () -> (NtMaybe<Integer>)(LibArithmetic.Mod.II(1, 1)));");
    gold.append("\n    f1 = new RxLazy<NtMaybe<Integer>>(this, () -> (NtMaybe<Integer>)(LibArithmetic.Mod.II(1, 0)));");
    gold.append("\n    f2 = new RxLazy<NtMaybe<Long>>(this, () -> (NtMaybe<Long>)(LibArithmetic.Mod.LI(1L, 1)));");
    gold.append("\n    f3 = new RxLazy<NtMaybe<Long>>(this, () -> (NtMaybe<Long>)(LibArithmetic.Mod.LI(1L, 0)));");
    gold.append("\n    f4 = new RxLazy<NtMaybe<Long>>(this, () -> (NtMaybe<Long>)(LibArithmetic.Mod.LL(1L, 1L)));");
    gold.append("\n    f5 = new RxLazy<NtMaybe<Long>>(this, () -> (NtMaybe<Long>)(LibArithmetic.Mod.LL(1L, 1L)));");
    gold.append("\n    f6 = new RxLazy<NtMaybe<Long>>(this, () -> (NtMaybe<Long>)(LibArithmetic.Mod.LL(1L, 0L)));");
