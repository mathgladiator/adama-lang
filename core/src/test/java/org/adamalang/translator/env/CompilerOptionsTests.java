...
public class CompilerOptionsTests {
    ...
    @Test
    public void core() {
        CompilerOptions options = CompilerOptions.start().args(0, "--input", "a.a", "--input", "b.a", "--add-search-path", "foo", "--add-search-path", "goo", "--output", "oout").make();
    ...
    @Test
    public void args1() {
        CompilerOptions options = CompilerOptions.start().args(0, "--billing", "no", "--code-coverage", "no", "--remove-tests", "no", "--silent", "no", "--goodwill-budget", "0", "--package", "org.foo", "--class", "ClassName").make();
        Assert.assertTrue(options.disableBillingCost);
    ...
    @Test
    public void args2() {
        CompilerOptions options = CompilerOptions.start().args(0, "--billing", "yes", "--code-coverage", "yes", "--remove-tests", "yes", "--silent", "yes", "--goodwill-budget", "5000", "--package", "org.foo2", "--class", "ClassName2").make();
    ...
    @Test
    public void offset() {
        CompilerOptions options = CompilerOptions.start().args(1, "compile","--billing", "yes", "--code-coverage", "yes", "--remove-tests", "yes", "--silent", "yes", "--goodwill-budget", "5000", "--package", "org.foo2", "--class", "ClassName2").make();
        Assert.assertFalse(options.disableBillingCost);
        Assert.assertTrue(options.produceCodeCoverage);
        Assert.assertTrue(options.removeTests);
        Assert.assertFalse(options.stderrLoggingCompiler);
