...
public class GeneratedPolicyTests extends GeneratedBase {
  ...
  public void stable_ContextVariables_1() {
    ...
    gold.append("\n  public static boolean __onCanCreate__0(StaticState __static_state, NtClient who, CoreRequestContext context) {");
    gold.append("\n    return (context.ip).equals(\"127.0.0.1\") && (context.origin).equals(\"internal://\") || (context.who).equals(who);");
    gold.append("\n  }");
    gold.append("\n  public static boolean __onCanInvent__0(StaticState __static_state, NtClient who, CoreRequestContext context){");
