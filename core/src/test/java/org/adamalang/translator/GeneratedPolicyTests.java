...
public class GeneratedPolicyTests extends GeneratedBase {
  ...
  public void stable_ContextOutOfStatic_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":11,\"byte\":17},\"end\":{\"line\":1,\"character\":19,\"byte\":25}},\"severity\":1,\"source\":\"error\",\"message\":\"@context is only available within static policies, constructors, document events, authorize handler, message handlers\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
  ...
  public void stable_ContextVariablesBadTypes_2() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":2,\"byte\":21},\"end\":{\"line\":1,\"character\":8,\"byte\":27}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'bool' is unable to store type 'int'.\"},{\"range\":{\"start\":{\"line\":1,\"character\":9,\"byte\":28},\"end\":{\"line\":3,\"character\":3,\"byte\":48}},\"severity\":1,\"source\":\"error\",\"message\":\"The 'create' policy must return a boolean\"},{\"range\":{\"start\":{\"line\":4,\"character\":2,\"byte\":51},\"end\":{\"line\":4,\"character\":8,\"byte\":57}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'bool' is unable to store type 'string'.\"},{\"range\":{\"start\":{\"line\":4,\"character\":9,\"byte\":58},\"end\":{\"line\":6,\"character\":3,\"byte\":80}},\"severity\":1,\"source\":\"error\",\"message\":\"The 'invent' policy must return a boolean\"},{\"range\":{\"start\":{\"line\":7,\"character\":20,\"byte\":101},\"end\":{\"line\":7,\"character\":24,\"byte\":105}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of 'int', but the type is actually 'bool'\"},{\"range\":{\"start\":{\"line\":8,\"character\":20,\"byte\":127},\"end\":{\"line\":8,\"character\":22,\"byte\":129}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of 'bool', but the type is actually 'int'\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_ContextVariables_3() {
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(ContextVariables_3 __item, PrivateLazyDeltaWriter __writer) {");
  ...
  public void stable_EmptyEnvironment_4() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":3,\"character\":20,\"byte\":51},\"end\":{\"line\":3,\"character\":21,\"byte\":52}},\"severity\":1,\"source\":\"error\",\"message\":\"The variable 'x' was not defined\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
