...
public class GeneratedPolicyTests extends GeneratedBase {
  ...
  public void stable_ContextOutOfStatic_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":11,\"byte\":17},\"end\":{\"line\":1,\"character\":19,\"byte\":25}},\"severity\":1,\"source\":\"error\",\"message\":\"@context is only available within static policies, constructors, document events, authorize handler, message handlers\",\"file\":\"./test_code/Policy_ContextOutOfStatic_failure.a\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
