...
public class GeneratedAuthTests extends GeneratedBase {
  ...
  public void stable_Primary_2() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":0,\"byte\":0},\"end\":{\"line\":5,\"character\":1,\"byte\":104}},\"severity\":1,\"source\":\"error\",\"message\":\"Variable 'username' was already defined (EnvironmentDefine)\"},{\"range\":{\"start\":{\"line\":0,\"character\":0,\"byte\":0},\"end\":{\"line\":5,\"character\":1,\"byte\":104}},\"severity\":1,\"source\":\"error\",\"message\":\"Variable 'password' was already defined (EnvironmentDefine)\"}]\"--JAVA---------------------------------------------");
