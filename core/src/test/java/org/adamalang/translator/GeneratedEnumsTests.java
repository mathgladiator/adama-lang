...
public class GeneratedEnumsTests extends GeneratedBase {
  ...
  public void stable_Cycle_5() {
    ...
    gold.append("\n    n1 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCycleNext_E(head.get())));");
    gold.append("\n    n2 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCycleNext_E(n1.get())));");
    gold.append("\n    n3 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCycleNext_E(n2.get())));");
    gold.append("\n    n4 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCycleNext_E(n3.get())));");
    gold.append("\n    p3 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCyclePrev_E(n4.get())));");
    gold.append("\n    p2 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCyclePrev_E(p3.get())));");
    gold.append("\n    p1 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCyclePrev_E(p2.get())));");
    gold.append("\n    p0 = new RxLazy<Integer>(this, () -> (Integer)(__EnumCyclePrev_E(p1.get())));");
    gold.append("\n    head.__subscribe(n1);");
    gold.append("\n    n1.__subscribe(n2);");
    gold.append("\n    n2.__subscribe(n3);");
    gold.append("\n    n3.__subscribe(n4);");
  ...
  private String cached_Str_17 = null;
  private String get_Str_17() {
    if (cached_Str_17 != null) {
      return cached_Str_17;
    }
    cached_Str_17 = generateTestOutput(true, "Str_17", "./test_code/Enums_Str_success.a");
    return cached_Str_17;
  }

  @Test
  public void testStrEmission() {
    assertEmissionGood(get_Str_17());
  }

  @Test
  public void testStrSuccess() {
    assertLivePass(get_Str_17());
  }

  @Test
  public void testStrGoodWillHappy() {
    assertGoodWillHappy(get_Str_17());
  }

  @Test
  public void testStrExceptionFree() {
    assertExceptionFree(get_Str_17());
  }

  @Test
  public void testStrTODOFree() {
    assertTODOFree(get_Str_17());
  }

  @Test
  public void stable_Str_17() {
    String live = get_Str_17();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class Str_17 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Str_17(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    a = new RxLazy<String>(this, () -> (String)(__EnumString_E(0)));");
    gold.append("\n    b = new RxLazy<String>(this, () -> (String)(__EnumString_E(1)));");
    gold.append("\n    c = new RxLazy<String>(this, () -> (String)(__EnumString_E(4)));");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
    gold.append("\n  @Override");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaStr_17 implements DeltaNode {");
    gold.append("\n    private int __ga;");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(Str_17 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      __code_cost += 3;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    ...
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    Str_17 __self = this;");
    gold.append("\n    DeltaStr_17 __state = new DeltaStr_17();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    return new PrivateView(__genViewId(), __who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
    gold.append("\n      public long memory() {");
