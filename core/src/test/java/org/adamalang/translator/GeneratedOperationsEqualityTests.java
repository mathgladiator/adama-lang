...
public class GeneratedOperationsEqualityTests extends GeneratedBase {
  ...
  public void stable_Testing_1() {
    ...
    gold.append("\n    b8 = new RxLazy<Boolean>(this, () -> (LibMath.equality(new NtMaybe<Integer>(1), 1, (__x, __y) -> __x.intValue() == __y)));");
    gold.append("\n    b9 = new RxLazy<Boolean>(this, () -> (LibMath.equality(new NtMaybe<Integer>(1), 1, (__x, __y) -> __x.intValue() == __y)));");
    ...
    gold.append("\n    e2 = new RxLazy<Boolean>(this, () -> (LibMath.equality(new NtMaybe<Integer>(0), 1, (__x, __y) -> __x.intValue() == __y)));");
    gold.append("\n    e3 = new RxLazy<Boolean>(this, () -> (!LibMath.equality(new NtMaybe<Integer>(1), 0, (__x, __y) -> __x.intValue() == __y)));");
    gold.append("\n    e4 = new RxLazy<Boolean>(this, () -> (LibMath.equality(new NtMaybe<Integer>(), 1, (__x, __y) -> __x.intValue() == __y)));");
