...
public class GeneratedArrayTests extends GeneratedBase {
  ...
  public void stable_IndexLookupLegacy_2() {
    ...
    gold.append("\n    found_impossible_thing.__commit(\"found_impossible_thing\", __writer);");
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  public void __revert() {");
    ...
    gold.append("\n--JAVA COMPILE RESULTS-----------------------------");
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\"}-->{\"__constructed\":true,\"__entropy\":\"0\",\"tbl\":{\"auto_key\":6,\"rows\":{\"0\":{\"x\":100,\"y\":3},\"1\":{\"x\":2,\"y\":2,\"id\":1},\"2\":{\"x\":100,\"y\":1,\"id\":2},\"3\":{\"x\":4,\"y\":2,\"id\":3},\"4\":{\"x\":5,\"y\":2,\"id\":4},\"5\":{\"x\":1,\"y\":2,\"id\":5}}},\"sum\":103} need:true in:0");
    gold.append("\nNO_ONE was DENIED:5011");
    gold.append("\nRANDO was DENIED:5011");
    ...
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"tbl\":{\"auto_key\":6,\"rows\":{\"0\":{\"x\":100,\"y\":3},\"1\":{\"x\":2,\"y\":2,\"id\":1},\"2\":{\"x\":100,\"y\":1,\"id\":2},\"3\":{\"x\":4,\"y\":2,\"id\":3},\"4\":{\"x\":5,\"y\":2,\"id\":4},\"5\":{\"x\":1,\"y\":2,\"id\":5}}},\"sum\":103,\"__seedUsed\":\"0\",\"__seq\":1,\"__time\":\"25\",\"__goodwill_used\":0,\"__cost\":25,\"__billing_seq\":1}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
  ...
  public void stable_OfAllTypes_3() {
    ...
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"x\":6,\"__seedUsed\":\"0\",\"__seq\":1,\"__time\":\"25\",\"__goodwill_used\":0,\"__cost\":12,\"__billing_seq\":1}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
