...
public class GeneratedWebTests extends GeneratedBase {
  ...
  public void stable_ParserHappy_5() {
    ...
    gold.append("\n    return null;");
    gold.append("\n  }");
    gold.append("\n  private WebResponse __get_F(NtClient __who, WebGet __request){");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(0);");
    gold.append("\n    {");
    gold.append("\n      RTx_AnonObjConvert_0 __capture7 = new RTx_AnonObjConvert_0(\"HiPath0\");");
    gold.append("\n      return new WebResponse().html(__capture7.html);");
    gold.append("\n    }");
    gold.append("\n  }");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private WebResponse __get_I(NtClient __who, WebGet __request, String id, double val){");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(2);");
    gold.append("\n    {");
    gold.append("\n      RTx_AnonObjConvert_0 __capture9 = new RTx_AnonObjConvert_0(\"Hi there\" + id);");
    gold.append("\n      return new WebResponse().html(__capture9.html);");
    gold.append("\n    }");
    gold.append("\n  }");
