...
public class GeneratedAnonymousTupleTests extends GeneratedBase {
  ...
  public void stable_Values_1() {
    ...
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      {");
    gold.append("\n        DList<DInt32> __deltaList5 = __dfirst;");
    gold.append("\n        PrivateLazyDeltaWriter __list4 = __obj.planField(\"first\").planObject();");
    gold.append("\n        int __index8 = 0;");
    gold.append("\n        for (Integer __listElement6 : __item.first) {");
    gold.append("\n          DInt32 __deltaElement7 = __deltaList5.getPrior(__index8, () -> new DInt32());");
