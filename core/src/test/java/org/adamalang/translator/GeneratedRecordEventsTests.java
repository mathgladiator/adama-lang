...
public class GeneratedRecordEventsTests extends GeneratedBase {
  ...
  private String cached_NotRoot_2 = null;
  private String get_NotRoot_2() {
    if (cached_NotRoot_2 != null) {
      return cached_NotRoot_2;
    }
    cached_NotRoot_2 = generateTestOutput(false, "NotRoot_2", "./test_code/RecordEvents_NotRoot_failure.a");
    return cached_NotRoot_2;
  }

  @Test
  public void testNotRootFailure() {
    assertLiveFail(get_NotRoot_2());
  }

  @Test
  public void testNotRootNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_NotRoot_2());
  }

  @Test
  public void testNotRootExceptionFree() {
    assertExceptionFree(get_NotRoot_2());
  }

  @Test
  public void testNotRootTODOFree() {
    assertTODOFree(get_NotRoot_2());
  }

  @Test
  public void stable_NotRoot_2() {
    String live = get_NotRoot_2();
    StringBuilder gold = new StringBuilder();
