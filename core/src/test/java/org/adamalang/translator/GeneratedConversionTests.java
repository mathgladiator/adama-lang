...
public class GeneratedConversionTests extends GeneratedBase {
  ...
  public void stable_CantConvertIntList_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":4,\"character\":22,\"byte\":50},\"end\":{\"line\":4,\"character\":31,\"byte\":59}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type `int[]` is unable to be converted. Only list<S>, S[], maybe<S> can be converted where S is either a record or a message.\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
  ...
  public void stable_CantConvertListToList_2() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":12,\"character\":2,\"byte\":84},\"end\":{\"line\":12,\"character\":8,\"byte\":90}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'list<M>' is unable to store type 'M[]'.\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_CantInteger_3() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":4,\"character\":22,\"byte\":50},\"end\":{\"line\":4,\"character\":23,\"byte\":51}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type `int` is unable to be converted. Only list<S>, S[], maybe<S> can be converted where S is either a record or a message.\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_CantMaybeInteger_4() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":4,\"character\":29,\"byte\":57},\"end\":{\"line\":4,\"character\":30,\"byte\":58}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of 'record' or 'message', but got a type of 'int'.\"},{\"range\":{\"start\":{\"line\":4,\"character\":22,\"byte\":50},\"end\":{\"line\":4,\"character\":30,\"byte\":58}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type `maybe<int>` is unable to be converted. Only list<S>, S[], maybe<S> can be converted where S is either a record or a message.\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_RecordToMessage_6() {
    ...
    gold.append("\nEnd");
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{\"x\":{\"type\":{\"nature\":\"reactive_ref\",\"ref\":\"R\"}},\"t\":{\"type\":{\"nature\":\"reactive_table\",\"record_name\":\"R\"}}}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}},\"R\":{\"nature\":\"reactive_record\",\"name\":\"R\",\"fields\":{\"x\":{\"type\":{\"nature\":\"reactive_value\",\"type\":\"int\"}},\"y\":{\"type\":{\"nature\":\"reactive_value\",\"type\":\"int\"}},\"id\":{\"type\":{\"nature\":\"reactive_value\",\"type\":\"int\"}}}},\"M\":{\"nature\":\"native_message\",\"name\":\"M\",\"anonymous\":false,\"fields\":{\"x\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"public\"}}},\"M2\":{\"nature\":\"native_message\",\"name\":\"M2\",\"anonymous\":false,\"fields\":{\"x\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"public\"},\"y\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"public\"}}}},\"channels\":{},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"0\",\"origin\":\"origin\",\"ip\":\"ip\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"__auto_table_row_id\":1,\"t\":{\"1\":{\"x\":1,\"y\":0,\"id\":1}},\"__messages\":null,\"__seq\":1} need:false in:0");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"25\"}-->{\"__messages\":null,\"__seq\":2,\"__entropy\":\"4804307197456638271\",\"__time\":\"25\"} need:false in:-25");
    gold.append("\nCPU:7");
    gold.append("\nMEMORY:882");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"50\"}-->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"50\"} need:false in:-50");
  ...
  public void stable_WhenCantConvertBasedOnFields_7() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":11,\"character\":2,\"byte\":100},\"end\":{\"line\":11,\"character\":8,\"byte\":106}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'string' is unable to store type 'int'.\"},{\"range\":{\"start\":{\"line\":15,\"character\":2,\"byte\":132},\"end\":{\"line\":15,\"character\":5,\"byte\":135}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'int' is unable to store type 'string'.\"},{\"range\":{\"start\":{\"line\":6,\"character\":2,\"byte\":56},\"end\":{\"line\":6,\"character\":8,\"byte\":62}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'string' is unable to store type 'int'.\"},{\"range\":{\"start\":{\"line\":21,\"character\":2,\"byte\":172},\"end\":{\"line\":21,\"character\":11,\"byte\":181}},\"severity\":1,\"source\":\"error\",\"message\":\"The type 'BigS' contains field 'z' which is not found within 'SmallI'.\"},{\"range\":{\"start\":{\"line\":21,\"character\":2,\"byte\":172},\"end\":{\"line\":21,\"character\":11,\"byte\":181}},\"severity\":1,\"source\":\"error\",\"message\":\"The type 'BigI' contains field 'z' which is not found within 'SmallI'.\"},{\"range\":{\"start\":{\"line\":22,\"character\":2,\"byte\":184},\"end\":{\"line\":22,\"character\":11,\"byte\":193}},\"severity\":1,\"source\":\"error\",\"message\":\"The type 'BigS' contains field 'z' which is not found within 'SmallS'.\"},{\"range\":{\"start\":{\"line\":1,\"character\":2,\"byte\":17},\"end\":{\"line\":1,\"character\":5,\"byte\":20}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'int' is unable to store type 'string'.\"},{\"range\":{\"start\":{\"line\":22,\"character\":2,\"byte\":184},\"end\":{\"line\":22,\"character\":11,\"byte\":193}},\"severity\":1,\"source\":\"error\",\"message\":\"The type 'BigI' contains field 'z' which is not found within 'SmallS'.\"},{\"range\":{\"start\":{\"line\":1,\"character\":2,\"byte\":17},\"end\":{\"line\":1,\"character\":5,\"byte\":20}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'int' is unable to store type 'string'.\"},{\"range\":{\"start\":{\"line\":6,\"character\":2,\"byte\":56},\"end\":{\"line\":6,\"character\":8,\"byte\":62}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'string' is unable to store type 'int'.\"},{\"range\":{\"start\":{\"line\":11,\"character\":2,\"byte\":100},\"end\":{\"line\":11,\"character\":8,\"byte\":106}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'string' is unable to store type 'int'.\"},{\"range\":{\"start\":{\"line\":15,\"character\":2,\"byte\":132},\"end\":{\"line\":15,\"character\":5,\"byte\":135}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: the type 'int' is unable to store type 'string'.\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
