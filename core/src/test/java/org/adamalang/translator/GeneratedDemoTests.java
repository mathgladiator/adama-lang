...
public class GeneratedDemoTests extends GeneratedBase {
  ...
  public void stable_ChatOrder_4() {
    ...
    gold.append("\n  public NtList<RTxLine> __COMPUTE_chat(NtClient who, RTx__ViewerType viewer) {");
    gold.append("\n    return (viewer.ordering ? (_chat.iterate(false).orderBy(true, __ORDER_Line_id_d)) : (_chat.iterate(false).orderBy(true, __ORDER_Line_id_a)));");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private static class RTxFlux implements NtMessageBase {");
    ...
    gold.append("\n");
    gold.append("\n  }");
    gold.append("\n  private void handleChannelMessage_flux(NtClient w, RTxFlux f) throws AbortMessageException {");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(2);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((_chat.iterate(false).where(true, new __CLOSURE_WhereClause0(w))).transform((item) -> item.what), \"x\");");
    gold.append("\n");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected boolean __is_direct_channel(String channel) {");
    ...
    gold.append("\n    switch (__channel) {");
    gold.append("\n      case \"flux\":");
    gold.append("\n        handleChannelMessage_flux(__who, (RTxFlux) __message);");
    gold.append("\n        return;");
    gold.append("\n      case \"say\":");
    ...
    gold.append("\n        return;");
    gold.append("\n      case \"flux\":");
    gold.append("\n        __task.setAction(() -> handleChannelMessage_flux(__task.who, (RTxFlux)(__task.message)));");
    gold.append("\n        return;");
    gold.append("\n      default:");
    gold.append("\n        return;");
    gold.append("\n    }");
    ...
    gold.append("\n      return null;");
    gold.append("\n    }");
    gold.append("\n    private __CLOSURE_WhereClause0(NtClient w) {");
    gold.append("\n      this.w = w;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public boolean test(RTxLine __obj) {");
    gold.append("\n      NtClient who = __obj.who.get();");
    gold.append("\n      __code_cost ++;");
    gold.append("\n      return (who).equals(w);");
    gold.append("\n    }");
    gold.append("\n  }");
  ...
  public void stable_GameHearts_5() {
    ...
    gold.append("\n      }");
    gold.append("\n    }");
    gold.append("\n    public boolean __POLICY_p(NtClient __who){");
    gold.append("\n      NtClient who = __who;");
    gold.append("\n      __code_cost += 4;");
    gold.append("\n      __track(0);");
    ...
    gold.append("\n    return true;");
    gold.append("\n  }");
    gold.append("\n  public void __onDisconnected__0(NtClient __who) {");
    gold.append("\n    NtClient cv = __who;");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(132);");
  ...
  public void stable_RefSilly_6() {
    ...
    gold.append("\n  @Override");
    gold.append("\n  public void __test(TestReportBuilder report, String testName) {}");
    gold.append("\n  private void __construct_0(NtClient __who, RTxArg arg) {");
    gold.append("\n    NtClient who = __who;__code_cost += 4;");
    gold.append("\n    __track(6);");
    gold.append("\n    owner.set(who);");
    gold.append("\n    __track(7);");
    gold.append("\n    name.set(arg.name);");
  ...
  public void stable_ReferenceIntro_7() {
    ...
    gold.append("\n  @Override");
    gold.append("\n  public void __test(TestReportBuilder report, String testName) {}");
    gold.append("\n  private void __construct_0(NtClient __who, RTxConsXYZ c) {");
    gold.append("\n    NtClient who = __who;__code_cost += 3;");
    gold.append("\n    __track(6);");
    gold.append("\n    creator.set(who);");
    gold.append("\n    __track(7);");
    gold.append("\n    x.set(c.x);");
  ...
  public void stable_TicTacToe_10() {
    ...
    gold.append("\n  private final RxClient playerX;");
    gold.append("\n  private final RxClient playerO;");
    gold.append("\n  private final RxClient current;");
    ...
    gold.append("\n  public String __COMPUTE_your_role(NtClient who, RTx__ViewerType __viewerState) {");
    gold.append("\n    return ((playerX.get()).equals(who) ? \"X\" : ((playerO.get()).equals(who) ? \"O\" : \"Observer\"));");
    gold.append("\n  }");
    gold.append("\n  public boolean __COMPUTE_your_turn(NtClient who, RTx__ViewerType __viewerState) {");
    gold.append("\n    return (current.get()).equals(who);");
    gold.append("\n  }");
    gold.append("\n  public int __COMPUTE_your_wins(NtClient who, RTx__ViewerType __viewerState) {");
    gold.append("\n    return ((playerX.get()).equals(who) ? wins_X.get() : ((playerO.get()).equals(who) ? wins_O.get() : 0));");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    ...
    gold.append("\n    super(__monitor);");
    gold.append("\n    playerX = new RxClient(this, NtClient.NO_ONE);");
    gold.append("\n    playerO = new RxClient(this, NtClient.NO_ONE);");
    gold.append("\n    current = new RxClient(this, NtClient.NO_ONE);");
    ...
    gold.append("\n    private final RxInt32 x;");
    gold.append("\n    private final RxInt32 y;");
    gold.append("\n    private final RxInt32 state;");
    gold.append("\n    private RTxSquare(RxParent __owner) {");
    gold.append("\n      super(__owner);");
    gold.append("\n      id = new RxInt32(this, 0);");
    gold.append("\n      x = new RxInt32(this, 0);");
    gold.append("\n      y = new RxInt32(this, 0);");
    gold.append("\n      state = new RxInt32(this, 0);");
    gold.append("\n      if (__owner instanceof RxTable) {");
    gold.append("\n        /* ok */");
    gold.append("\n      } else {");
    gold.append("\n        /* ok */");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private static class RTxPlay implements NtMessageBase {");
    gold.append("\n    private int id = 0;");
    ...
    gold.append("\n          switch (__fieldName) {");
    gold.append("\n            case \"state\":");
    gold.append("\n              this.state = __reader.readInteger();");
    gold.append("\n              break;");
    gold.append("\n            case \"x\":");
    gold.append("\n              this.x = __reader.readInteger();");
    gold.append("\n              break;");
    ...
    gold.append("\n");
    gold.append("\n      __track(14);");
    gold.append("\n      NtList<RxInt32> _auto_8 = (_squares.iterate(false).where(true, new __CLOSURE_WhereClause1(pick))).transform((item) -> item.state);");
    ...
    gold.append("\n    __code_cost += 3;");
    gold.append("\n    __track(27);");
    gold.append("\n    NtList<RxInt32> _auto_10 = (_squares.iterate(true)).transform((item) -> item.state);");
    ...
    gold.append("\n    __code_cost += 3;");
    gold.append("\n    __track(29);");
    gold.append("\n    if ((playerX.get()).equals(NtClient.NO_ONE)) {");
    gold.append("\n      __code_cost += 3;");
    gold.append("\n      __track(30);");
    gold.append("\n      playerX.set(who);");
    gold.append("\n      __track(31);");
    gold.append("\n      if (!(playerO.get()).equals(NtClient.NO_ONE)) {");
    gold.append("\n        __code_cost += 2;");
    gold.append("\n        __track(32);");
    gold.append("\n        __transitionStateMachine(\"initiate\", 0);");
    gold.append("\n      }");
    gold.append("\n    } else if ((playerO.get()).equals(NtClient.NO_ONE)) {");
    gold.append("\n      __code_cost += 3;");
    gold.append("\n      __track(33);");
    gold.append("\n      playerO.set(who);");
    gold.append("\n      __track(34);");
    ...
    gold.append("\n{\"command\":\"connect\",\"timestamp\":\"125\",\"who\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}-->{\"__seq\":8,\"__connection_id\":2,\"__time\":\"125\",\"playerX\":{\"agent\":\"rando\",\"authority\":\"random-place\"},\"__clients\":{\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}},\"__messages\":null,\"__entropy\":\"488730542833106255\"} need:false in:-125");
    gold.append("\nRANDO|SUCCESS:8");
    ...
    gold.append("\nMEMORY:8796");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"playerX\":{\"agent\":\"rando\",\"authority\":\"random-place\"},\"playerO\":{\"agent\":\"?\",\"authority\":\"?\"},\"current\":{\"agent\":\"?\",\"authority\":\"?\"},\"wins_X\":0,\"wins_O\":0,\"stalemates\":0,\"_squares\":{\"1\":{\"id\":1,\"x\":0,\"y\":0,\"state\":0},\"2\":{\"id\":2,\"x\":1,\"y\":0,\"state\":0},\"3\":{\"id\":3,\"x\":2,\"y\":0,\"state\":0},\"4\":{\"id\":4,\"x\":0,\"y\":1,\"state\":0},\"5\":{\"id\":5,\"x\":1,\"y\":1,\"state\":0},\"6\":{\"id\":6,\"x\":2,\"y\":1,\"state\":0},\"7\":{\"id\":7,\"x\":0,\"y\":2,\"state\":0},\"8\":{\"id\":8,\"x\":1,\"y\":2,\"state\":0},\"9\":{\"id\":9,\"x\":2,\"y\":2,\"state\":0}},\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":9,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"150\",\"__auto_table_row_id\":9,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{\"playerX\":{\"agent\":\"rando\",\"authority\":\"random-place\"},\"playerO\":{\"agent\":\"?\",\"authority\":\"?\"},\"current\":{\"agent\":\"?\",\"authority\":\"?\"},\"wins_X\":0,\"wins_O\":0,\"stalemates\":0,\"_squares\":{\"1\":{\"id\":1,\"x\":0,\"y\":0,\"state\":0},\"2\":{\"id\":2,\"x\":1,\"y\":0,\"state\":0},\"3\":{\"id\":3,\"x\":2,\"y\":0,\"state\":0},\"4\":{\"id\":4,\"x\":0,\"y\":1,\"state\":0},\"5\":{\"id\":5,\"x\":1,\"y\":1,\"state\":0},\"6\":{\"id\":6,\"x\":2,\"y\":1,\"state\":0},\"7\":{\"id\":7,\"x\":0,\"y\":2,\"state\":0},\"8\":{\"id\":8,\"x\":1,\"y\":2,\"state\":0},\"9\":{\"id\":9,\"x\":2,\"y\":2,\"state\":0}},\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":9,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"150\",\"__auto_table_row_id\":9,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n{\"playerX\":{\"agent\":\"rando\",\"authority\":\"random-place\"},\"playerO\":{\"agent\":\"?\",\"authority\":\"?\"},\"current\":{\"agent\":\"?\",\"authority\":\"?\"},\"wins_X\":0,\"wins_O\":0,\"stalemates\":0,\"_squares\":{\"1\":{\"id\":1,\"x\":0,\"y\":0,\"state\":0},\"2\":{\"id\":2,\"x\":1,\"y\":0,\"state\":0},\"3\":{\"id\":3,\"x\":2,\"y\":0,\"state\":0},\"4\":{\"id\":4,\"x\":0,\"y\":1,\"state\":0},\"5\":{\"id\":5,\"x\":1,\"y\":1,\"state\":0},\"6\":{\"id\":6,\"x\":2,\"y\":1,\"state\":0},\"7\":{\"id\":7,\"x\":0,\"y\":2,\"state\":0},\"8\":{\"id\":8,\"x\":1,\"y\":2,\"state\":0},\"9\":{\"id\":9,\"x\":2,\"y\":2,\"state\":0}},\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":9,\"__entropy\":\"5082315122564986995\",\"__auto_future_id\":0,\"__connection_id\":2,\"__message_id\":0,\"__time\":\"150\",\"__auto_table_row_id\":9,\"__clients\":{\"0\":{\"agent\":\"?\",\"authority\":\"?\"},\"1\":{\"agent\":\"rando\",\"authority\":\"random-place\"}}}");
    gold.append("\n--JAVA TEST RESULTS--------------------------------");
