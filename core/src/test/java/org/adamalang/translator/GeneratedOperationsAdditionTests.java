...
public class GeneratedOperationsAdditionTests extends GeneratedBase {
  ...
  public void stable_Assignment_1() {
    ...
    gold.append("\nMEMORY:1966");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"r0\":2,\"r1\":\"7\",\"r2\":17.0,\"r3\":{\"r\":7.5,\"i\":2.0},\"rS\":\"123.51.0 2.0imaybe?true7.0 2.0i123.51.0 2.0imaybe?true7.0 2.0i123.51.0 2.0imaybe?true7.0 2.0i\",\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":0,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{}");
    gold.append("\n--METRIC RESULTS-----------------------------------");
    gold.append("\n{\"r0\":2,\"r1\":\"7\",\"r2\":17.0,\"r3\":{\"r\":7.5,\"i\":2.0},\"rS\":\"123.51.0 2.0imaybe?true7.0 2.0i123.51.0 2.0imaybe?true7.0 2.0i123.51.0 2.0imaybe?true7.0 2.0i\",\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":0,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
  ...
  public void stable_ListAssignment_3() {
    ...
    gold.append("\n    }");
    gold.append("\n    __track(2);");
    gold.append("\n    LibArithmetic.ListMath.addToII((tbl.iterate(true)).transform((RTxR item) -> (RxInt32) (item.r0)), 1);");
    gold.append("\n    __track(3);");
    gold.append("\n    LibArithmetic.ListMath.addToLI((tbl.iterate(true)).transform((RTxR item) -> (RxInt64) (item.r1)), 1);");
    gold.append("\n    __track(4);");
    gold.append("\n    LibArithmetic.ListMath.addToLL((tbl.iterate(true)).transform((RTxR item) -> (RxInt64) (item.r1)), 1L);");
    gold.append("\n    __track(5);");
    gold.append("\n    LibArithmetic.ListMath.addToDI((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 1);");
    gold.append("\n    __track(6);");
    gold.append("\n    LibArithmetic.ListMath.addToDL((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 1L);");
    gold.append("\n    __track(7);");
    gold.append("\n    LibArithmetic.ListMath.addToDD((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 1.0);");
    gold.append("\n    __track(8);");
    gold.append("\n    LibArithmetic.ListMath.addToCI((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 1);");
    gold.append("\n    __track(9);");
    gold.append("\n    LibArithmetic.ListMath.addToCL((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 1L);");
    gold.append("\n    __track(10);");
    gold.append("\n    LibArithmetic.ListMath.addToCD((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 1.0);");
    gold.append("\n    __track(11);");
    gold.append("\n    LibArithmetic.ListMath.addToCC((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), LibArithmetic.Add.CD(LibArithmetic.Multiply.CI(new NtComplex(0.0, 1.0), 2), 1.0));");
    gold.append("\n    __track(12);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), 1);");
    gold.append("\n    __track(13);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), 1L);");
    gold.append("\n    __track(14);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), 1.0);");
    gold.append("\n    __track(15);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), LibArithmetic.Add.CD(LibArithmetic.Multiply.CI(new NtComplex(0.0, 1.0), 2), 1.0));");
    gold.append("\n    __track(16);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), true);");
    gold.append("\n    __track(17);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((RTxR item) -> (RxString) (item.rS)), \"x\");");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected NtMessageBase __parse_construct_arg(JsonStreamReader __reader) {");
    gold.append("\n    __reader.skipValue();");
    ...
    gold.append("\nMEMORY:1588");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"tbl\":{\"1\":{\"id\":1,\"r0\":2,\"r1\":\"4\",\"r2\":6.3,\"r3\":{\"r\":4.0,\"i\":3.0},\"rS\":\"111.01.0 2.0itruex\"},\"2\":{\"id\":2,\"r0\":3,\"r1\":\"5\",\"r2\":7.4,\"r3\":{\"r\":4.0,\"i\":4.0},\"rS\":\"S111.01.0 2.0itruex\"}},\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":2,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{}");
    gold.append("\n--METRIC RESULTS-----------------------------------");
    gold.append("\n{\"tbl\":{\"1\":{\"id\":1,\"r0\":2,\"r1\":\"4\",\"r2\":6.3,\"r3\":{\"r\":4.0,\"i\":3.0},\"rS\":\"111.01.0 2.0itruex\"},\"2\":{\"id\":2,\"r0\":3,\"r1\":\"5\",\"r2\":7.4,\"r3\":{\"r\":4.0,\"i\":4.0},\"rS\":\"S111.01.0 2.0itruex\"}},\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":2,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
