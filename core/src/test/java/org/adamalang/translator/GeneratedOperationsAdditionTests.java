...
public class GeneratedOperationsAdditionTests extends GeneratedBase {
  ...
  public void stable_ListAssignment_3() {
    ...
    gold.append("\n    }");
    gold.append("\n    __track(2);");
    gold.append("\n    LibArithmetic.ListMath.addToII((tbl.iterate(true)).transform((item) -> item.r0), 1);");
    gold.append("\n    __track(3);");
    gold.append("\n    LibArithmetic.ListMath.addToLI((tbl.iterate(true)).transform((item) -> item.r1), 1);");
    gold.append("\n    __track(4);");
    gold.append("\n    LibArithmetic.ListMath.addToLL((tbl.iterate(true)).transform((item) -> item.r1), 1L);");
    gold.append("\n    __track(5);");
    gold.append("\n    LibArithmetic.ListMath.addToDI((tbl.iterate(true)).transform((item) -> item.r2), 1);");
    gold.append("\n    __track(6);");
    gold.append("\n    LibArithmetic.ListMath.addToDL((tbl.iterate(true)).transform((item) -> item.r2), 1L);");
    gold.append("\n    __track(7);");
    gold.append("\n    LibArithmetic.ListMath.addToDD((tbl.iterate(true)).transform((item) -> item.r2), 1.0);");
    gold.append("\n    __track(8);");
    gold.append("\n    LibArithmetic.ListMath.addToCI((tbl.iterate(true)).transform((item) -> item.r3), 1);");
    gold.append("\n    __track(9);");
    gold.append("\n    LibArithmetic.ListMath.addToCL((tbl.iterate(true)).transform((item) -> item.r3), 1L);");
    gold.append("\n    __track(10);");
    gold.append("\n    LibArithmetic.ListMath.addToCD((tbl.iterate(true)).transform((item) -> item.r3), 1.0);");
    gold.append("\n    __track(11);");
    gold.append("\n    LibArithmetic.ListMath.addToCC((tbl.iterate(true)).transform((item) -> item.r3), LibArithmetic.Add.CD(LibArithmetic.Multiply.CI(new NtComplex(0.0, 1.0), 2), 1.0));");
    gold.append("\n    __track(12);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), 1);");
    gold.append("\n    __track(13);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), 1L);");
    gold.append("\n    __track(14);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), 1.0);");
    gold.append("\n    __track(15);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), LibArithmetic.Add.CD(LibArithmetic.Multiply.CI(new NtComplex(0.0, 1.0), 2), 1.0));");
    gold.append("\n    __track(16);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), true);");
    gold.append("\n    __track(17);");
    gold.append("\n    LibArithmetic.ListMath.addToSO((tbl.iterate(true)).transform((item) -> item.rS), \"x\");");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected NtMessageBase __parse_construct_arg(JsonStreamReader __reader) {");
    gold.append("\n    __reader.skipValue();");
