...
public class GeneratedBubbleTests extends GeneratedBase {
  ...
  public void stable_CanOnlyCallPure_1() {
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaCanOnlyCallPure_1 {");
    gold.append("\n    private DInt32 __dx;");
    gold.append("\n    private int __gk;");
    gold.append("\n    private DInt32 __dk;");
    ...
    gold.append("\n      if (__gk != __item.___k.getGeneration()) {");
    gold.append("\n        Integer __local_k = __item.__COMPUTE_k(__writer.who);");
    gold.append("\n        __dk.show(__local_k, __obj.planField(\"k\"));");
    gold.append("\n        __gk = __item.___k.getGeneration();");
    gold.append("\n      }");
    gold.append("\n      if (__obj.end()) {");
    gold.append("\n        __emitted = true;");
    gold.append("\n      }");
    ...
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"x\":7,\"k\":4096},\"outstanding\":[],\"blockers\":[],\"seq\":1}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"x\":7,\"k\":4096},\"outstanding\":[],\"blockers\":[],\"seq\":1}");
    ...
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"__seedUsed\":\"0\",\"__seq\":1,\"__time\":\"25\",\"__goodwill_used\":0,\"__cost\":8,\"__billing_seq\":1}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{\"x\":7,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__blocked\":false,\"__seq\":1,\"__entropy\":\"-4962768465676381896\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"50\"}");
    gold.append("\n{\"x\":7,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__blocked\":false,\"__seq\":1,\"__entropy\":\"-4962768465676381896\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"50\"}");
    gold.append("\n--JAVA TEST RESULTS--------------------------------");
    gold.append("\n");
    gold.append("\nSuccess");
  ...
  public void stable_Define_2() {
    ...
    gold.append("\nNO_ONE was DENIED:5011");
    gold.append("\nRANDO was DENIED:5011");
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"x\":7,\"k\":64},\"outstanding\":[],\"blockers\":[],\"seq\":1}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"x\":7,\"k\":64},\"outstanding\":[],\"blockers\":[],\"seq\":1}");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"25\"}-->{\"__messages\":null,\"__seedUsed\":\"0\",\"__seq\":1,\"__entropy\":\"-4962768465676381896\",\"__time\":\"25\"} need:false in:-25");
