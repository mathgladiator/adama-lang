...
public class GeneratedConstructorTests extends GeneratedBase {
  ...
  public void stable_ConstructClientAndMessage_2() {
    ...
    gold.append("\n!!EXCEPTION!!!!!!!!!!!!!!!!!!");
    gold.append("\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    gold.append("\npath: ConstructClientAndMessage_2 failed due to to exception");
    gold.append("\norg.adamalang.translator.parser.exceptions.ParseException: Parser was expecting a Symbol=`)`; instead, the parse got Symbol:,. {Token: `,` @ (6,20) -> (6,21): Symbol}");
    gold.append("\n	at org.adamalang.translator.parser.Parser.consumeExpectedSymbol(Parser.java:355)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define_constructor_trailer(Parser.java:660)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define(Parser.java:573)");
  ...
  public void stable_ConstructJustClient_3() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":2,\"character\":0,\"byte\":17},\"end\":{\"line\":4,\"character\":1,\"byte\":59}},\"severity\":1,\"source\":\"error\",\"message\":\"Type not found: a message named 'client' was not found. (TypeCheckReferences)\"},{\"range\":{\"start\":{\"line\":3,\"character\":10,\"byte\":53},\"end\":{\"line\":3,\"character\":12,\"byte\":55}},\"severity\":1,\"source\":\"error\",\"message\":\"The variable 'me' was not defined (VariableLookup)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  ...
  public void stable_Legacy_6() {
    ...
    gold.append("\n!!EXCEPTION!!!!!!!!!!!!!!!!!!");
    gold.append("\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    gold.append("\npath: Legacy_6 failed due to to exception");
    gold.append("\norg.adamalang.translator.parser.exceptions.ParseException: Parser was expecting a Symbol=`)`; instead, the parse got Symbol:,. {Token: `,` @ (16,20) -> (16,21): Symbol}");
    gold.append("\n	at org.adamalang.translator.parser.Parser.consumeExpectedSymbol(Parser.java:355)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define_constructor_trailer(Parser.java:660)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define(Parser.java:573)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.document(Parser.java:954)");
