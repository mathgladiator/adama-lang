...
public class GeneratedStdLibTests extends GeneratedBase {
  ...
  public void stable_Lists_2() {
    ...
    gold.append("\n    x = new RxLazy<NtList<Integer>>(this, () -> (NtList<Integer>)(LibLists.flatten((_b.iterate(true)).transform((item) -> item.a.get()))), null);");
    ...
    gold.append("\n      a = new RxLazy<NtList<Integer>>(this, () -> (NtList<Integer>)((_a.iterate(true)).transform((item) -> item.x.get())), null);");
  ...
  public void stable_NumericalExtensions_3() {
    ...
    gold.append("\n    }");
    gold.append("\n    __track(10);");
    gold.append("\n    d1.set((Integer) (LibStatistics.sumInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(11);");
    gold.append("\n    d2.set((Double) (LibStatistics.avgDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected NtMessageBase __parse_construct_arg(JsonStreamReader __reader) {");
    gold.append("\n    __reader.skipValue();");
  ...
  public void stable_Stats_4() {
    ...
    gold.append("\n    }");
    gold.append("\n    __track(6);");
    gold.append("\n    y1.set((Double) (LibStatistics.sumDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(7);");
    gold.append("\n    y2.set((Double) (LibStatistics.medianDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(8);");
    gold.append("\n    y3.set((Double) (LibStatistics.maxDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(9);");
    gold.append("\n    y4.set((Double) (LibStatistics.minDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(10);");
    gold.append("\n    y5.set((Double) (LibStatistics.percentileDoubles((rows.iterate(true)).transform((item) -> item.y.get()), 0.0).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(11);");
    gold.append("\n    y6.set((Double) (LibStatistics.percentileDoubles((rows.iterate(true)).transform((item) -> item.y.get()), 0.95).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(12);");
    gold.append("\n    y7.set((Double) (LibStatistics.avgDoubles((rows.iterate(true)).transform((item) -> item.y.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n    __track(13);");
    gold.append("\n    x1.set((Integer) (LibStatistics.sumInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(14);");
    gold.append("\n    x2.set((Integer) (LibStatistics.medianInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(15);");
    gold.append("\n    x3.set((Integer) (LibStatistics.maxInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(16);");
    gold.append("\n    x4.set((Integer) (LibStatistics.minInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(17);");
    gold.append("\n    x5.set((Integer) (LibStatistics.percentileInts((rows.iterate(true)).transform((item) -> item.x.get()), 0.0).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(18);");
    gold.append("\n    x6.set((Integer) (LibStatistics.percentileInts((rows.iterate(true)).transform((item) -> item.x.get()), 0.95).getOrDefaultTo(-1000)));");
    gold.append("\n    __track(19);");
    gold.append("\n    x7.set((Double) (LibStatistics.avgInts((rows.iterate(true)).transform((item) -> item.x.get())).getOrDefaultTo(-1000.0)));");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected NtMessageBase __parse_construct_arg(JsonStreamReader __reader) {");
    gold.append("\n    __reader.skipValue();");
