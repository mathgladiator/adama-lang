...
public class GeneratedStdLibTests extends GeneratedBase {
  ...
  public void stable_Strings_3() {
    ...
    gold.append("\n!!EXCEPTION!!!!!!!!!!!!!!!!!!");
    gold.append("\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    gold.append("\npath: Strings_3 failed due to to exception");
    gold.append("\norg.adamalang.translator.parser.exceptions.ParseException: Parser was expecting an identifier, but got a Symbol:= instead. {Token: `=` @ (20,15) -> (20,16): Symbol}");
    gold.append("\n	at org.adamalang.translator.parser.Parser.testId(Parser.java:1802)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.id(Parser.java:1211)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define_field_record(Parser.java:854)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.define(Parser.java:719)");
    gold.append("\n	at org.adamalang.translator.parser.Parser.document(Parser.java:1086)");
    gold.append("\n	at org.adamalang.support.testgen.PhaseEmission.go(PhaseEmission.java:25)");
    gold.append("\n	at org.adamalang.support.testgen.PhaseValidate.go(PhaseValidate.java:41)");
    gold.append("\n	at org.adamalang.support.testgen.TestForge.forge(TestForge.java:30)");
