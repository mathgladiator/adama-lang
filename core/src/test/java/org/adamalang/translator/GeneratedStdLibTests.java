...
public class GeneratedStdLibTests extends GeneratedBase {
  ...
  public void stable_Lists_1() {
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private static class RTxAutoMaxRecord7 extends NtMessageBase {");
    gold.append("\n    private final RTxAutoMaxRecord7 __this;");
    gold.append("\n    private int x = 0;");
    gold.append("\n    public void __hash(HashBuilder __hash) {");
    gold.append("\n      __hash.hashString(\"x\");");
    ...
    gold.append("\n      __hash.hashString(\"anonymous\");");
    gold.append("\n    }");
    gold.append("\n    private static String[] __INDEX_COLUMNS_AutoMaxRecord7 = new String[] {};");
    gold.append("\n    @Override");
    gold.append("\n    public String[] __getIndexColumns() {");
    gold.append("\n      return __INDEX_COLUMNS_AutoMaxRecord7;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public int[] __getIndexValues() {");
    gold.append("\n      return new int[] {};");
    gold.append("\n    }");
    gold.append("\n    private RTxAutoMaxRecord7(JsonStreamReader __reader) {");
    gold.append("\n      __this = this;");
    gold.append("\n      __ingest(__reader);");
    gold.append("\n    }");
    gold.append("\n    @Override");
    ...
    gold.append("\n      __writer.endObject();");
    gold.append("\n    }");
    gold.append("\n    private RTxAutoMaxRecord7() { __this = this; }");
    gold.append("\n    private RTxAutoMaxRecord7(int x) {");
    gold.append("\n      this.__this = this;");
    gold.append("\n      this.x = x;");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaRTxAutoMaxRecord7 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaRTxAutoMaxRecord7() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(RTxAutoMaxRecord7 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      if (__obj.end()) {");
    gold.append("\n        __emitted = true;");
    gold.append("\n      }");
    ...
    gold.append("\n    private RTxAutoMaxRecord7[] _a = new RTxAutoMaxRecord7[]{};");
    gold.append("\n    public void __hash(HashBuilder __hash) {");
    gold.append("\n      __hash.hashString(\"_a\");");
    gold.append("\n      for (RTxAutoMaxRecord7 __item1 : this._a) {");
    ...
    gold.append("\n        switch (__fieldName) {");
    gold.append("\n          case \"_a\":");
    gold.append("\n            ArrayList<RTxAutoMaxRecord7> __localArray_0 = new ArrayList<>();");
    gold.append("\n            RTxAutoMaxRecord7 __localItem_1;");
    gold.append("\n            __reader.mustStartArray();");
    gold.append("\n            while (__reader.notEndOfArray()) {");
    gold.append("\n              __localItem_1 = new RTxAutoMaxRecord7(__reader);");
    gold.append("\n              __localArray_0.add(__localItem_1);");
    gold.append("\n            }");
    gold.append("\n            this._a = new RTxAutoMaxRecord7[__localArray_0.size()];");
    ...
    gold.append("\n      __writer.writeObjectFieldIntro(\"_a\");");
    gold.append("\n      __writer.beginArray();");
    gold.append("\n      for (RTxAutoMaxRecord7 __localItem_3 : _a) {");
    ...
    gold.append("\n    private RTx_AnonObjConvert_0(RTxAutoMaxRecord7[] _a) {");
    gold.append("\n      this.__this = this;");
    gold.append("\n      this._a = _a;");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaRTx_AnonObjConvert_0 implements DeltaNode {");
    gold.append("\n    private DList<DeltaRTxAutoMaxRecord7> __d_a;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaRTx_AnonObjConvert_0() {");
    gold.append("\n      __d_a = new DList<DeltaRTxAutoMaxRecord7>();");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      {");
    gold.append("\n        DList<DeltaRTxAutoMaxRecord7> __deltaList47 = __d_a;");
    gold.append("\n        PrivateLazyDeltaWriter __list46 = __obj.planField(\"_a\").planObject();");
    gold.append("\n        int __index50 = 0;");
    gold.append("\n        for (RTxAutoMaxRecord7 __listElement48 : __item._a) {");
    gold.append("\n          DeltaRTxAutoMaxRecord7 __deltaElement49 = __deltaList47.getPrior(__index50, () -> new DeltaRTxAutoMaxRecord7());");
    ...
    gold.append("\n      RTx_AnonObjConvert_0 _AutoExpr53 = new RTx_AnonObjConvert_0(new RTxAutoMaxRecord7[] {new RTxAutoMaxRecord7(1), new RTxAutoMaxRecord7(2), new RTxAutoMaxRecord7(3)});");
    gold.append("\n      RTxB _CreateRef52 = _AutoRef51.make();");
    gold.append("\n      __code_cost += 1;");
    gold.append("\n      {");
    gold.append("\n        RxTable<RTxA> _AutoRef54 = _CreateRef52._a;");
    gold.append("\n        for (RTxAutoMaxRecord7 _AutoElement55 : _AutoExpr53._a) {");
    ...
    gold.append("\n      RTx_AnonObjConvert_0 _AutoExpr58 = new RTx_AnonObjConvert_0(new RTxAutoMaxRecord7[] {new RTxAutoMaxRecord7(4), new RTxAutoMaxRecord7(5), new RTxAutoMaxRecord7(6)});");
    gold.append("\n      RTxB _CreateRef57 = _AutoRef56.make();");
    gold.append("\n      __code_cost += 1;");
    gold.append("\n      {");
    gold.append("\n        RxTable<RTxA> _AutoRef59 = _CreateRef57._a;");
    gold.append("\n        for (RTxAutoMaxRecord7 _AutoElement60 : _AutoExpr58._a) {");
