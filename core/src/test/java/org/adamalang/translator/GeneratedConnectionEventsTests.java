...
public class GeneratedConnectionEventsTests extends GeneratedBase {
  ...
  public void stable_ConnectMustReturn_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":15},\"end\":{\"line\":1,\"character\":1}},\"severity\":1,\"source\":\"error\",\"message\":\"The @connected handler must return a boolean (ConnectionEvents)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
  ...
  public void stable_Happy_2() {
    ...
    gold.append("\n{\"command\":\"bill\",\"timestamp\":\"225\"}-->{\"__goodwill_used\":0,\"__cost\":8,\"__billing_seq\":8} need:true in:0");
