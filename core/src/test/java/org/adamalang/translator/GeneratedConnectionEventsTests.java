...
public class GeneratedConnectionEventsTests extends GeneratedBase {
  ...
  public void stable_ConnectMustReturn_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":15,\"byte\":15},\"end\":{\"line\":1,\"character\":1,\"byte\":19}},\"severity\":1,\"source\":\"error\",\"message\":\"The @connected handler must return a boolean (DocumentEvents)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
  ...
  public void stable_Happy_2() {
    ...
    gold.append("\n    return false;");
    gold.append("\n  }");
    gold.append("\n  public boolean __onConnected__1(NtPrincipal __who) {");
    gold.append("\n    NtPrincipal cv = __who;");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(1);");
    gold.append("\n    return true;");
