...
public class GeneratedAssetsTests extends GeneratedBase {
  ...
  public void stable_Attachment_1() {
    ...
    gold.append("\n    my_file = new RxLazy<NtAsset>(this, () -> (NtAsset)(latest.get()));");
    gold.append("\n    my_name = new RxLazy<String>(this, () -> (String)(latest.get().name()));");
    gold.append("\n    my_id = new RxLazy<String>(this, () -> (String)(latest.get().id()));");
    gold.append("\n    my_size = new RxLazy<Long>(this, () -> (Long)(latest.get().size()));");
    gold.append("\n    my_type = new RxLazy<String>(this, () -> (String)(latest.get().type()));");
    gold.append("\n    my_valid = new RxLazy<Boolean>(this, () -> (Boolean)(latest.get().valid()));");
  ...
  public void stable_Sanity_4() {
    ...
    gold.append("\n    latest_size = new RxLazy<Long>(this, () -> (Long)(latest.get().size()));");
    gold.append("\n    latest_md5 = new RxLazy<String>(this, () -> (String)(latest.get().md5()));");
    gold.append("\n    latest_sha384 = new RxLazy<String>(this, () -> (String)(latest.get().sha384()));");
    gold.append("\n    latest_type = new RxLazy<String>(this, () -> (String)(latest.get().type()));");
    gold.append("\n    latest_name = new RxLazy<String>(this, () -> (String)(latest.get().name()));");
