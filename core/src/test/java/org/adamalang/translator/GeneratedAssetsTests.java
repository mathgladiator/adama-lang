...
public class GeneratedAssetsTests extends GeneratedBase {
  ...
  public void stable_Sanity_4() {
    ...
    gold.append("\n    latest_size = new RxLazy<Long>(this, () -> (latest.get().size()));");
    gold.append("\n    latest_md5 = new RxLazy<String>(this, () -> (latest.get().md5()));");
    gold.append("\n    latest_sha384 = new RxLazy<String>(this, () -> (latest.get().sha384()));");
    gold.append("\n    latest_type = new RxLazy<String>(this, () -> (latest.get().type()));");
    gold.append("\n    latest_name = new RxLazy<String>(this, () -> (latest.get().name()));");
