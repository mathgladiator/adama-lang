...
public class GeneratedChannelsGuardTests extends GeneratedBase {
  private String cached_Found_1 = null;
  private String get_Found_1() {
    if (cached_Found_1 != null) {
      return cached_Found_1;
    }
    cached_Found_1 = generateTestOutput(true, "Found_1", "./test_code/ChannelsGuard_Found_success.a");
    return cached_Found_1;
  }

  @Test
  public void testFoundEmission() {
    assertEmissionGood(get_Found_1());
  }

  @Test
  public void testFoundSuccess() {
    assertLivePass(get_Found_1());
  }

  @Test
  public void testFoundGoodWillHappy() {
    assertGoodWillHappy(get_Found_1());
  }

  @Test
  public void testFoundExceptionFree() {
    assertExceptionFree(get_Found_1());
  }

  @Test
  public void testFoundTODOFree() {
    assertTODOFree(get_Found_1());
  }

  @Test
  public void stable_Found_1() {
    String live = get_Found_1();
    ...
    gold.append("\npublic class Found_1 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Found_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaFound_1 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaFound_1() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Found_1 __item, PrivateLazyDeltaWriter __writer) {");
    ...
    gold.append("\n    Found_1 __self = this;");
    gold.append("\n    DeltaFound_1 __state = new DeltaFound_1();");
    ...
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}},\"X\":{\"nature\":\"native_message\",\"name\":\"X\",\"anonymous\":false,\"fields\":{}}},\"channels\":{\"goo\":\"X\"},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
  ...
  private String cached_NotFound_2 = null;
  private String get_NotFound_2() {
    if (cached_NotFound_2 != null) {
      return cached_NotFound_2;
    }
    cached_NotFound_2 = generateTestOutput(false, "NotFound_2", "./test_code/ChannelsGuard_NotFound_failure.a");
    return cached_NotFound_2;
  }

  @Test
  public void testNotFoundFailure() {
    assertLiveFail(get_NotFound_2());
  }

  @Test
  public void testNotFoundNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_NotFound_2());
  }

  @Test
  public void testNotFoundExceptionFree() {
    assertExceptionFree(get_NotFound_2());
  }

  @Test
  public void testNotFoundTODOFree() {
    assertTODOFree(get_NotFound_2());
  }

  @Test
  public void stable_NotFound_2() {
    String live = get_NotFound_2();
    StringBuilder gold = new StringBuilder();
