...
public class GeneratedCronTests extends GeneratedBase {
  ...
  public void stable_HappyDaily_2() {
    ...
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{\"__foo\":{\"type\":{\"nature\":\"reactive_value\",\"type\":\"long\"},\"privacy\":\"private\"}}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}}},\"channels\":{},\"channels-privacy\":{},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"0\",\"origin\":\"origin\",\"ip\":\"ip\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"__messages\":null,\"__enqueued\":{},\"__seq\":1} need:true in:43200000");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"21600000\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":2,\"__entropy\":\"4804307197456638271\",\"__time\":\"21600000\"} need:false in:0");
    gold.append("\nCPU:0");
    gold.append("\nMEMORY:440");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"21600025\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"21600025\"} need:false in:0");
    gold.append("\nNO_ONE: CREATED PRIVATE VIEW");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":3}");
    gold.append("\nNO_ONE|FAILURE:184333");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"21600050\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":4,\"__entropy\":\"7848011421992302230\",\"__time\":\"21600050\"} need:false in:0");
    gold.append("\nRANDO: CREATED PRIVATE VIEW");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":4}");
    gold.append("\n+ RANDO DELTA:{\"seq\":4}");
    gold.append("\nRANDO|FAILURE:184333");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"21600075\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__time\":\"21600075\"} need:false in:0");
    gold.append("\nRANDO|SUCCESS:5");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":5}");
    gold.append("\n+ RANDO DELTA:{\"seq\":5}");
    gold.append("\nMEMORY:558");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"__foo\":\"0\",\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"21600075\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":0,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{}");
    gold.append("\n--METRIC RESULTS-----------------------------------");
    gold.append("\n{\"__foo\":\"0\",\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"21600075\",\"__timezone\":\"UTC\",\"__auto_table_row_id\":0,\"__auto_gen\":0,\"__auto_cache_id\":0,\"__cache\":{},\"__webTaskId\":0,\"__enqueued\":{},\"__webqueue\":{},\"__replication\":{}}");
  ...
  private String cached_NotInteger_3 = null;
  private String get_NotInteger_3() {
    if (cached_NotInteger_3 != null) {
      return cached_NotInteger_3;
    }
    cached_NotInteger_3 = generateTestOutput(false, "NotInteger_3", "./test_code/Cron_NotInteger_failure.a");
    return cached_NotInteger_3;
  }

  @Test
  public void testNotIntegerFailure() {
    assertLiveFail(get_NotInteger_3());
  }

  @Test
  public void testNotIntegerNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_NotInteger_3());
  }

  @Test
  public void testNotIntegerExceptionFree() {
    assertExceptionFree(get_NotInteger_3());
  }

  @Test
  public void testNotIntegerTODOFree() {
    assertTODOFree(get_NotInteger_3());
  }

  @Test
  public void stable_NotInteger_3() {
    String live = get_NotInteger_3();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:Cron_NotInteger_failure.a");
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":16,\"byte\":16},\"end\":{\"line\":0,\"character\":17,\"byte\":17}},\"severity\":1,\"source\":\"error\",\"message\":\"File './test_code/Cron_NotInteger_failure.a' failed to parse: Parser was expecting an integer; got 'x'instead {Token: `x` @ (0,16) -> (0,17): Identifier}\",\"file\":\"./test_code/Cron_NotInteger_failure.a\"},{\"range\":{\"start\":{\"line\":0,\"character\":0,\"byte\":0},\"end\":{\"line\":0,\"character\":0,\"byte\":0}},\"severity\":1,\"source\":\"error\",\"message\":\"Import failed (Parse): Parser was expecting an integer; got 'x'instead {Token: `x` @ (0,16) -> (0,17): Identifier}\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
