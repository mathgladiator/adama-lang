...
public class GeneratedBubbleGTests extends GeneratedBase {
  private String cached_CantFind_1 = null;
  private String get_CantFind_1() {
    if (cached_CantFind_1 != null) {
      return cached_CantFind_1;
    }
    cached_CantFind_1 = generateTestOutput(false, "CantFind_1", "./test_code/BubbleG_CantFind_failure.a");
    return cached_CantFind_1;
  }

  @Test
  public void testCantFindFailure() {
    assertLiveFail(get_CantFind_1());
  }

  @Test
  public void testCantFindNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_CantFind_1());
  }

  @Test
  public void testCantFindExceptionFree() {
    assertExceptionFree(get_CantFind_1());
  }

  @Test
  public void testCantFindTODOFree() {
    assertTODOFree(get_CantFind_1());
  }

  @Test
  public void stable_CantFind_1() {
    String live = get_CantFind_1();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:BubbleG_CantFind_failure.a");
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":0,\"character\":0,\"byte\":0},\"end\":{\"line\":0,\"character\":18,\"byte\":18}},\"severity\":1,\"source\":\"error\",\"message\":\"Policy 'p2' was not found for bubble guard\",\"file\":\"./test_code/BubbleG_CantFind_failure.a\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  private String cached_Guard_2 = null;
  private String get_Guard_2() {
    if (cached_Guard_2 != null) {
      return cached_Guard_2;
    }
    cached_Guard_2 = generateTestOutput(true, "Guard_2", "./test_code/BubbleG_Guard_success.a");
    return cached_Guard_2;
  }

  @Test
  public void testGuardEmission() {
    assertEmissionGood(get_Guard_2());
  }

  @Test
  public void testGuardSuccess() {
    assertLivePass(get_Guard_2());
  }

  @Test
  public void testGuardNoFormatException() {
    assertNoFormatException(get_Guard_2());
  }

  @Test
  public void testGuardGoodWillHappy() {
    assertGoodWillHappy(get_Guard_2());
  }

  @Test
  public void testGuardExceptionFree() {
    assertExceptionFree(get_Guard_2());
  }

  @Test
  public void testGuardTODOFree() {
    assertTODOFree(get_Guard_2());
  }

  @Test
  public void stable_Guard_2() {
    String live = get_Guard_2();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:BubbleG_Guard_success.a");
    gold.append("\n--EMISSION-----------------------------------------");
    ...
    gold.append("\npublic class Guard_2 extends LivingDocument {");
    gold.append("\n  private final RxGuard ___k;");
    gold.append("\n  private final RxGuard ___k2;");
    gold.append("\n  private final RxGuard ___k3;");
    ...
    gold.append("\n    return 42;");
    gold.append("\n  }");
    gold.append("\n  public int __COMPUTE_k2(NtPrincipal __who, RTx__ViewerType __viewer) {");
    gold.append("\n    return 42;");
    gold.append("\n  }");
    gold.append("\n  public int __COMPUTE_k3(NtPrincipal __who, RTx__ViewerType __viewer) {");
    gold.append("\n    return 1000;");
    gold.append("\n  }");
    gold.append("\n  @Override");
    ...
    gold.append("\n      this.p2=__POLICY_p2(__who);");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaGuard_2 implements DeltaNode {");
    gold.append("\n    private long __gk;");
    gold.append("\n    private DInt32 __dk;");
    gold.append("\n    private long __gk2;");
    gold.append("\n    private DInt32 __dk2;");
    gold.append("\n    private long __gk3;");
    gold.append("\n    private DInt32 __dk3;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaGuard_2() {");
    gold.append("\n      __gk = -1;");
    gold.append("\n      __dk = new DInt32();");
    gold.append("\n      __gk2 = -1;");
    gold.append("\n      __dk2 = new DInt32();");
    ...
    gold.append("\n      long __sum = 40;");
    gold.append("\n      __sum += __dk.__memory();");
    gold.append("\n      __sum += __dk2.__memory();");
    gold.append("\n      __sum += __dk3.__memory();");
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(Guard_2 __item, PrivateLazyDeltaWriter __writer) {");
    ...
    gold.append("\n        __CHECK = __item.___k2.getGeneration(__writer.getViewId());");
    gold.append("\n        if (__gk2 != __CHECK)  {");
    gold.append("\n          __item.___k2.startView(__writer.getViewId());");
    gold.append("\n          Integer __local_k2 = __item.__COMPUTE_k2(__writer.who, __VIEWER);");
    gold.append("\n          __dk2.show(__local_k2, __obj.planField(\"k2\"));");
    gold.append("\n          __item.___k2.finishView();");
    gold.append("\n          __gk2 = __CHECK;");
    gold.append("\n        }");
    gold.append("\n        /* privacy check close up */");
    gold.append("\n      } else {");
    ...
    gold.append("\n        __CHECK = __item.___k3.getGeneration(__writer.getViewId());");
    gold.append("\n        if (__gk3 != __CHECK)  {");
    gold.append("\n          __item.___k3.startView(__writer.getViewId());");
    gold.append("\n          Integer __local_k3 = __item.__COMPUTE_k3(__writer.who, __VIEWER);");
    gold.append("\n          __dk3.show(__local_k3, __obj.planField(\"k3\"));");
    gold.append("\n          __item.___k3.finishView();");
    gold.append("\n          __gk3 = __CHECK;");
    gold.append("\n        }");
    gold.append("\n        /* privacy check close up */");
    gold.append("\n      } else {");
    gold.append("\n        __gk3 = -1;");
    gold.append("\n        __dk3.hide(__obj.planField(\"k3\"));");
    gold.append("\n      }");
    gold.append("\n      if (__obj.end()) {");
    gold.append("\n        __emitted = true;");
    gold.append("\n      }");
    ...
    gold.append("\n    Guard_2 __self = this;");
    gold.append("\n    DeltaGuard_2 __state = new DeltaGuard_2();");
    ...
    gold.append("\n--REFLECTION RESULTS-------------------------------------");
    gold.append("\n{\"types\":{\"__Root\":{\"nature\":\"reactive_record\",\"name\":\"Root\",\"fields\":{\"k\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"bubble\"},\"k2\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"bubble\"},\"k3\":{\"type\":{\"nature\":\"native_value\",\"type\":\"int\"},\"privacy\":\"bubble\"}}},\"__ViewerType\":{\"nature\":\"native_message\",\"name\":\"__ViewerType\",\"anonymous\":true,\"fields\":{}}},\"channels\":{},\"channels-privacy\":{},\"constructors\":[],\"labels\":[]}");
    gold.append("\n--JAVA RUNNING-------------------------------------");
  ...
  private String cached_RecordGuard_3 = null;
  private String get_RecordGuard_3() {
    if (cached_RecordGuard_3 != null) {
      return cached_RecordGuard_3;
    }
    cached_RecordGuard_3 = generateTestOutput(true, "RecordGuard_3", "./test_code/BubbleG_RecordGuard_success.a");
    return cached_RecordGuard_3;
  }

  @Test
  public void testRecordGuardEmission() {
    assertEmissionGood(get_RecordGuard_3());
  }

  @Test
  public void testRecordGuardSuccess() {
    assertLivePass(get_RecordGuard_3());
  }

  @Test
  public void testRecordGuardNoFormatException() {
    assertNoFormatException(get_RecordGuard_3());
  }

  @Test
  public void testRecordGuardGoodWillHappy() {
    assertGoodWillHappy(get_RecordGuard_3());
  }

  @Test
  public void testRecordGuardExceptionFree() {
    assertExceptionFree(get_RecordGuard_3());
  }

  @Test
  public void testRecordGuardTODOFree() {
    assertTODOFree(get_RecordGuard_3());
  }

  @Test
  public void stable_RecordGuard_3() {
    String live = get_RecordGuard_3();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:BubbleG_RecordGuard_success.a");
    gold.append("\n--EMISSION-----------------------------------------");
    gold.append("\nEmission Success, Yay");
    gold.append("\n=FORMAT===================================================");
    gold.append("\nrecord R {");
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class RecordGuard_3 extends LivingDocument {");
    gold.append("\n  public boolean __POLICY_g(NtPrincipal __who){");
    gold.append("\n    __code_cost += 2;");
    gold.append("\n    __track(0);");
    gold.append("\n    return true;");
    gold.append("\n  }");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public RecordGuard_3(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {");
    gold.append("\n      this.g=__POLICY_g(__who);");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaRecordGuard_3 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaRecordGuard_3() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(RecordGuard_3 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    ...
    gold.append("\n  @Override");
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    RecordGuard_3 __self = this;");
    gold.append("\n    DeltaRecordGuard_3 __state = new DeltaRecordGuard_3();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    int __viewId = __genViewId();");
    gold.append("\n    return new PrivateView(__viewId, __who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
