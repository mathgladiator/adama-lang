...
public class GeneratedMetricsTests extends GeneratedBase {
  ...
  public void stable_BadTypes_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":2147483647,\"character\":2147483647,\"byte\":2147483647},\"end\":{\"line\":0,\"character\":0,\"byte\":0}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of int, long, or double; instead, but the type is actually 'string'\"},{\"range\":{\"start\":{\"line\":2147483647,\"character\":2147483647,\"byte\":2147483647},\"end\":{\"line\":0,\"character\":0,\"byte\":0}},\"severity\":1,\"source\":\"error\",\"message\":\"Type check failure: must have a type of int, long, or double; instead, but the type is actually 'complex'\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
  private String cached_Rx_2 = null;
  private String get_Rx_2() {
    if (cached_Rx_2 != null) {
      return cached_Rx_2;
    }
    cached_Rx_2 = generateTestOutput(true, "Rx_2", "./test_code/Metrics_Rx_success.a");
    return cached_Rx_2;
  }

  @Test
  public void testRxEmission() {
    assertEmissionGood(get_Rx_2());
  }

  @Test
  public void testRxSuccess() {
    assertLivePass(get_Rx_2());
  }

  @Test
  public void testRxGoodWillHappy() {
    assertGoodWillHappy(get_Rx_2());
  }

  @Test
  public void testRxExceptionFree() {
    assertExceptionFree(get_Rx_2());
  }

  @Test
  public void testRxTODOFree() {
    assertTODOFree(get_Rx_2());
  }

  @Test
  public void stable_Rx_2() {
    String live = get_Rx_2();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\npublic class Rx_2 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Rx_2(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n  }");
    gold.append("\n  private class DeltaRx_2 implements DeltaNode {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Rx_2 __item, PrivateLazyDeltaWriter __writer) {");
    ...
    gold.append("\n    Rx_2 __self = this;");
    gold.append("\n    DeltaRx_2 __state = new DeltaRx_2();");
  ...
  private String cached_Types_3 = null;
  private String get_Types_3() {
    if (cached_Types_3 != null) {
      return cached_Types_3;
    }
    cached_Types_3 = generateTestOutput(true, "Types_3", "./test_code/Metrics_Types_success.a");
    return cached_Types_3;
  }

  @Test
  public void testTypesEmission() {
    assertEmissionGood(get_Types_3());
  }

  @Test
  public void testTypesSuccess() {
    assertLivePass(get_Types_3());
  }

  @Test
  public void testTypesGoodWillHappy() {
    assertGoodWillHappy(get_Types_3());
  }

  @Test
  public void testTypesExceptionFree() {
    assertExceptionFree(get_Types_3());
  }

  @Test
  public void testTypesTODOFree() {
    assertTODOFree(get_Types_3());
  }

  @Test
  public void stable_Types_3() {
    String live = get_Types_3();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class Types_3 extends LivingDocument {");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Types_3(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaTypes_3 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaTypes_3() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Types_3 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    ...
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    Types_3 __self = this;");
    gold.append("\n    DeltaTypes_3 __state = new DeltaTypes_3();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    return new PrivateView(__genViewId(), __who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
    gold.append("\n      public long memory() {");
