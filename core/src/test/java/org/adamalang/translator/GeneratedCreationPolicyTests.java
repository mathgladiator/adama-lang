...
public class GeneratedCreationPolicyTests extends GeneratedBase {
  ...
  public void stable_ControlFlowOpen_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":6},\"end\":{\"line\":1,\"character\":19}},\"severity\":1,\"source\":\"error\",\"message\":\"Record '__CreateDocumentContext' lacks field 'ipppp' (FieldLookup)\"},{\"range\":{\"start\":{\"line\":0,\"character\":27},\"end\":{\"line\":4,\"character\":1}},\"severity\":1,\"source\":\"error\",\"message\":\"The @can_create handler must return a boolean (DocumentEvents)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
  ...
  public void stable_Simple_2() {
    ...
    gold.append("\n  public static boolean __onCanCreate__0(NtClient who, NtCreateContext context) {");
    gold.append("\n    if (LibString.equality(context.origin, \"pi\")) {");
    gold.append("\n      return true;");
    gold.append("\n    }");
    gold.append("\n    if (LibString.equality(context.ip, \"127.0.0.1\")) {");
    gold.append("\n      return true;");
    gold.append("\n    }");
    gold.append("\n    return LibString.equality(context.key, \"cake\");");
    gold.append("\n  }");
    gold.append("\n  @Override");
    ...
    gold.append("\n    boolean __result = false;");
    gold.append("\n    if (__onCanCreate__0(__client, __context)) {");
    gold.append("\n      __result = true;");
    gold.append("\n    } else {");
    gold.append("\n      return false;");
    gold.append("\n    }return __result;");
  ...
  public void stable_TimeNotStatic_3() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":1,\"character\":10},\"end\":{\"line\":1,\"character\":18}},\"severity\":1,\"source\":\"error\",\"message\":\"Global 'Time' lacks 'now' (GlobaLookup)\"},{\"range\":{\"start\":{\"line\":1,\"character\":10},\"end\":{\"line\":1,\"character\":18}},\"severity\":1,\"source\":\"error\",\"message\":\"Expression is not a function (FunctionInvoke)\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
