...
public class GeneratedMaybeTests extends GeneratedBase {
  ...
  public void stable_Unpack_1() {
    ...
    gold.append("\n      __obj.manifest();");
    gold.append("\n      if (__item.r.get().has()) {");
    gold.append("\n        RTxR __maybeElement1 = (RTxR)(__item.r.get().get());");
    gold.append("\n        DeltaRTxR __maybeDeltaElement2 = __dr.get(() -> new DeltaRTxR());");
    gold.append("\n        __maybeDeltaElement2.show(__maybeElement1, __obj.planField(\"r\"));");
    gold.append("\n      } else {");
    gold.append("\n        __dr.hide(__obj.planField(\"r\"));");
    gold.append("\n      }");
    gold.append("\n      if (__grx != __item.rx.getGeneration()) {");
    gold.append("\n        if (__item.rx.get().has()) {");
    gold.append("\n          Integer __maybeElement3 = (Integer)(__item.rx.get().get());");
    gold.append("\n          DInt32 __maybeDeltaElement4 = __drx.get(() -> new DInt32());");
    gold.append("\n          __maybeDeltaElement4.show(__maybeElement3, __obj.planField(\"rx\"));");
    gold.append("\n        } else {");
    ...
    gold.append("\n    __code_cost += 5;");
    gold.append("\n    __track(0);");
    gold.append("\n    final NtMaybe<RTxM> m0 = new NtMaybe<RTxM>(new NtMaybe<RTxM>(new RTxM(123)));");
    gold.append("\n    __track(1);");
    ...
    gold.append("\nMEMORY:766");
    gold.append("\n--JAVA RESULTS-------------------------------------");
    gold.append("\n{\"r\":null,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__auto_table_row_id\":0}");
    gold.append("\n--DUMP RESULTS-------------------------------------");
    gold.append("\n{\"r\":null,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__auto_table_row_id\":0}");
    gold.append("\n{\"r\":null,\"__state\":\"\",\"__constructed\":true,\"__next_time\":\"0\",\"__last_expire_time\":\"0\",\"__blocked\":false,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__auto_future_id\":0,\"__connection_id\":0,\"__message_id\":0,\"__time\":\"100\",\"__auto_table_row_id\":0}");
    gold.append("\n--JAVA TEST RESULTS--------------------------------");
