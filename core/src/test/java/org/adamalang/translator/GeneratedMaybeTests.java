...
public class GeneratedMaybeTests extends GeneratedBase {
  private String cached_Unpack_1 = null;
  private String get_Unpack_1() {
    if (cached_Unpack_1 != null) {
      return cached_Unpack_1;
    }
    cached_Unpack_1 = generateTestOutput(true, "Unpack_1", "./test_code/Maybe_Unpack_success.a");
    return cached_Unpack_1;
  }

  @Test
  public void testUnpackEmission() {
    assertEmissionGood(get_Unpack_1());
  }

  @Test
  public void testUnpackSuccess() {
    assertLivePass(get_Unpack_1());
  }

  @Test
  public void testUnpackGoodWillHappy() {
    assertGoodWillHappy(get_Unpack_1());
  }

  @Test
  public void testUnpackExceptionFree() {
    assertExceptionFree(get_Unpack_1());
  }

  @Test
  public void testUnpackTODOFree() {
    assertTODOFree(get_Unpack_1());
  }

  @Test
  public void stable_Unpack_1() {
    String live = get_Unpack_1();
    ...
    gold.append("\npublic class Unpack_1 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Unpack_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Unpack_1 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 3;");
    ...
    gold.append("\n    Unpack_1 __self = this;");
    gold.append("\n    DeltaUnpack_1 __state = new DeltaUnpack_1();");
