...
public class GeneratedCOETests extends GeneratedBase {
  private String cached_Issue20230513_1 = null;
  private String get_Issue20230513_1() {
    if (cached_Issue20230513_1 != null) {
      return cached_Issue20230513_1;
    }
    cached_Issue20230513_1 = generateTestOutput(true, "Issue20230513_1", "./test_code/COE_Issue20230513_success.a");
    return cached_Issue20230513_1;
  }

  @Test
  public void testIssue20230513Emission() {
    assertEmissionGood(get_Issue20230513_1());
  }

  @Test
  public void testIssue20230513Success() {
    assertLivePass(get_Issue20230513_1());
  }

  @Test
  public void testIssue20230513GoodWillHappy() {
    assertGoodWillHappy(get_Issue20230513_1());
  }

  @Test
  public void testIssue20230513ExceptionFree() {
    assertExceptionFree(get_Issue20230513_1());
  }

  @Test
  public void testIssue20230513TODOFree() {
    assertTODOFree(get_Issue20230513_1());
  }

  @Test
  public void stable_Issue20230513_1() {
    String live = get_Issue20230513_1();
    ...
    gold.append("\npublic class Issue20230513_1 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Issue20230513_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaIssue20230513_1 implements DeltaNode {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Issue20230513_1 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 2;");
    ...
    gold.append("\n    Issue20230513_1 __self = this;");
    gold.append("\n    DeltaIssue20230513_1 __state = new DeltaIssue20230513_1();");
