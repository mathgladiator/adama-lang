...
public class GeneratedMessagesTests extends GeneratedBase {
  ...
  private String cached_Silent_6 = null;
  private String get_Silent_6() {
    if (cached_Silent_6 != null) {
      return cached_Silent_6;
    }
    cached_Silent_6 = generateTestOutput(true, "Silent_6", "./test_code/Messages_Silent_success.a");
    return cached_Silent_6;
  }

  @Test
  public void testSilentEmission() {
    assertEmissionGood(get_Silent_6());
  }

  @Test
  public void testSilentSuccess() {
    assertLivePass(get_Silent_6());
  }

  @Test
  public void testSilentNoFormatException() {
    assertNoFormatException(get_Silent_6());
  }

  @Test
  public void testSilentGoodWillHappy() {
    assertGoodWillHappy(get_Silent_6());
  }

  @Test
  public void testSilentExceptionFree() {
    assertExceptionFree(get_Silent_6());
  }

  @Test
  public void testSilentTODOFree() {
    assertTODOFree(get_Silent_6());
  }

  @Test
  public void stable_Silent_6() {
    String live = get_Silent_6();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:Messages_Silent_success.a");
    gold.append("\n--EMISSION-----------------------------------------");
    gold.append("\nEmission Success, Yay");
    gold.append("\n=FORMAT===================================================");
    gold.append("\nmessage T {");
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class Silent_6 extends LivingDocument {");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory() + 2176;");
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Silent_6(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaSilent_6 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaSilent_6() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(Silent_6 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    ...
    gold.append("\n  @Override");
    gold.append("\n  public PrivateView __createPrivateView(NtPrincipal __who, Perspective ___perspective) {");
    gold.append("\n    Silent_6 __self = this;");
    gold.append("\n    DeltaSilent_6 __state = new DeltaSilent_6();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    int __viewId = __genViewId();");
    gold.append("\n    return new PrivateView(__viewId, __who, ___perspective) {");
    gold.append("\n      @Override");
    ...
    gold.append("\n        switch (__fieldName) {");
    gold.append("\n          case \"NOPE\":");
    gold.append("\n            this.NOPE = __reader.readInteger();");
    gold.append("\n            break;");
    gold.append("\n          case \"a\":");
    ...
    gold.append("\n    public void __writeOut(JsonStreamWriter __writer) {");
    gold.append("\n      __writer.beginObject();");
    gold.append("\n      __writer.writeObjectFieldIntro(\"NOPE\");");
    gold.append("\n      __writer.writeInteger(NOPE);");
    ...
    gold.append("\n    public void __parsed() throws AbortMessageException {}");
    gold.append("\n    private RTxT() { __this = this; }");
    gold.append("\n    private RTxT(int NOPE, int a, int b, int c, int d) {");
    gold.append("\n      this.__this = this;");
    gold.append("\n      this.NOPE = NOPE;");
    gold.append("\n      this.a = a;");
    gold.append("\n      this.b = b;");
    ...
    gold.append("\n      __dNOPE.show(__item.NOPE, __obj.planField(\"NOPE\"));");
