...
public class GeneratedMessagesTests extends GeneratedBase {
  ...
  public void stable_CantHaveTables_2() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":8,\"character\":0,\"byte\":47},\"end\":{\"line\":11,\"character\":1,\"byte\":94}},\"severity\":1,\"source\":\"error\",\"message\":\"Messages can't have a field type of 'table<R>'\",\"file\":\"./test_code/Messages_CantHaveTables_failure.a\"},{\"range\":{\"start\":{\"line\":8,\"character\":0,\"byte\":47},\"end\":{\"line\":11,\"character\":1,\"byte\":94}},\"severity\":1,\"source\":\"error\",\"message\":\"Messages can't have a field type of 'table<T>'\",\"file\":\"./test_code/Messages_CantHaveTables_failure.a\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
    assertStable(live, gold);
  }
