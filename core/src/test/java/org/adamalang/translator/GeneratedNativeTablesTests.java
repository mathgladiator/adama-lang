...
public class GeneratedNativeTablesTests extends GeneratedBase {
  ...
  public void stable_MessageSync_6() {
    ...
    gold.append("\n    private DList<DeltaRTxM> __dfooz;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaMessageSync_6() {");
    gold.append("\n      __gfooz = -1;");
    gold.append("\n      __dfooz = new DList<DeltaRTxM>();");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n        {");
    gold.append("\n          DList<DeltaRTxM> __deltaList5 = __dfooz;");
    gold.append("\n          PrivateLazyDeltaWriter __list4 = __obj.planField(\"fooz\").planObject();");
    gold.append("\n          int __index8 = 0;");
    gold.append("\n          for (RTxM __listElement6 : __local_fooz) {");
    ...
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"50\"}-->{\"__messages\":null,\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"50\"} need:false in:-50");
    gold.append("\nNO_ONE: CREATED PRIVATE VIEW");
    gold.append("\n+ NO_ONE DELTA:{\"data\":{\"fooz\":{\"0\":{\"id\":1,\"x\":4},\"1\":{\"id\":2,\"x\":8},\"2\":{\"id\":3,\"x\":16},\"@s\":3}},\"seq\":3}");
    gold.append("\nNO_ONE|FAILURE:184333");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"75\"}-->{\"__messages\":null,\"__seq\":4,\"__entropy\":\"7848011421992302230\",\"__time\":\"75\"} need:false in:-75");
    gold.append("\nRANDO: CREATED PRIVATE VIEW");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":4}");
    gold.append("\n+ RANDO DELTA:{\"data\":{\"fooz\":{\"0\":{\"id\":1,\"x\":4},\"1\":{\"id\":2,\"x\":8},\"2\":{\"id\":3,\"x\":16},\"@s\":3}},\"seq\":4}");
    gold.append("\nRANDO|FAILURE:184333");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"100\"}-->{\"__messages\":null,\"__seq\":5,\"__entropy\":\"-8929183248358367000\",\"__time\":\"100\"} need:false in:-100");
    gold.append("\nRANDO|SUCCESS:5");
    gold.append("\n+ NO_ONE DELTA:{\"seq\":5}");
