...
public class GeneratedNativeTablesTests extends GeneratedBase {
  ...
  private String cached_MessageSync_6 = null;
  private String get_MessageSync_6() {
    if (cached_MessageSync_6 != null) {
      return cached_MessageSync_6;
    }
    cached_MessageSync_6 = generateTestOutput(true, "MessageSync_6", "./test_code/NativeTables_MessageSync_success.a");
    return cached_MessageSync_6;
  }

  @Test
  public void testMessageSyncEmission() {
    assertEmissionGood(get_MessageSync_6());
  }

  @Test
  public void testMessageSyncSuccess() {
    assertLivePass(get_MessageSync_6());
  }
  ...
  public void testMessageSyncExceptionFree() {
    assertExceptionFree(get_MessageSync_6());
  }

  @Test
  public void testMessageSyncTODOFree() {
    assertTODOFree(get_MessageSync_6());
  }

  @Test
  public void stable_MessageSync_6() {
    String live = get_MessageSync_6();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class MessageSync_6 extends LivingDocument {");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public MessageSync_6(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaMessageSync_6 implements DeltaNode {");
    gold.append("\n    private long __gfooz;");
    gold.append("\n    private DRecordList<DeltaRTxM> __dfooz;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaMessageSync_6() {");
    gold.append("\n      __gfooz = -1;");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(MessageSync_6 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      __code_cost += 1;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
  ...
  private String cached_NoMessage_7 = null;
  private String get_NoMessage_7() {
    if (cached_NoMessage_7 != null) {
      return cached_NoMessage_7;
    }
    cached_NoMessage_7 = generateTestOutput(false, "NoMessage_7", "./test_code/NativeTables_NoMessage_failure.a");
    return cached_NoMessage_7;
  }

  @Test
  public void testNoMessageFailure() {
    assertLiveFail(get_NoMessage_7());
  }

  @Test
  public void testNoMessageNotTerribleLineNumbers() {
    assertNotTerribleLineNumbers(get_NoMessage_7());
  }

  @Test
  public void testNoMessageExceptionFree() {
    assertExceptionFree(get_NoMessage_7());
  }

  @Test
  public void testNoMessageTODOFree() {
    assertTODOFree(get_NoMessage_7());
  }

  @Test
  public void stable_NoMessage_7() {
    String live = get_NoMessage_7();
    StringBuilder gold = new StringBuilder();
  ...
  private String cached_TableCopy_8 = null;
  private String get_TableCopy_8() {
    if (cached_TableCopy_8 != null) {
      return cached_TableCopy_8;
    }
    cached_TableCopy_8 = generateTestOutput(true, "TableCopy_8", "./test_code/NativeTables_TableCopy_success.a");
    return cached_TableCopy_8;
  }

  @Test
  public void testTableCopyEmission() {
    assertEmissionGood(get_TableCopy_8());
  }

  @Test
  public void testTableCopySuccess() {
    assertLivePass(get_TableCopy_8());
  }
  ...
  public void testTableCopyExceptionFree() {
    assertExceptionFree(get_TableCopy_8());
  }

  @Test
  public void testTableCopyTODOFree() {
    assertTODOFree(get_TableCopy_8());
  }

  @Test
  public void stable_TableCopy_8() {
    String live = get_TableCopy_8();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Map;");
    gold.append("\nimport java.util.Set;");
    gold.append("\npublic class TableCopy_8 extends LivingDocument {");
    gold.append("\n  private final RxInt32 sz;");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public TableCopy_8(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    sz = new RxInt32(this, 0);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    ...
    gold.append("\n    public DeltaPrivacyCache(NtPrincipal __who) {}");
    gold.append("\n  }");
    gold.append("\n  private class DeltaTableCopy_8 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaTableCopy_8() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(TableCopy_8 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      DeltaPrivacyCache __policy_cache = new DeltaPrivacyCache(__writer.who);");
    gold.append("\n      __writer.setCacheObject(__policy_cache);");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
