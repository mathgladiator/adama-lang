...
public class GeneratedCrashReportTests extends GeneratedBase {
  ...
  public void stable_March21_1() {
    ...
    gold.append("\n--ISSUES-------------------------------------------");
    gold.append("\n[{\"range\":{\"start\":{\"line\":3,\"character\":2,\"byte\":74},\"end\":{\"line\":3,\"character\":14,\"byte\":86}},\"severity\":1,\"source\":\"error\",\"message\":\"The type 'maybe<String>' is using a type that was not found.\"},{\"range\":{\"start\":{\"line\":2,\"character\":0,\"byte\":58},\"end\":{\"line\":3,\"character\":27,\"byte\":99}},\"severity\":1,\"source\":\"error\",\"message\":\"The field 'bound_type' has no type\"},{\"range\":{\"start\":{\"line\":2,\"character\":0,\"byte\":58},\"end\":{\"line\":3,\"character\":27,\"byte\":99}},\"severity\":1,\"source\":\"error\",\"message\":\"Variable 'bound_type' has no backing type\"}]\"--JAVA---------------------------------------------");
    gold.append("\n");
    gold.append("\nFailedValidation");
