...
public class GeneratedAggregatesTests extends GeneratedBase {
  ...
  public void stable_Legacy_4() {
    ...
    gold.append("\n    __track(13);");
    gold.append("\n    NtList<RxInt32> _auto_14 = (zzz.iterate(true)).transform((item) -> item.v);");
