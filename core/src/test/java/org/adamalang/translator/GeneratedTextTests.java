...
public class GeneratedTextTests extends GeneratedBase {
  ...
  public void stable_Append_1() {
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"document\":{\"fragments\":{},\"order\":{},\"changes\":{}},\"__messages\":null,\"__seq\":1} need:false in:0");
  ...
  private String cached_Flow_2 = null;
  private String get_Flow_2() {
    if (cached_Flow_2 != null) {
      return cached_Flow_2;
    }
    cached_Flow_2 = generateTestOutput(true, "Flow_2", "./test_code/Text_Flow_success.a");
    return cached_Flow_2;
  }

  @Test
  public void testFlowEmission() {
    assertEmissionGood(get_Flow_2());
  }

  @Test
  public void testFlowSuccess() {
    assertLivePass(get_Flow_2());
  }

  @Test
  public void testFlowGoodWillHappy() {
    assertGoodWillHappy(get_Flow_2());
  }

  @Test
  public void testFlowExceptionFree() {
    assertExceptionFree(get_Flow_2());
  }

  @Test
  public void testFlowTODOFree() {
    assertTODOFree(get_Flow_2());
  }

  @Test
  public void stable_Flow_2() {
    String live = get_Flow_2();
    StringBuilder gold = new StringBuilder();
    ...
    gold.append("\nimport java.util.Set;");
    gold.append("\nimport java.lang.Math;");
    gold.append("\npublic class Flow_2 extends LivingDocument {");
    gold.append("\n  private final RxText document;");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    ...
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Flow_2(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    gold.append("\n    document = new RxText(__self);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    ...
    gold.append("\n    /* root */");
    gold.append("\n  }");
    gold.append("\n  private class DeltaFlow_2 implements DeltaNode {");
    gold.append("\n    private DText __ddocument;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaFlow_2() {");
    gold.append("\n      __ddocument = new DText();");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(Flow_2 __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 1;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      __obj.manifest();");
    gold.append("\n      __ddocument.show(__item.document, __obj.planField(\"document\"));");
    ...
    gold.append("\n  public PrivateView __createPrivateView(NtClient __who, Perspective ___perspective, AssetIdEncoder __encoder) {");
    gold.append("\n    Flow_2 __self = this;");
    gold.append("\n    DeltaFlow_2 __state = new DeltaFlow_2();");
    gold.append("\n    RTx__ViewerType __viewerState = new RTx__ViewerType();");
    gold.append("\n    return new PrivateView(__who, ___perspective, __encoder) {");
    gold.append("\n      @Override");
    gold.append("\n      public long memory() {");
