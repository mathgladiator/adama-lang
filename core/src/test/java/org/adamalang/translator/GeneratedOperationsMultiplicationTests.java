...
public class GeneratedOperationsMultiplicationTests extends GeneratedBase {
  ...
  public void stable_Assignment_1() {
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"0\",\"origin\":\"origin\",\"ip\":\"ip\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"r0\":0,\"r1\":\"0\",\"r2\":0.0,\"r3\":{\"r\":0.0,\"i\":0.0},\"__messages\":null,\"__enqueued\":{},\"__seq\":1} need:false in:0");
  ...
  public void stable_ListAssignment_3() {
    ...
    gold.append("\n    }");
    gold.append("\n    __track(2);");
    gold.append("\n    LibArithmetic.ListMath.multByII((tbl.iterate(true)).transform((RTxR item) -> (RxInt32) (item.r0)), 5);");
    gold.append("\n    __track(3);");
    gold.append("\n    LibArithmetic.ListMath.multByLI((tbl.iterate(true)).transform((RTxR item) -> (RxInt64) (item.r1)), 5);");
    gold.append("\n    __track(4);");
    gold.append("\n    LibArithmetic.ListMath.multByLL((tbl.iterate(true)).transform((RTxR item) -> (RxInt64) (item.r1)), 5L);");
    gold.append("\n    __track(5);");
    gold.append("\n    LibArithmetic.ListMath.multByDI((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 5);");
    gold.append("\n    __track(6);");
    gold.append("\n    LibArithmetic.ListMath.multByDL((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 5L);");
    gold.append("\n    __track(7);");
    gold.append("\n    LibArithmetic.ListMath.multByDD((tbl.iterate(true)).transform((RTxR item) -> (RxDouble) (item.r2)), 5.0);");
    gold.append("\n    __track(8);");
    gold.append("\n    LibArithmetic.ListMath.multByCI((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 5);");
    gold.append("\n    __track(9);");
    gold.append("\n    LibArithmetic.ListMath.multByCL((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 5L);");
    gold.append("\n    __track(10);");
    gold.append("\n    LibArithmetic.ListMath.multByCD((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), 5.0);");
    gold.append("\n    __track(11);");
    gold.append("\n    LibArithmetic.ListMath.multByCC((tbl.iterate(true)).transform((RTxR item) -> (RxComplex) (item.r3)), LibArithmetic.Add.CD(LibArithmetic.Multiply.CI(new NtComplex(0.0, 1.0), 7), 5.0));");
    gold.append("\n  }");
    gold.append("\n  @Override");
    gold.append("\n  protected NtMessageBase __parse_construct_arg(JsonStreamReader __reader) {");
    gold.append("\n    __reader.skipValue();");
    ...
    gold.append("\n--JAVA RUNNING-------------------------------------");
    gold.append("\n{\"command\":\"construct\",\"timestamp\":\"0\",\"who\":{\"agent\":\"?\",\"authority\":\"?\"},\"arg\":{},\"entropy\":\"0\",\"key\":\"0\",\"origin\":\"origin\",\"ip\":\"ip\"}-->{\"__constructed\":true,\"__entropy\":\"-4962768465676381896\",\"__auto_table_row_id\":2,\"tbl\":{\"1\":{\"id\":1,\"r0\":5,\"r1\":\"50\",\"r2\":412.5,\"r3\":{\"r\":-875.0,\"i\":625.0}},\"2\":{\"id\":2,\"r0\":10,\"r1\":\"75\",\"r2\":550.0,\"r3\":{\"r\":-1750.0,\"i\":1250.0}}},\"__messages\":null,\"__enqueued\":{},\"__seq\":1} need:false in:0");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"25\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":2,\"__entropy\":\"4804307197456638271\",\"__time\":\"25\"} need:false in:0");
    gold.append("\nCPU:43");
    gold.append("\nMEMORY:1210");
    gold.append("\n{\"command\":\"invalidate\",\"timestamp\":\"50\"}-->{\"__messages\":null,\"__enqueued\":{},\"__seq\":3,\"__entropy\":\"-1034601897293430941\",\"__time\":\"50\"} need:false in:0");
