...
public class GeneratedValidMessagesTests extends GeneratedBase {
  private String cached_Issue228_1 = null;
  private String get_Issue228_1() {
    if (cached_Issue228_1 != null) {
      return cached_Issue228_1;
    }
    cached_Issue228_1 = generateTestOutput(true, "Issue228_1", "./test_code/ValidMessages_Issue228_success.a");
    return cached_Issue228_1;
  }

  @Test
  public void testIssue228Emission() {
    assertEmissionGood(get_Issue228_1());
  }

  @Test
  public void testIssue228Success() {
    assertLivePass(get_Issue228_1());
  }

  @Test
  public void testIssue228NoFormatException() {
    assertNoFormatException(get_Issue228_1());
  }

  @Test
  public void testIssue228GoodWillHappy() {
    assertGoodWillHappy(get_Issue228_1());
  }

  @Test
  public void testIssue228ExceptionFree() {
    assertExceptionFree(get_Issue228_1());
  }

  @Test
  public void testIssue228TODOFree() {
    assertTODOFree(get_Issue228_1());
  }

  @Test
  public void stable_Issue228_1() {
    String live = get_Issue228_1();
    StringBuilder gold = new StringBuilder();
    gold.append("Path:ValidMessages_Issue228_success.a");
    gold.append("\n--EMISSION-----------------------------------------");
    ...
    gold.append("\npublic class Issue228_1 extends LivingDocument {");
    gold.append("\n  @Override");
    gold.append("\n  public long __memory() {");
    gold.append("\n    long __sum = super.__memory();");
    gold.append("\n    return __sum;");
    gold.append("\n  }");
    gold.append("\n  public Issue228_1(DocumentMonitor __monitor) {");
    gold.append("\n    super(__monitor);");
    ...
    gold.append("\n  }");
    gold.append("\n  private class DeltaIssue228_1 implements DeltaNode {");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaIssue228_1() {");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    ...
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public boolean show(Issue228_1 __item, PrivateLazyDeltaWriter __writer) {");
    ...
    gold.append("\n    Issue228_1 __self = this;");
    gold.append("\n    DeltaIssue228_1 __state = new DeltaIssue228_1();");
    ...
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private static class RTxML extends NtMessageBase {");
    gold.append("\n    private final RTxML __this;");
    gold.append("\n    private NtList<RTxM> m_list = new EmptyNtList<RTxM>();");
    gold.append("\n    private NtList<String> s_list = new EmptyNtList<String>();");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    gold.append("\n      long __mem = 64;");
    gold.append("\n      for (RTxM __idx_0 : m_list) {");
    gold.append("\n        __mem += __idx_0.__memory();");
    gold.append("\n      }");
    gold.append("\n      for (String __idx_1 : s_list) {");
    gold.append("\n        __mem += Sizing.memoryOf(__idx_1);");
    gold.append("\n      }");
    gold.append("\n      return __mem;");
    gold.append("\n    }");
    gold.append("\n    public void __reset() {");
    gold.append("\n      this.m_list = new EmptyNtList<RTxM>();");
    gold.append("\n      this.s_list = new EmptyNtList<String>();");
    gold.append("\n    }");
    gold.append("\n    public void __hash(HashBuilder __hash) {");
    gold.append("\n      __hash.hashString(\"m_list\");");
    gold.append("\n      for (RTxM __item1 : this.m_list) {");
    gold.append("\n        __item1.__hash(__hash);");
    gold.append("\n      }");
    gold.append("\n      __hash.hashString(\"s_list\");");
    gold.append("\n      for (String __item2 : this.s_list) {");
    gold.append("\n        __hash.hashString(__item2);");
    gold.append("\n      }");
    gold.append("\n      __hash.hashString(\"ML\");");
    gold.append("\n    }");
    gold.append("\n    private static String[] __INDEX_COLUMNS_ML = new String[] {};");
    gold.append("\n    @Override");
    gold.append("\n    public String[] __getIndexColumns() {");
    gold.append("\n      return __INDEX_COLUMNS_ML;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public int[] __getIndexValues() {");
    gold.append("\n      return new int[] {};");
    gold.append("\n    }");
    gold.append("\n    private RTxML(JsonStreamReader __reader) {");
    gold.append("\n      __this = this;");
    gold.append("\n      __ingest(__reader);");
    gold.append("\n    }");
    gold.append("\n    @Override");
    ...
    gold.append("\n            }");
    gold.append("\n            this.m_list = new ArrayNtList<RTxM>(__localArray_0);");
    gold.append("\n            break;");
    gold.append("\n          case \"s_list\":");
    gold.append("\n            ArrayList<String> __localArray_3 = new ArrayList<>();");
    gold.append("\n            String __localItem_4;");
    gold.append("\n            __reader.mustStartArray();");
    gold.append("\n            while (__reader.notEndOfArray()) {");
    gold.append("\n              __localItem_4 = __reader.readString();");
    gold.append("\n              __localArray_3.add(__localItem_4);");
    gold.append("\n            }");
    gold.append("\n            this.s_list = new ArrayNtList<String>(__localArray_3);");
    gold.append("\n            break;");
    gold.append("\n          default:");
    gold.append("\n            __reader.skipValue();");
    gold.append("\n        }");
    ...
    gold.append("\n    public void __writeOut(JsonStreamWriter __writer) {");
    gold.append("\n      __writer.beginObject();");
    gold.append("\n      __writer.writeObjectFieldIntro(\"m_list\");");
    gold.append("\n      __writer.beginArray();");
    gold.append("\n      for (RTxM __localItem_6 : m_list) {");
    gold.append("\n        __localItem_6.__writeOut(__writer);");
    gold.append("\n      }");
    gold.append("\n      __writer.endArray();");
    gold.append("\n      __writer.writeObjectFieldIntro(\"s_list\");");
    gold.append("\n      __writer.beginArray();");
    gold.append("\n      for (String __localItem_7 : s_list) {");
    gold.append("\n        __writer.writeString(__localItem_7);");
    gold.append("\n      }");
    gold.append("\n      __writer.endArray();");
    gold.append("\n      __writer.endObject();");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public void __parsed() throws AbortMessageException {}");
    gold.append("\n    private RTxML() { __this = this; }");
    gold.append("\n    private RTxML(NtList<RTxM> m_list, NtList<String> s_list) {");
    gold.append("\n      this.__this = this;");
    gold.append("\n      this.m_list = m_list;");
    gold.append("\n      this.s_list = s_list;");
    gold.append("\n    }");
    gold.append("\n  }");
    gold.append("\n  private class DeltaRTxML implements DeltaNode {");
    gold.append("\n    private DList<DeltaRTxM> __dm_list;");
    gold.append("\n    private DList<DString> __ds_list;");
    gold.append("\n    private boolean __emitted;");
    gold.append("\n    private DeltaRTxML() {");
    gold.append("\n      __dm_list = new DList<DeltaRTxM>();");
    gold.append("\n      __ds_list = new DList<DString>();");
    gold.append("\n      __emitted = false;");
    gold.append("\n    }");
    gold.append("\n    @Override");
    gold.append("\n    public long __memory() {");
    gold.append("\n      long __sum = 40;");
    gold.append("\n      __sum += __dm_list.__memory();");
    gold.append("\n      __sum += __ds_list.__memory();");
    gold.append("\n      return __sum;");
    gold.append("\n    }");
    gold.append("\n    public void show(RTxML __item, PrivateLazyDeltaWriter __writer) {");
    gold.append("\n      __code_cost += 2;");
    gold.append("\n      PrivateLazyDeltaWriter __obj = __writer.planObject();");
    gold.append("\n      {");
    gold.append("\n        DList<DeltaRTxM> __deltaList3 = __dm_list;");
    gold.append("\n        PrivateLazyDeltaWriter __list2 = __obj.planField(\"m_list\").planObject();");
    gold.append("\n        int __index6 = 0;");
    gold.append("\n        for (RTxM __listElement4 : __item.m_list) {");
    gold.append("\n          DeltaRTxM __deltaElement5 = __deltaList3.getPrior(__index6, () -> new DeltaRTxM());");
    ...
    gold.append("\n      }");
    gold.append("\n      {");
    gold.append("\n        DList<DString> __deltaList8 = __ds_list;");
    gold.append("\n        PrivateLazyDeltaWriter __list7 = __obj.planField(\"s_list\").planObject();");
    gold.append("\n        int __index11 = 0;");
    gold.append("\n        for (String __listElement9 : __item.s_list) {");
