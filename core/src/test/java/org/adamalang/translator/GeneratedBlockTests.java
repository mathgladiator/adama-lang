...
public class GeneratedBlockTests extends GeneratedBase {
  ...
  public void stable_DeadCode_1() {
    ...
    gold.append("\npublic class DeadCode_1 extends LivingDocument {");
    gold.append("\n  public DeadCode_1(ObjectNode __root, DocumentMonitor __monitor) {");
  ...
  public void stable_DuplicateVariable_2() {
    ...
    gold.append("\nimport java.util.Comparator;");
    gold.append("\nimport java.lang.Math;");
    gold.append("\npublic class DuplicateVariable_2 extends LivingDocument {");
    gold.append("\n  public DuplicateVariable_2(ObjectNode __root, DocumentMonitor __monitor) {");
    gold.append("\n    super(__root, __monitor);");
    gold.append("\n    __goodwillBudget = 100000;");
    gold.append("\n    __goodwillLimitOfBudget = 100000;");
    gold.append("\n  }");
